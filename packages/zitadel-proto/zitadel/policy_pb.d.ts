...
export declare class OrgIAMPolicy extends Message<OrgIAMPolicy> {
  ...
  static equals(
    a: OrgIAMPolicy | PlainMessage<OrgIAMPolicy> | undefined,
    b: OrgIAMPolicy | PlainMessage<OrgIAMPolicy> | undefined,
  ): boolean;
}
...
export declare class DomainPolicy extends Message<DomainPolicy> {
  ...
  static equals(
    a: DomainPolicy | PlainMessage<DomainPolicy> | undefined,
    b: DomainPolicy | PlainMessage<DomainPolicy> | undefined,
  ): boolean;
}
...
export declare class LabelPolicy extends Message<LabelPolicy> {
  ...
  static equals(
    a: LabelPolicy | PlainMessage<LabelPolicy> | undefined,
    b: LabelPolicy | PlainMessage<LabelPolicy> | undefined,
  ): boolean;
}
...
export declare class LoginPolicy extends Message<LoginPolicy> {
  ...
  static equals(
    a: LoginPolicy | PlainMessage<LoginPolicy> | undefined,
    b: LoginPolicy | PlainMessage<LoginPolicy> | undefined,
  ): boolean;
}
...
export declare class PasswordComplexityPolicy extends Message<PasswordComplexityPolicy> {
  ...
  static equals(
    a:
      | PasswordComplexityPolicy
      | PlainMessage<PasswordComplexityPolicy>
      | undefined,
    b:
      | PasswordComplexityPolicy
      | PlainMessage<PasswordComplexityPolicy>
...
export declare class PasswordAgePolicy extends Message<PasswordAgePolicy> {
  ...
  static equals(
    a: PasswordAgePolicy | PlainMessage<PasswordAgePolicy> | undefined,
    b: PasswordAgePolicy | PlainMessage<PasswordAgePolicy> | undefined,
  ): boolean;
}
...
export declare class LockoutPolicy extends Message<LockoutPolicy> {
  ...
  static equals(
    a: LockoutPolicy | PlainMessage<LockoutPolicy> | undefined,
    b: LockoutPolicy | PlainMessage<LockoutPolicy> | undefined,
  ): boolean;
}
...
export declare class PrivacyPolicy extends Message<PrivacyPolicy> {
  ...
  static equals(
    a: PrivacyPolicy | PlainMessage<PrivacyPolicy> | undefined,
    b: PrivacyPolicy | PlainMessage<PrivacyPolicy> | undefined,
  ): boolean;
}
...
export declare class NotificationPolicy extends Message<NotificationPolicy> {
  ...
  static equals(
    a: NotificationPolicy | PlainMessage<NotificationPolicy> | undefined,
    b: NotificationPolicy | PlainMessage<NotificationPolicy> | undefined,
  ): boolean;
}
