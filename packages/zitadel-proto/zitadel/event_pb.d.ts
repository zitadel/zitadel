...
export declare class Editor extends Message<Editor> {
  ...
  static equals(
    a: Editor | PlainMessage<Editor> | undefined,
    b: Editor | PlainMessage<Editor> | undefined,
  ): boolean;
}
...
export declare class EventType extends Message<EventType> {
  ...
  static equals(
    a: EventType | PlainMessage<EventType> | undefined,
    b: EventType | PlainMessage<EventType> | undefined,
  ): boolean;
}
...
export declare class AggregateType extends Message<AggregateType> {
  ...
  static equals(
    a: AggregateType | PlainMessage<AggregateType> | undefined,
    b: AggregateType | PlainMessage<AggregateType> | undefined,
  ): boolean;
}
