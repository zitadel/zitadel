...
export declare class SecretGenerator extends Message<SecretGenerator> {
  ...
  static equals(
    a: SecretGenerator | PlainMessage<SecretGenerator> | undefined,
    b: SecretGenerator | PlainMessage<SecretGenerator> | undefined,
  ): boolean;
}
...
export declare class SecretGeneratorQuery extends Message<SecretGeneratorQuery> {
  ...
  static equals(
    a: SecretGeneratorQuery | PlainMessage<SecretGeneratorQuery> | undefined,
    b: SecretGeneratorQuery | PlainMessage<SecretGeneratorQuery> | undefined,
  ): boolean;
}
...
export declare class SecretGeneratorTypeQuery extends Message<SecretGeneratorTypeQuery> {
  ...
  static equals(
    a:
      | SecretGeneratorTypeQuery
      | PlainMessage<SecretGeneratorTypeQuery>
      | undefined,
    b:
      | SecretGeneratorTypeQuery
      | PlainMessage<SecretGeneratorTypeQuery>
...
export declare class SMTPConfig extends Message<SMTPConfig> {
  ...
  static equals(
    a: SMTPConfig | PlainMessage<SMTPConfig> | undefined,
    b: SMTPConfig | PlainMessage<SMTPConfig> | undefined,
  ): boolean;
}
...
export declare class SMSProvider extends Message<SMSProvider> {
  ...
  static equals(
    a: SMSProvider | PlainMessage<SMSProvider> | undefined,
    b: SMSProvider | PlainMessage<SMSProvider> | undefined,
  ): boolean;
}
...
export declare class TwilioConfig extends Message<TwilioConfig> {
  ...
  static equals(
    a: TwilioConfig | PlainMessage<TwilioConfig> | undefined,
    b: TwilioConfig | PlainMessage<TwilioConfig> | undefined,
  ): boolean;
}
...
export declare class DebugNotificationProvider extends Message<DebugNotificationProvider> {
  ...
  static equals(
    a:
      | DebugNotificationProvider
      | PlainMessage<DebugNotificationProvider>
      | undefined,
    b:
      | DebugNotificationProvider
      | PlainMessage<DebugNotificationProvider>
...
export declare class OIDCSettings extends Message<OIDCSettings> {
  ...
  static equals(
    a: OIDCSettings | PlainMessage<OIDCSettings> | undefined,
    b: OIDCSettings | PlainMessage<OIDCSettings> | undefined,
  ): boolean;
}
...
export declare class SecurityPolicy extends Message<SecurityPolicy> {
  ...
  static equals(
    a: SecurityPolicy | PlainMessage<SecurityPolicy> | undefined,
    b: SecurityPolicy | PlainMessage<SecurityPolicy> | undefined,
  ): boolean;
}
