...
export declare class AppQuery extends Message<AppQuery> {
  ...
  static equals(
    a: AppQuery | PlainMessage<AppQuery> | undefined,
    b: AppQuery | PlainMessage<AppQuery> | undefined,
  ): boolean;
}
...
export declare class AppNameQuery extends Message<AppNameQuery> {
  ...
  static equals(
    a: AppNameQuery | PlainMessage<AppNameQuery> | undefined,
    b: AppNameQuery | PlainMessage<AppNameQuery> | undefined,
  ): boolean;
}
...
export declare class APIConfig extends Message<APIConfig> {
  ...
  static equals(
    a: APIConfig | PlainMessage<APIConfig> | undefined,
    b: APIConfig | PlainMessage<APIConfig> | undefined,
  ): boolean;
}
