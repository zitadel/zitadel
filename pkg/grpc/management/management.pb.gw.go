...
var (
	...
	pattern_ManagementService_ResendInitialMail_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"users", "id", "_initialize"}, "", runtime.AssumeColonVerbOpt(true)))
