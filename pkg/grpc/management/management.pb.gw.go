...
var (
	...
	pattern_ManagementService_SearchUserExternalIDPs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"users", "user_id", "externalidps", "_search"}, ""))

	pattern_ManagementService_RemoveExternalIDP_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"users", "user_id", "externalidps", "idp_config_id", "external_user_id"}, ""))
