...
const (
	CredentialType_CredentialTypePublicKey CredentialType = 0
)

var CredentialType_name = map[int32]string{
	0: "CredentialTypePublicKey",
}

var CredentialType_value = map[string]int32{
	"CredentialTypePublicKey": 0,
}
...
const (
	AuthenticatorAttachment_AuthenticatorAttachmentUnspecified   AuthenticatorAttachment = 0
	AuthenticatorAttachment_AuthenticatorAttachmentPlatform      AuthenticatorAttachment = 1
	AuthenticatorAttachment_AuthenticatorAttachmentCrossPlatform AuthenticatorAttachment = 2
)

var AuthenticatorAttachment_name = map[int32]string{
	0: "AuthenticatorAttachmentUnspecified",
	1: "AuthenticatorAttachmentPlatform",
	2: "AuthenticatorAttachmentCrossPlatform",
}

var AuthenticatorAttachment_value = map[string]int32{
	"AuthenticatorAttachmentUnspecified":   0,
	"AuthenticatorAttachmentPlatform":      1,
	"AuthenticatorAttachmentCrossPlatform": 2,
}

func (x AuthenticatorAttachment) String() string {
	return proto.EnumName(AuthenticatorAttachment_name, int32(x))
}
...
const (
	UserVerificationRequirement_UserVerificationRequirementPreferred   UserVerificationRequirement = 0
	UserVerificationRequirement_UserVerificationRequirementDiscouraged UserVerificationRequirement = 1
	UserVerificationRequirement_UserVerificationRequirementRequired    UserVerificationRequirement = 2
)

var UserVerificationRequirement_name = map[int32]string{
	0: "UserVerificationRequirementPreferred",
	1: "UserVerificationRequirementDiscouraged",
	2: "UserVerificationRequirementRequired",
}

var UserVerificationRequirement_value = map[string]int32{
	"UserVerificationRequirementPreferred":   0,
	"UserVerificationRequirementDiscouraged": 1,
	"UserVerificationRequirementRequired":    2,
}
...
const (
	AuthenticatorTransport_AuthenticatorTransportUnspecified AuthenticatorTransport = 0
	AuthenticatorTransport_AuthenticatorTransportUSB         AuthenticatorTransport = 1
	AuthenticatorTransport_AuthenticatorTransportNFC         AuthenticatorTransport = 2
	AuthenticatorTransport_AuthenticatorTransportBLE         AuthenticatorTransport = 3
	AuthenticatorTransport_AuthenticatorTransportInternal    AuthenticatorTransport = 4
)

var AuthenticatorTransport_name = map[int32]string{
	0: "AuthenticatorTransportUnspecified",
	1: "AuthenticatorTransportUSB",
	2: "AuthenticatorTransportNFC",
	3: "AuthenticatorTransportBLE",
	4: "AuthenticatorTransportInternal",
}

var AuthenticatorTransport_value = map[string]int32{
	"AuthenticatorTransportUnspecified": 0,
	"AuthenticatorTransportUSB":         1,
	"AuthenticatorTransportNFC":         2,
	"AuthenticatorTransportBLE":         3,
	"AuthenticatorTransportInternal":    4,
}

func (x AuthenticatorTransport) String() string {
	return proto.EnumName(AuthenticatorTransport_name, int32(x))
}
...
const (
	ConveyancePreference_ConveyancePreferenceNoAttestation       ConveyancePreference = 0
	ConveyancePreference_ConveyancePreferenceIndirectAttestation ConveyancePreference = 1
	ConveyancePreference_ConveyancePreferenceDirectAttestation   ConveyancePreference = 2
)

var ConveyancePreference_name = map[int32]string{
	0: "ConveyancePreferenceNoAttestation",
	1: "ConveyancePreferenceIndirectAttestation",
	2: "ConveyancePreferenceDirectAttestation",
}

var ConveyancePreference_value = map[string]int32{
	"ConveyancePreferenceNoAttestation":       0,
	"ConveyancePreferenceIndirectAttestation": 1,
	"ConveyancePreferenceDirectAttestation":   2,
}

func (x ConveyancePreference) String() string {
	return proto.EnumName(ConveyancePreference_name, int32(x))
}
...
type MfaU2FResponse struct {
	Id                   string        `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	PublicKey            *U2FPublicKey `protobuf:"bytes,2,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"`
...
func (m *MfaU2FResponse) GetPublicKey() *U2FPublicKey {
	if m != nil {
		return m.PublicKey
	}
	return nil
...
type U2FPublicKey struct {
	...
	PubKeyCredParams       []*CredentialParameter  `protobuf:"bytes,4,rep,name=pub_key_cred_params,json=pubKeyCredParams,proto3" json:"pub_key_cred_params,omitempty"`
	...
	Extensions             map[string]string       `protobuf:"bytes,8,rep,name=extensions,proto3" json:"extensions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Attestation            ConveyancePreference    `protobuf:"varint,9,opt,name=attestation,proto3,enum=caos.zitadel.auth.api.v1.ConveyancePreference" json:"attestation,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                `json:"-"`
	XXX_unrecognized       []byte                  `json:"-"`
	XXX_sizecache          int32                   `json:"-"`
}

func (m *U2FPublicKey) Reset()         { *m = U2FPublicKey{} }
func (m *U2FPublicKey) String() string { return proto.CompactTextString(m) }
func (*U2FPublicKey) ProtoMessage()    {}
func (*U2FPublicKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_8bbd6f3875b0e874, []int{27}
}

func (m *U2FPublicKey) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_U2FPublicKey.Unmarshal(m, b)
}
func (m *U2FPublicKey) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_U2FPublicKey.Marshal(b, m, deterministic)
}
func (m *U2FPublicKey) XXX_Merge(src proto.Message) {
	xxx_messageInfo_U2FPublicKey.Merge(m, src)
}
func (m *U2FPublicKey) XXX_Size() int {
	return xxx_messageInfo_U2FPublicKey.Size(m)
}
func (m *U2FPublicKey) XXX_DiscardUnknown() {
	xxx_messageInfo_U2FPublicKey.DiscardUnknown(m)
}

var xxx_messageInfo_U2FPublicKey proto.InternalMessageInfo

func (m *U2FPublicKey) GetChallenge() []byte {
	if m != nil {
		return m.Challenge
	}
	return nil
...
func (m *U2FPublicKey) GetRp() *RelyingParty {
	if m != nil {
		return m.Rp
	}
	return nil
...
func (m *U2FPublicKey) GetUser() *UserEntity {
	if m != nil {
		return m.User
	}
	return nil
...
func (m *U2FPublicKey) GetPubKeyCredParams() []*CredentialParameter {
	if m != nil {
		return m.PubKeyCredParams
	}
	return nil
}

func (m *U2FPublicKey) GetAuthenticatorSelection() *AuthenticatorSelection {
	if m != nil {
...
func (m *U2FPublicKey) GetTimeout() int32 {
	if m != nil {
		return m.Timeout
	}
	return 0
...
func (m *U2FPublicKey) GetExcludeCredentials() []*CredentialDescriptor {
	if m != nil {
...
func (m *U2FPublicKey) GetExtensions() map[string]string {
	if m != nil {
		return m.Extensions
	}
	return nil
...
func (m *U2FPublicKey) GetAttestation() ConveyancePreference {
	if m != nil {
		return m.Attestation
	}
	return ConveyancePreference_ConveyancePreferenceNoAttestation
}
...
func (m *RelyingParty) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RelyingParty.Unmarshal(m, b)
}
...
func (m *RelyingParty) XXX_Size() int {
	return xxx_messageInfo_RelyingParty.Size(m)
}
...
func (m *RelyingParty) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *RelyingParty) GetIcon() string {
	if m != nil {
		return m.Icon
	}
	return ""
...
func (m *RelyingParty) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
type CredentialParameter struct {
	Type                 CredentialType `protobuf:"varint,1,opt,name=type,proto3,enum=caos.zitadel.auth.api.v1.CredentialType" json:"type,omitempty"`
...
func (m *CredentialParameter) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CredentialParameter.Unmarshal(m, b)
}
...
func (m *CredentialParameter) XXX_Size() int {
	return xxx_messageInfo_CredentialParameter.Size(m)
}
...
func (m *CredentialParameter) GetType() CredentialType {
	if m != nil {
		return m.Type
	}
	return CredentialType_CredentialTypePublicKey
}

func (m *CredentialParameter) GetAlgorithm() int32 {
	if m != nil {
		return m.Algorithm
	}
	return 0
...
type AuthenticatorSelection struct {
	AuthenticatorAttachment AuthenticatorAttachment     `protobuf:"varint,1,opt,name=authenticator_attachment,json=authenticatorAttachment,proto3,enum=caos.zitadel.auth.api.v1.AuthenticatorAttachment" json:"authenticator_attachment,omitempty"`
	...
	UserVerification        UserVerificationRequirement `protobuf:"varint,3,opt,name=user_verification,json=userVerification,proto3,enum=caos.zitadel.auth.api.v1.UserVerificationRequirement" json:"user_verification,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                    `json:"-"`
	XXX_unrecognized        []byte                      `json:"-"`
	XXX_sizecache           int32                       `json:"-"`
}
...
func (m *AuthenticatorSelection) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AuthenticatorSelection.Unmarshal(m, b)
}
...
func (m *AuthenticatorSelection) XXX_Size() int {
	return xxx_messageInfo_AuthenticatorSelection.Size(m)
}
...
func (m *AuthenticatorSelection) GetAuthenticatorAttachment() AuthenticatorAttachment {
	if m != nil {
		return m.AuthenticatorAttachment
	}
	return AuthenticatorAttachment_AuthenticatorAttachmentUnspecified
}
...
func (m *AuthenticatorSelection) GetUserVerification() UserVerificationRequirement {
	if m != nil {
		return m.UserVerification
	}
	return UserVerificationRequirement_UserVerificationRequirementPreferred
}

type CredentialDescriptor struct {
	Type                 CredentialType           `protobuf:"varint,1,opt,name=type,proto3,enum=caos.zitadel.auth.api.v1.CredentialType" json:"type,omitempty"`
	Id                   []byte                   `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
	Transports           []AuthenticatorTransport `protobuf:"varint,3,rep,packed,name=transports,proto3,enum=caos.zitadel.auth.api.v1.AuthenticatorTransport" json:"transports,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (m *CredentialDescriptor) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CredentialDescriptor.Unmarshal(m, b)
}
...
func (m *CredentialDescriptor) XXX_Size() int {
	return xxx_messageInfo_CredentialDescriptor.Size(m)
}
...
func (m *CredentialDescriptor) GetType() CredentialType {
	if m != nil {
		return m.Type
	}
	return CredentialType_CredentialTypePublicKey
...
func (m *CredentialDescriptor) GetTransports() []AuthenticatorTransport {
	if m != nil {
		return m.Transports
	}
	return nil
...
type VerifyMfaU2F struct {
	...
	RawId                []byte         `protobuf:"bytes,3,opt,name=raw_id,json=rawId,proto3" json:"raw_id,omitempty"`
...
func (m *VerifyMfaU2F) GetType() CredentialType {
	if m != nil {
		return m.Type
	}
	return CredentialType_CredentialTypePublicKey
...
func (m *VerifyMfaU2F) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *VerifyMfaU2F) GetRawId() []byte {
	if m != nil {
		return m.RawId
	}
	return nil
...
func (m *VerifyMfaU2F) GetResponse() *Response {
	if m != nil {
		return m.Response
	}
	return nil
...
type Response struct {
	AttestionObject      []byte   `protobuf:"bytes,1,opt,name=attestion_object,json=attestionObject,proto3" json:"attestion_object,omitempty"`
	ClientData_JSON      []byte   `protobuf:"bytes,2,opt,name=client_data_JSON,json=clientDataJSON,proto3" json:"client_data_JSON,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Response) GetAttestionObject() []byte {
	if m != nil {
		return m.AttestionObject
	}
	return nil
}

func (m *Response) GetClientData_JSON() []byte {
	if m != nil {
		return m.ClientData_JSON
	}
	return nil
}
...
func init() {
	...
	proto.RegisterEnum("caos.zitadel.auth.api.v1.CredentialType", CredentialType_name, CredentialType_value)
	proto.RegisterEnum("caos.zitadel.auth.api.v1.AuthenticatorAttachment", AuthenticatorAttachment_name, AuthenticatorAttachment_value)
	proto.RegisterEnum("caos.zitadel.auth.api.v1.UserVerificationRequirement", UserVerificationRequirement_name, UserVerificationRequirement_value)
	proto.RegisterEnum("caos.zitadel.auth.api.v1.AuthenticatorTransport", AuthenticatorTransport_name, AuthenticatorTransport_value)
	proto.RegisterEnum("caos.zitadel.auth.api.v1.ConveyancePreference", ConveyancePreference_name, ConveyancePreference_value)
	...
	proto.RegisterType((*U2FPublicKey)(nil), "caos.zitadel.auth.api.v1.U2FPublicKey")
	proto.RegisterMapType((map[string]string)(nil), "caos.zitadel.auth.api.v1.U2FPublicKey.ExtensionsEntry")
	proto.RegisterType((*RelyingParty)(nil), "caos.zitadel.auth.api.v1.RelyingParty")
	proto.RegisterType((*UserEntity)(nil), "caos.zitadel.auth.api.v1.UserEntity")
	proto.RegisterType((*CredentialParameter)(nil), "caos.zitadel.auth.api.v1.CredentialParameter")
	proto.RegisterType((*AuthenticatorSelection)(nil), "caos.zitadel.auth.api.v1.AuthenticatorSelection")
	proto.RegisterType((*CredentialDescriptor)(nil), "caos.zitadel.auth.api.v1.CredentialDescriptor")
	proto.RegisterType((*VerifyMfaU2F)(nil), "caos.zitadel.auth.api.v1.VerifyMfaU2f")
	proto.RegisterType((*Response)(nil), "caos.zitadel.auth.api.v1.Response")
	proto.RegisterType((*Raw)(nil), "caos.zitadel.auth.api.v1.Raw")
...
var fileDescriptor_8bbd6f3875b0e874 = []byte{
	...
	,
}
...
type AuthServiceClient interface {
	...
	RemoveMfaU2F(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *authServiceClient) RemoveMfaU2F(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/caos.zitadel.auth.api.v1.AuthService/RemoveMfaU2F", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	RemoveMfaU2F(context.Context, *empty.Empty) (*empty.Empty, error)
...
func (*UnimplementedAuthServiceServer) RemoveMfaU2F(ctx context.Context, req *empty.Empty) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveMfaU2F not implemented")
}
...
func _AuthService_RemoveMfaU2F_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).RemoveMfaU2F(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/caos.zitadel.auth.api.v1.AuthService/RemoveMfaU2F",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).RemoveMfaU2F(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RemoveMfaU2F",
			Handler:    _AuthService_RemoveMfaU2F_Handler,
		},
		{
