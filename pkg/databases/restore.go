...
func GitOpsRestore(
	...
	return restore(monitor, k8sClient, name, func() (*tree.Tree, error) {
...
func CrdRestore(
	...
	return restore(monitor, k8sClient, name,
		func() (*tree.Tree, error) {
...
func restore(
	...
	current := &tree.Tree{}
	query, _, _, _, _, _, err := orbdb.AdaptFunc(name, nil, false, "restore")(monitor, dbTree, current)
	if err != nil {
		monitor.Error(err)
		return err
	}
