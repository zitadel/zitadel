...
// Source: github.com/caos/zitadel/pkg/admin/grpc (interfaces: AdminServiceClient)
...
import (
	context "context"
	grpc "github.com/caos/zitadel/pkg/admin/grpc"
...
func (m *MockAdminServiceClient) AddIamMember(arg0 context.Context, arg1 *grpc.AddIamMemberRequest, arg2 ...grpc0.CallOption) (*grpc.IamMember, error) {
	m.ctrl.T.Helper()
...
func (m *MockAdminServiceClient) ChangeIamMember(arg0 context.Context, arg1 *grpc.ChangeIamMemberRequest, arg2 ...grpc0.CallOption) (*grpc.IamMember, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockAdminServiceClient) GetIamMemberRoles(arg0 context.Context, arg1 *emptypb.Empty, arg2 ...grpc0.CallOption) (*grpc.IamMemberRoles, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*grpc.IamMemberRoles)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAdminServiceClient) RemoveIamMember(arg0 context.Context, arg1 *grpc.RemoveIamMemberRequest, arg2 ...grpc0.CallOption) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockAdminServiceClient) SearchIamMembers(arg0 context.Context, arg1 *grpc.IamMemberSearchRequest, arg2 ...grpc0.CallOption) (*grpc.IamMemberSearchResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*grpc.IamMemberSearchResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
