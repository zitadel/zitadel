...
test("login with Gitlab IDP - auto redirect", async ({user, page}) => {
    // Given idp Gitlab is configure on the organization as only authencation method
    // Given the user has only idp Gitlab added as auth method
...
test("login with Gitlab IDP - auto redirect, error", async ({user, page}) => {
    // Given idp Gitlab is configure on the organization as only authencation method
    // Given the user has only idp Gitlab added as auth method
    ...
    // User is redirect to ZITADEL login
    // Error is shown to the user "Something went wrong in Gitlab Login"
});


test("login with Gitlab IDP", async ({user, page}) => {
    // Given username password and idp Gitlab is configure on the organization as authencation method
    // Given the user has username password and Gitlab configured

    // Login form shows username field and a Gitlab Login button
    // User clicks on the Gitlab button
...
test("login with Gitlab IDP, error", async ({user, page}) => {
    // Given username password and idp Gitlab is configure on the organization as authencation method
    // Given the user has username password and Gitlab configured
...
test("login with Gitlab IDP, no user existing - auto register", async ({user, page}) => {
    // Given idp Gitlab is configure on the organization as only authencation method
...
test("login with Gitlab IDP, no user linked - auto link", async ({user, page}) => {
    // Given idp Gitlab is configure on the organization as only authencation method
