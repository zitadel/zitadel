...
test("login with Google IDP - auto redirect, error", async ({user, page}) => {
    // Given idp Google is configure on the organization as only authencation method
    // Given the user has only idp Google added as auth method
    ...
    // User is redirect to ZITADEL login
    // Error is shown to the user "Something went wrong in Google Login"
});


test("login with Google IDP", async ({user, page}) => {
    // Given username password and idp Google is configure on the organization as authencation method
    // Given the user has username password and Google configured

    // Login form shows username field and a Google Login button
    // User clicks on the Google button
...
test("login with Google IDP, error", async ({user, page}) => {
    // Given username password and idp Google is configure on the organization as authencation method
    // Given the user has username password and Google configured
...
test("login with Google IDP, no user existing - auto register", async ({user, page}) => {
    // Given idp Google is configure on the organization as only authencation method
...
test("login with Google IDP, no user linked - auto link", async ({user, page}) => {
    // Given idp Google is configure on the organization as only authencation method
