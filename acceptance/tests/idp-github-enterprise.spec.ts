...
test("login with GitHub Enterprise IDP - auto redirect", async ({user, page}) => {
    // Given idp GitHub Enterprise is configure on the organization as only authencation method
    // Given the user has only idp GitHub Enterprise added as auth method
...
test("login with GitHub Enterprise IDP - auto redirect, error", async ({user, page}) => {
    // Given idp GitHub Enterprise is configure on the organization as only authencation method
    // Given the user has only idp GitHub Enterprise added as auth method
    ...
    // User is redirect to ZITADEL login
    // Error is shown to the user "Something went wrong in GitHub Enterprise Login"
});


test("login with GitHub Enterprise IDP", async ({user, page}) => {
    // Given username password and idp GitHub Enterprise is configure on the organization as authencation method
    // Given the user has username password and GitHub Enterprise configured

    // Login form shows username field and a GitHub Enterprise Login button
    // User clicks on the GitHub Enterprise button
...
test("login with GitHub Enterprise IDP, error", async ({user, page}) => {
    // Given username password and idp GitHub Enterprise is configure on the organization as authencation method
    // Given the user has username password and GitHub Enterprise configured
...
test("login with GitHub Enterprise IDP, no user existing - auto register", async ({user, page}) => {
    // Given idp GitHub Enterprise is configure on the organization as only authencation method
...
test("login with GitHub Enterprise IDP, no user linked - auto link", async ({user, page}) => {
    // Given idp GitHub Enterprise is configure on the organization as only authencation method
