...
test("login with Generic JWT IDP - auto redirect", async ({user, page}) => {
    // Given idp Generic JWT is configure on the organization as only authencation method
    // Given the user has only idp Generic JWT added as auth method
...
test("login with Generic JWT IDP - auto redirect, error", async ({user, page}) => {
    // Given idp Generic JWT is configure on the organization as only authencation method
    // Given the user has only idp Generic JWT added as auth method
    ...
    // User is redirect to ZITADEL login
    // Error is shown to the user "Something went wrong in Generic JWT Login"
});


test("login with Generic JWT IDP", async ({user, page}) => {
    // Given username password and idp Generic JWT is configure on the organization as authencation method
    // Given the user has username password and Generic JWT configured

    // Login form shows username field and a Generic JWT Login button
    // User clicks on the Generic JWT button
...
test("login with Generic JWT IDP, error", async ({user, page}) => {
    // Given username password and idp Generic JWT is configure on the organization as authencation method
    // Given the user has username password and Generic JWT configured
...
test("login with Generic JWT IDP, no user existing - auto register", async ({user, page}) => {
    // Given idp Generic JWT is configure on the organization as only authencation method
...
test("login with Generic JWT IDP, no user linked - auto link", async ({user, page}) => {
    // Given idp Generic JWT is configure on the organization as only authencation method
