...
func DomainInstanceListModelToGRPCResponse(instances []*domain.Instance) []*instance_v2beta.Instance {
...
func DomainInstanceModelToGRPCResponse(inst *domain.Instance) *instance_v2beta.Instance {
...
func domainInstanceDomainListModelToGRPCResponse(dms []*domain.InstanceDomain) []*instance_v2beta.Domain {
