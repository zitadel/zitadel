...
type Instance struct {
	...
	ManagementConsoleClientID string    `json:"managementConsoleClientId,omitempty" db:"console_client_id"`
	ManagementConsoleAppID    string    `json:"managementConsoleAppId,omitempty" db:"console_app_id"`
