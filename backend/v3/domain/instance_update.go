...
func (u *UpdateInstanceCommand) Events(ctx context.Context, _ *CommandOpts) ([]eventstore.Command, error) {
...
func (u *UpdateInstanceCommand) Execute(ctx context.Context, opts *CommandOpts) (err error) {
	...
	if updateCount > 1 {
		err = zerrors.ThrowInternal(NewMultipleObjecstUpdatedError(1, updateCount), "DOM-HlrNmD", "unexpected number of rows updated")
		return err
	}
...
func (u *UpdateInstanceCommand) Validate(ctx context.Context, opts *CommandOpts) error {
