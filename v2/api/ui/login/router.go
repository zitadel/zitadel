...
func CreateRouter(login *Login, staticDir http.FileSystem, baseRouter *mux.Router, interceptors ...mux.MiddlewareFunc) *mux.Router {
	router := baseRouter.NewRoute().Subrouter()
