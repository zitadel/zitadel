...
describe('instance notifications', () => {
  ...
  describe('smtp settings', () => {
    ...
    it(`should change Mailgun SMTP provider settings`, () => {
      ...
      cy.get('[formcontrolname="user"]').should('be.enabled').clear().type('change@example.com');
      cy.get('[data-e2e="continue-to-2nd-form"]').click();
    ...
    it(`should add Mailjet SMTP provider settings`, () => {
      ...
      cy.get('[formcontrolname="password"]').should('be.enabled').clear().type('password');
      cy.get('[data-e2e="continue-to-2nd-form"]').click();
      cy.get('[formcontrolname="senderAddress"]').should('be.enabled').clear().type('sender2@example.com');
      cy.get('[formcontrolname="senderName"]').should('be.enabled').clear().type('Test2');
      cy.get('[formcontrolname="replyToAddress"]').should('be.enabled').clear().type('replyto2@example.com');
      cy.get('[data-e2e="continue-button"]').click();
      cy.get('[data-e2e="create-button"]').click();
      cy.shouldConfirmSuccess();
      cy.get('[data-e2e="close-button"]').click();
    ...
    it(`should delete Mailjet SMTP provider`, () => {
      ...
      cy.get('[data-e2e="confirm-dialog-input"]').focus().should('be.enabled').type('Test2');
      cy.get('[data-e2e="confirm-dialog-button"]').click();
      cy.shouldConfirmSuccess();
      rowSelector = `tr:contains('mailjet')`;
    ...
    it(`should delete Mailgun SMTP provider`, () => {
      ...
      cy.visit(smtpPath);
      cy.get(rowSelector).find('[data-e2e="delete-provider-button"]').click({ force: true });
      cy.get('[data-e2e="confirm-dialog-input"]').focus().should('be.enabled').type('Change1');
      cy.get('[data-e2e="confirm-dialog-button"]').click();
      cy.shouldConfirmSuccess();
      rowSelector = `tr:contains('mailgun')`;
      cy.get(rowSelector).should('not.exist');
    ...
    it(`should delete Mailgun SMTP provider`, () => {
      ...
      cy.visit(smtpPath);
      cy.get(rowSelector).find('[data-e2e="delete-provider-button"]').click({ force: true });
      cy.get('[data-e2e="confirm-dialog-input"]').focus().should('be.enabled').type('Test1');
      cy.get('[data-e2e="confirm-dialog-button"]').click();
      cy.shouldConfirmSuccess();
      rowSelector = `tr:contains('mailgun')`;
      cy.get(rowSelector).should('not.exist');
  ...
  describe('sms settings', () => {
    ...
    it(`should add SMS provider`, () => {
      ...
      cy.get('[formcontrolname="token"]').should('be.enabled').clear()
