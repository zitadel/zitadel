...
This example uses **[Symfony Security](https://symfony.com/doc/current/security.html)**, the standard authentication component for Symfony applications. Symfony Security implements the [OpenID Connect (OIDC)](https://zitadel.com/docs/apis/openidoauth/endpoints) flow through a custom authenticator, manages [PKCE](/docs/concepts/pkce), performs secure [token exchange](https://zitadel.com/docs/apis/openidoauth/endpoints), and provides [session management](https://zitadel.com/docs/concepts/sessions) through Symfony's firewall system.
