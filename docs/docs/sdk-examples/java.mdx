...
- [API APP Step-By-Step Guide](/docs/examples/secur-api/java-spring)
...
The [zitadel-java](https://github.com/zitadel/zitadel-java) repository includes an Example Application ready to start and show how a Vue application looks like with integrated ZITADEL Login.
...
The [Step-By-Step Guide](/docs/examples/login/vue) leads you through the whole process from configuring the right application in ZITADEL to a ready application with integrated login or authentication checks.
