...
* **PKCE concept:** [/docs/guides/integrate/login/oidc/login-users#pkce](/docs/guides/integrate/login/oidc/login-users#pkce)
* **PKCE application setup:** [/docs/concepts/structure/applications](/docs/concepts/structure/applications)
