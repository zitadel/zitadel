...
2. Create a `.env` file in the project root and configure it with the values from your [ZITADEL Application](/docs/guides/manage/console/applications-overview):
```
...
- The **Client ID** you copied when creating the application in the [PKCE setup](/docs/guides/manage/console/applications-overview)
