...
Before running this example, you need to create and configure a PKCE application in the [ZITADEL Console](https://zitadel.com/docs/guides/manage/console/overview). Follow the **[Application Setup guide](/docs/guides/manage/console/applications-overview)** to:
