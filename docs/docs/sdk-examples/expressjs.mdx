...
1. Create a new Web application in your [Zitadel project](https://zitadel.com/docs/guides/manage/console/console-overview)
...
2. Create a `.env.local` file and configure it with the values from your [Zitadel application](https://zitadel.com/docs/guides/manage/console/console-overview). Use the exact environment variable names from the repository:
   ```
