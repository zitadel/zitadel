...
2. Create a `.env.local` file and configure it with the values from your [Zitadel Application](/docs/guides/manage/console/applications-overview). Use the exact environment variable names from the repository:
   ```
   ...
   Replace these values with:
	- Your actual Zitadel instance URL (the **Issuer** from the [PKCE setup guide](/docs/guides/manage/console/applications-overview))
