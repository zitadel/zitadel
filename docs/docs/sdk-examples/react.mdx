...
2. Create a `.env` file (copy from `.env.example`) and configure it with the values from your [Zitadel application](https://zitadel.com/docs/guides/manage/console/applications). **Use these exact environment variable names:**
```
...
* **PKCE concept:** [https://zitadel.com/docs/concepts/pkce](https://zitadel.com/docs/concepts/pkce)
* **PKCE application setup:** [https://zitadel.com/docs/guides/integrate/login/oidc/pkce-setup](https://zitadel.com/docs/guides/integrate/login/oidc/pkce-setup)
