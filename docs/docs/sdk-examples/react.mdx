...
<table>
    <tr>
        <td width="100px">
            <img width="100px" src="/docs/img/tech/react.svg" alt="react"/>
        </td>
        <td>
            <a href="https://react.dev/" target="_blank">React</a> is a declarative, component-based JavaScript library for building user interfaces.
            Integrate authentication to your React application easily by using the <a href="https://github.com/zitadel/zitadel-react" target="_blank">zitadel-react</a> SDK.
        </td>
    </tr>
</table>
