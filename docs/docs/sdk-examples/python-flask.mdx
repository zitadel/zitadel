...
<table>
    <tr>
        <td width="100px">
            <img width="100px" src="/docs/img/tech/flask.svg" alt="python logo" className="hideonlight"/>
            <img width="100px" src="/docs/img/tech/flasklight.svg" alt="python logo" className="hideondark"/>
        </td>
        <td>
