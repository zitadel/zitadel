...
We the third-party providers, mentioned in our [List of Subprocessors](https://trust.zitadel.com/subprocessors),  that collect and process certain analytics data on our behalf.
...
We will provide additional notice via to you if we make any changes that materially affect your privacy rights.
