...
To calculate the monthly amount we summerize the activated external identity providers over all instances on each day and take the rounded up average over a given month.
