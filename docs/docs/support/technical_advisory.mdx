...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      These refactored components do not support dynamic styling, so from ...
      the console UI will loose its dynamic theming capability. If you need
      users to have your branding settings (background-, button-, link and text
      coloring) you should implemement your own user facing UI yourself and not
      use ZITADELs console UI.
    </td>
    <td>TBD</td>
  </tr>
</table>
