...
![Same Site Strict Enforcement](/img/manuals/errors/same-site-strict.png)
...
You might encounter this error message from ZITADEL, typically when you authenticated with a application in one project and trying to access an application in another project.
