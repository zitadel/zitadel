...
<Column>
  ...
  <ListWrapper title="Structure">
    ...
    <ListElement link="./structure/overview" type={ICONTYPE.FILE} title="Organizations" description="" />
    <ListElement link="./structure/overview" type={ICONTYPE.FILE} title="Policies" description="" />
    <ListElement link="./structure/overview" type={ICONTYPE.FILE} title="Projects" description="" />
    </div>
    <div>
    <ListElement link="./structure/overview" type={ICONTYPE.FILE} title="Applications" description="" />
    <ListElement link="./structure/overview" type={ICONTYPE.FILE} title="Granted Projects" description="" />
    <ListElement link="./structure/overview" type={ICONTYPE.FILE} title="Users" description="" />
    <ListElement link="./structure/overview" type={ICONTYPE.FILE} title="Managers" description="" />
    </div>
    </Column>
  </ListWrapper>
