...
1. **Default Settings:** [Administrators](/docs/concepts/structure/administrators) can access and manage the default settings of the ZITADEL system. This includes configuring authentication methods, security policies, and other system-wide parameters to meet the organization's requirements.
...
7. **Administrator Assignment:** Administrators can assign ZITADEL [administrators](/docs/concepts/structure/administrators) who have elevated privileges for managing resources within the organization. This allows for the delegation of administrative tasks while maintaining proper oversight and control.
