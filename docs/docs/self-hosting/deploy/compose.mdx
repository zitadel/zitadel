...
:::info
If you you ran these commands for an existing instance that still uses the login v1, [connect it to the now running v2 login](/self-hosting/manage/login-client#create-login-client).
:::
