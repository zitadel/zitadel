...
With this example configuration, you run Zitadel and the default login at the same domain using [Docker Compose](https://docs.docker.com/compose/).
...
- A Zitadel container that is accessable via Traefik at all other paths than `/ui/v2/login`.
...
- **username**: *zitadel-admin@<span></span>zitadel.zitadel*
- **password**: *Password1!*
