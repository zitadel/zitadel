...
- A cockroachDB or Postgresql as only needed storage (Make sure to read our [Production Guide](./self-hosting/manage/production#prefer-cockroachdb) before you decide to use Postgresql it.
)
