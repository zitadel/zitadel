...
import Steps from './env/_steps.mdx'
import Defaults from './env/_defaults.mdx'
...
Currently it is not possible to configure maps of values with environment variables, use a configuration file instead.

<details>
    <summary>List of environment variables for database initialization </summary>
    Check the <a href="#database-initialization-file">Database initialization file</a> for a full reference, if default values are omitted.
    <Steps />
</details>
<details>
    <summary>List of environment variables for runtime configuration</summary>
    Check the <a href="#runtime-configuration-file">Runtime configuration file</a>for a full reference, if default values are omitted.
    <Defaults />
</details>
