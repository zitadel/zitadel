...
You can configure the runtime settings by using the file [defaults.yaml](https://github.com/zitadel/zitadel/blob/main/cmd/defaults.yaml).

:::tip First Instance Configuration
...
You can use environment variables to configure the runtime.

:::info Complete List of Environment Variables
A complete list of environment variables can be found in the [defaults.yaml](https://github.com/zitadel/zitadel/blob/main/cmd/defaults.yaml).
::: 

Environment Variable | Description | Default Value
--- | --- | ---
ZITADEL_EXTERNALSECURE | True | ExternalSecure specifies if ZITADEL is exposed externally using HTTPS or HTTP. [Read more about external access](https://zitadel.com/docs/self-hosting/manage/custom-domain).
ZITADEL_EXTERNALDOMAIN | localhost | ExternalPort is the domain on which end users access ZITADEL. [Read more about external access](https://zitadel.com/docs/self-hosting/manage/custom-domain).
ZITADEL_DATABASE_POSTGRES_ADMIN_USERNAME | | [defaults.yaml](https://github.com/zitadel/zitadel/blob/main/cmd/defaults.yaml)
ZITADEL_DATABASE_POSTGRES_USER_SSL_MODE | | [defaults.yaml](https://github.com/zitadel/zitadel/blob/main/cmd/defaults.yaml)
