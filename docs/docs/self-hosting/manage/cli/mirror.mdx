...
Follow the [Linux](/docs/self-hosting/deploy/linux#run-postgresql) guide to start the database or use the following commands for [Docker Compose](/docs/self-hosting/deploy/compose)
