...
The last step is to setup the permissions and verify the data, there might be differences between source destination, refer to [`zitadel mirror verify`](#zitadel-mirror-verify) to get an overview of possible diffs.
