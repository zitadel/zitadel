...
Flags:
  -h, --help                     help for mirror
      ...
      --ignore-previous          ignores previous migrations of the events table. This flag should be used if you copy to a fresh environment with the same name as a previous migration.
