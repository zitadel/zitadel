...
The `mirror` command allows you to do database to database migrations as well as migrations to/from databases to/from files. This functionality is useful to copy data from a database/file to another.
