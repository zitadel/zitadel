...
For single instance setups which fulfilled all milestone (*your next steps* in management console) it is not needed to enable this cache. We mainly use it for ZITADEL cloud where there are many instances with *incomplete* milestones.
