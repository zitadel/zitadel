...
However, if you want to access ZITADEL at an organization domain, [you can add additional domains using the System API](/reference/deprecated#tag/system/POST/system/v1/instances/{instanceId}/domains).
