...
Additionally, you can use the [session API](../reference#tag/sessions) to authenticate users, for example by building a [custom login UI](/docs/guides/integrate/login-ui/).
...
ZITADEL allows to authenticate users by creating a session with the [Session API](/docs/reference#tag/sessions) or get OIDC authentication request details with the [OIDC service API](/docs/reference#tag/openid-connect-oidc).
...
ZITADEL provides APIs for each [core resource](/docs/reference#tag/healthz):

- [User](/docs/reference#tag/users)
- [Session](/docs/reference#tag/sessions)
- [Settings](/docs/reference#tag/settings)
...
API Reference:
[OpenAPI Docs](/reference/deprecated#tag/auth)
...
API Reference:
[OpenAPI Docs](/reference/deprecated#tag/management-service)
...
API Reference:
[OpenAPI Docs](/reference/deprecated#tag/admin-service)
...
API Reference:
[OpenAPI Docs](/reference/deprecated#tag/system)
