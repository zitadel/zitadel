...
[Action](/docs/apis/actions/introduction) allow to extend ZITADEL with custom code to change default behaviors or calling external systems.
...
- [Organization](/docs/apis/resources/mgmt)
- [Instance lifecycle](/docs/apis/resources/system) & [Instance objects](/docs/apis/resources/admin)
