...
Follow the guides to learn how to [authenticate service users](/docs/guides/integrate/serviceusers).

Accessing the ZITADEL APIs through a service user might require additional steps, please follow the guide on how to [access ZITADEL APIs](../guides/integrate/zitadel-apis/) to include the correct audience scope in your requests.
