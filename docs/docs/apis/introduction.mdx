...
ZITADEL allows to authenticate users by creating a session with the [Session API](/docs/reference#tag/sessions) or get OIDC authentication request details with the [OIDC service API](/docs/apis/resources/oidc_service).
