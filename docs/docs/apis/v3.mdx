...
- LimitBulk (partial update of block and audit log retention for multiple instances)

### ZITADELInstanceDomains

Additional methods for instance domains:
...
<!-- Additionally various checks to update and validate sessions.-->
...
- standard CRUD on instances for Executions
- standard CRUD on instances for Targets

### ZITADELIdentityProviders (reusable)

Standard CRUD and methods for reusable resources
