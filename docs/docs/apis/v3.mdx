...
- Resources:
    ...
    - Limits
    - Projects
    - Grants (target types project and user)
    - Memberships (target types org and instance)
    - IDP Auth Factors
    - Apps
    - Auth Factors
    - IDPs
...
- System level resource if no context is given
- Instance level resource if instance context is given
- Org level resource if org context is given
- Effective resource returned on GET requests reflecting with resolved values for the given context or the system level if no context is given
