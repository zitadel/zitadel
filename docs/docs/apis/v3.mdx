...
We invite you to...
- ... join [the next office hours](https://zitadel.com/office-hours?event=1248016231936692274) and discuss the new API with us in person.
- ... share your thoughts about the concepts [by opening discussions on GitHub](https://github.com/zitadel/zitadel/discussions/new/choose).
