...
- Standard CRUD and methods for reusable UserSchemas <!-- TODO verify -->

### ZITADELSessions

Additional method for Challenge which returns an updated session. <!-- TODO verify -->
...
- standard CRUD for context-aware Executions <!-- TODO verify -->
- standard CRUD and methods for reusable Targets <!-- TODO verify -->
...
previously known as password complexity and password age policy (do we still need the password age policy? <!-- TODO verify-->)
