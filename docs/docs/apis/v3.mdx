...
- For pagination, [we provide a *next_page_token*](https://protobuf.dev/programming-guides/api/#define-pagination-api) in the response. <!-- TODO verify @muhlemmer -->
...
- GetOIDCInformation (replaces the management services GetIAM method <!-- TODO verify @muhlemmer --> )
...
- All methods from the auth service that are not defined in this document already (list and revoke tokens <!-- TODO verify @livio-a -->, list permissions etc.)

### ZITADELUserSchemas

- Standard CRUD and methods for reusable UserSchemas <!-- TODO verify @hifabienne-->
...
- standard CRUD for Executions
- standard CRUD for Targets
...
<!-- TODO should we integrate this into the user schema? @livio-a -->
