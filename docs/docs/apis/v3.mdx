...
For a concrete proto example, have a look at the [ZITADELActions service](#zitadel.resources.action.v3alpha.ZITADELActions).
...
For a concrete proto example, have a look at the [ZITADELIdentityProviders service](#zitadel.resources.idp.v3alpha.ZITADELIdentityProviders).
...
### zitadel.settings.language.v3alpha.ZITADELLanguageSettings
...
### zitadel.settings.text.v3alpha.ZITADELTextSettings

key-value pairs for localized login texts, previously known as login texts

### zitadel.settings.branding.v3alpha.ZITADELBrandingSettings

predefined branding settings and custom key-value pairs, previously known as label policy or branding settings

### zitadel.settings.login.v3alpha.ZITADELLoginSettings

previously known as login policy

### zitadel.settings.lockout.v3alpha.ZITADELLockoutSettings

previously known as lockout policy

### zitadel.settings.password.v3alpha.ZITADELPasswordSettings

previously known as password complexity policy

### zitadel.settings.help.v3alpha.ZITADELHelpSettings

previously known as legal and support settings or privacy policy

### zitadel.settings.domain.v3alpha.ZITADELDomainSettings

previously known as domain policy

### zitadel.settings.feature.v3alpha.ZITADELFeatureSettings

feature toggles

also contains disallow public org registrations on system and instance level.

### zitadel.settings.template.v3alpha.ZITADELTemplatesSettings

html and text templates for fully customizable emails and sms

### zitadel.settings.secret.v3alpha.ZITADELSecretSettings

replaces secret generators

## zitadel.insights.v3alpha.ZITADELInsights
