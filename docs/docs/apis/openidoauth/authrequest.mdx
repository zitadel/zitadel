...
<p>
  <span className="text-orange-500">Response Type</span> termines whether a
...
Enforce a organization's policies and branding as well as membership of the user by passing the scope `urn:zitadel:iam:org:id:{id}` with the required <span className="text-purple-500">Organization ID</span>.
