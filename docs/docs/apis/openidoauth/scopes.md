...
| urn:zitadel:iam:org:private:labeling:id:{org_id} | `{"urn:zitadel:iam:org:private:labeling:id": "74161146763996133"}`             | By using this scope the private labeling of the requested organisation id will trigger.                                                                                              |
