...
| `urn:zitadel:iam:org:project:id:{projectid}:aud`  | `urn:zitadel:iam:org:project:id:69234237810729019:aud`  | By adding this scope, the requested projectid will be added to the audience of the access and id token                                                                                                                                                                |
...
:::note
If access to ZITADEL's API's is needed, e.g. with a service user the scope `urn:zitadel:iam:org:project:id:ZITADEL:aud` needs to be used with the authorization request
:::
