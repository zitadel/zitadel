...
Creation can be done from ZITADEL Console (*https://`ZITADEL_DOMAIN`.zitadel.cloud/ui/console/orgs/create*). You can choose your current account for the organization owner or create a new one.
...
To setup your organizations login policy, go to your organizations detail in Console (https://`ZITADEL_DOMAIN`.zitadel.cloud/ui/console/org).
