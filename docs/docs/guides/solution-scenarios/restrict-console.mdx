...
With this workaround, you will limit users from accessing the [default-project](/docs/guides/manage/console/projects-overview#default-project), if they are not explicitly granted to use this project.
...
Start by granting the organization of your managers, that should be able to access the Console, the [default project](/docs/guides/manage/console/projects-overview#default-project):
...
To avoid accidental lock-out, the [default project](/docs/guides/manage/console/projects-overview#default-project) hides the checkbox "Check Project on Authentication" in the Console:
