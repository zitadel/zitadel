...
You need to use the [update project API call](/docs/reference/deprecated#tag/management-service/PUT/management/v1/projects/{id}) to set the configuration on the project.
