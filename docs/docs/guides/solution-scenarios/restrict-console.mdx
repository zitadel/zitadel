...
Start by granting the organization of your managers, that should be able to access the Management Console, the [default project](/docs/guides/manage/console/projects-overview#the-default-project):
...
To avoid accidental lock-out, the [default project](/docs/guides/manage/console/projects-overview#the-default-project) hides the checkbox "Check Project on Authentication" in the Management Console:
