...
If you are self-hosting, you can also enable the feature for the complete system (all instances) using the [set system level features](/docs/reference#tag/features/PUT/v2/features/system) endpoint.
