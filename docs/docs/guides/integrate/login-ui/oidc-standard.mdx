...
Implement all the steps you like the user the go trough by [creating](/docs/reference#tag/sessions/POST/v2/sessions) and [updating](/docs/reference#tag/sessions/PATCH/v2/sessions/{sessionId}) the user-session.
