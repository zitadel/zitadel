...
The /loginname page allows you to enter loginname or email of a user which is then used to search for a user.
...
The self service part of the application allows you to load the Login app without an OIDC flow.
