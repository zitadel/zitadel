...
![Register OTP SMS](/img/guides/login-ui/register-phone-otp-flow.png)
...
![Authenticate OTP SMS](/img/guides/login-ui/authenticate-phone-otp-flow.png)
...
![Register OTP Email](/img/guides/login-ui/register-email-otp-flow.png)
