...
[Start Identity Provider Intent Documentation](/docs/reference#tag/users/user-service-start-identity-provider-intent)
...
[Retrieve Identity Provider Intent Documentation](/docs/reference#tag/users/user-service-retrieve-identity-provider-intent)
...
[Create User API Documentation](/docs/reference#tag/users/user-service-add-human-user)
...
[Add IDP Link to existing user documentation](/docs/reference#tag/users/user-service-add-idp-link)
