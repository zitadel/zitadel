...
To get the current state of the session, you can call the [GetSession endpoint](/reference#tag/sessionssession-service-get-session),
resp. you can get several by [searching sessions](/reference#tag/sessionssession-service-list-sessions).
