...
In case one of your applications requires the OAuth2 Device Authorization Grant this guide will show you how to implement
...
client_id=170086824411201793%40yourapp&
...
Present the user_code and verification_uri or maybe even render a QR code with the verification_uri_complete for the user to scan.
...
```bash
curl --request POST \
  --url $ZITADEL_DOMAIN/v2/oidc/device_authorization/JKSh3oijfoodih13hqiu12sakj \
