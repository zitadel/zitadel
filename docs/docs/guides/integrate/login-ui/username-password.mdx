...
[Create User Documentation](/reference#tag/users/user-service-add-human-user)
...
- [Get Login Settings](/reference#tag/settings/settings-service-get-login-settings) To find out which authentication possibilities are enabled (password, identity provider, etc.)
- [Get Password Complexity Settings](/reference#tag/settings/settings-service-get-password-complexity-settings) to find out how the password should look like (length, characters, etc.)
...
- [Create new session Documentation](/reference#tag/sessionssession-service-create-session)
- [Update an existing session Documentation](/reference#tag/sessionssession-service-set-session)
- [Get Session Documentation](/reference#tag/sessionssession-service-get-session)
