...
If you do have custom fields you like to add to your users that are not provided by ZITADEL, you can add them to the metadata.
Metadata are key values you can use for additional user data.
