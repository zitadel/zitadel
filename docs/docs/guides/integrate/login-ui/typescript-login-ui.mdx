...
To replace the old login UI built with Golang and to showcase the use of our session and OIDC APIs, we've created the [Typescript Login UI](https://github.com/zitadel/zitadel/blob/main/CONTRIBUTING.md#contribute-to-login).
