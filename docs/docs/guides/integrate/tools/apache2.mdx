...
We use the module module `mod_auth_openidc` in this guide.
...
| OIDCRedirectURI | Users will be redirected to this page after successful login. If you are using localhost make sure to enable development mode in ZITADEL. | http://localhost:8080/secure/callback |
