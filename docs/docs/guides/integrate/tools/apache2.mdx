...
|---|---|---|
| OIDCProviderMetadataURL | Is the url to the discovery endpoint, which is typically located at *`ZITADEL_DOMAIN`*/.well-known/openid-configuration| https://<span></span>my-zitadel.zitadel.cloud/.well-known/openid-configuration |
