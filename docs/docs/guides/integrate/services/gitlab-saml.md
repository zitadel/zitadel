...
- `Identity provider single sign-on URL`: *`ZITADEL_DOMAIN`*/saml/v2/SSO
- `Certificate fingerprint`: You need to download the certificate from *`ZITADEL_DOMAIN`*/saml/v2/certificate and create a SHA1 fingerprint
