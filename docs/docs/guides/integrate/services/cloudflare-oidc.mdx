...
3. Fill in the required information. Check the discovery endpoint of your instance (https://*`ZITADEL_DOMAIN`*/.well-known/openid-configuration) for the urls. As mentioned in the Cloudflare docs the Certificate Url is jwks_uri.
...
```json
{
  "config": {
    ...
    "auth_url": "https://ZITADEL_DOMAIN.zitadel.cloud/oauth/v2/authorize",
    "token_url": "https://ZITADEL_DOMAIN.zitadel.cloud/oauth/v2/token",
    "certs_url": "https://ZITADEL_DOMAIN.zitadel.cloud/oauth/v2/keys",
