...
- Make sure that you [verify the same domain also in your ZITADEL organization and set it as organization domain](/docs/guides/manage/console/organizations-overview#primary-domain)
