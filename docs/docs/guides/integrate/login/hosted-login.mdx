...
Login methods can be a user's username, containing the username and an [organization domain](/docs/guides/manage/console/organizations-overview#domain-verification-guide), their email addresses, or their phone numbers.
