...
### Multi-tenant enterprise single-sign-on
...
ZITADEL acts as [identity broker](/docs/concepts/features/identity-brokering)

- Identity providers per tenant
- Domain discovery
- Available templates [Okta](/docs/guides/integrate/identity-providers/okta) or [Entra ID](/docs/guides/integrate/identity-providers/azure-ad) 
- [LDAP](/docs/guides/integrate/identity-providers/ldap)
