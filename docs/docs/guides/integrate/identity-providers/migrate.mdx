...
To migrate, you either use the [Migrate Generic OIDC Identity Provider (Instance)](/docs/reference/deprecated#tag/admin-service/POST/admin/v1/idps/generic_oidc/{id}/_migrate) or [Migrate Generic OIDC Identity Provider (Organization)](/reference/deprecated#tag/identity-providers/POST/management/v1/idps/generic_oidc/{id}/_migrate) API request.
