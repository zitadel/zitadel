---
title: Configure Keycloak as Identity Provider
...
<GenericOIDC
    name=": e.g. Keycloak"
    issuer=": The domain of your Keycloak account and /auth/realms/$REALM, Example: https://lemur-0.cloud-iam.com/auth/realms/acme"
