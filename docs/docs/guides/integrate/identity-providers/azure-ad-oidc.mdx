...
3. Choose "Web" in the redirect uri field and paste the ZITADEL Callback URL you copied before.
...
Go back to the Microsoft provider template you opened before.
Add the client ID and secret created before on your Entra ID application.
