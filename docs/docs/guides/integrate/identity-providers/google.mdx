...
4. Paste the callback URL you copied before to the Authorised redirect URIs
...
Go back to the Google provider template you opened before.
It has as much as possible preconfigured.
