...
3. Proceed to **Assertion Creation**:
   ...
   - Add additional attributes you want to send to ZITADEL (you need at least `email`, `given_name`, `family_name`, and you can send optional attributes like `display_name`).
