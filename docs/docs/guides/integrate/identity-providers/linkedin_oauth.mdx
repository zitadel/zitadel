...
![Activate the OKTA Provider](/img/guides/zitadel_activate_linkedin.png)

## Test the setup

<TestSetup loginscreen="your LinkedIn login"/>

![OKTA Button](/img/guides/zitadel_login_linkedin.png)

![OKTA Login](/img/guides/linkedin_login.png)
