...
- [Update Default Login Settings](/docs/reference/deprecated#tag/settings/PUT/admin/v1/policies/login)
- [Update Organization Login Settings](/docs/reference/deprecated#tag/login-settings/PUT/admin/v1/policies/login)
