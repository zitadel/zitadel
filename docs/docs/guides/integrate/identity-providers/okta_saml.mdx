...
- [Add Default SAML Identity Provider](/docs/reference/deprecated#tag/admin-service/POST/admin/v1/idps/samlr)
- [Add SAML Identity Provider on Organization](/docs/reference/deprecated#tag/identity-providers/POST/management/v1/idps/saml)
...
- [Update Default SAML Identity Provider](/docs/reference/deprecated#tag/identity-providers/PUT/admin/v1/idps/saml/{id}r)
- [Update SAML Identity Provider on Organization](/docs/reference/deprecated#tag/identity-providers/PUT/management/v1/idps/saml/{id})
