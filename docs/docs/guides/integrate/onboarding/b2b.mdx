...
[Restrict the instance features](/docs/reference/deprecated#tag/features)
...
Detailed description of [Setup Organization](/docs/reference/deprecated#tag/organizations/POST/admin/v1/orgs/_setup)
...
[Set Organization Metadata](/docs/reference/deprecated#tag/management-service/POST/management/v1/metadata/{key})
If you have more than one field, you can use the bulk add request:
[Bulk Set Organization Metadata](/docs/reference/deprecated#tag/management-service/POST/management/v1/metadata/_bulk)

The same requests also exist on the user resource:
[Set User Metadata](/docs/reference/deprecated#tag/management-service/POST/management/v1/users/{id}/metadata/{key})
[Bulk Set User Metadata](/docs/reference/deprecated#tag/management-service/POST/management/v1/users/{id}/metadata/_bulk)
