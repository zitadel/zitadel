...
Depending on your Software Development Life Cycle (SDLC) you will have to create multiple organizations to keep your data from different environments separate.
