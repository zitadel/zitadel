...
ZITADEL holds bi-weekly community calls. To join the community calls use [this link], or find further information [here](https://github.com/zitadel/zitadel/blob/main/MEETING_SCHEDULE.md).
