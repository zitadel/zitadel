...
ZITADEL holds bi-weekly community calls. To join the community calls use [this link](zitadel.com/office-hours), or find further information [here](https://github.com/zitadel/zitadel/blob/main/MEETING_SCHEDULE.md).
