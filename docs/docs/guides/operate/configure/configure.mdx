...
This guide assumes you are already familiar with [running ZITADEL with the most minimal configuration possible](/docs/guides/deploy/self-hosted).
...
The ZITADEL management console [requires end-to-end HTTP/2 support](/docs/guides/operate/http2)
