...
wget https://raw.githubusercontent.com/zitadel/zitadel/v2-alpha/docs/docs/guides/operate/loadbalancing-example/docker-compose.yaml

# Download the docker compose example configuration. For example:
wget https://raw.githubusercontent.com/zitadel/zitadel/v2-alpha/docs/docs/guides/operate/loadbalancing-example/example-traefik.yaml

# Download and adjust the example configuration file containing standard configuration
wget https://raw.githubusercontent.com/zitadel/zitadel/v2-alpha/docs/docs/guides/operate/loadbalancing-example/example-zitadel-config.yaml

# Download and adjust the example configuration file containing secret configuration
wget https://raw.githubusercontent.com/zitadel/zitadel/v2-alpha/docs/docs/guides/operate/loadbalancing-example/example-zitadel-secrets.yaml

# Download and adjust the example configuration file containing database initialization configuration
wget https://raw.githubusercontent.com/zitadel/zitadel/v2-alpha/docs/docs/guides/operate/loadbalancing-example/example-zitadel-init-steps.yaml
