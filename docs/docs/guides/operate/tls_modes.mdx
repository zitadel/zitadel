...
The mode `external` allow you to configure ZITADEL in such a way that it will instruct its clients to use https.
...
You can read more about how ZITADEL utilizes in our [HTTP/2 docs](./http2).