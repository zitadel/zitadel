...
Use the [OIDC authentication request playground](https://zitadel.com/playgrounds/oidc) or the configuration of an [example application](/docs/sdk-examples/introduction) to set the required scopes and receive a valid access token.
