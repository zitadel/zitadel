...
We can do so by calling the [create user schema endpoint](/docs/reference#tag/users-schema-preview/POST/resources/v3alpha/user_schemas)
...
Finally, we call the [update user schema endpoint](/docs/reference#tag/users-schema-preview/GET/resources/v3alpha/user_schemas/{id})
...
To check the state of existing schemas you can simply [list them](/reference#tag/users-schema-preview/POST/resources/v3alpha/user_schemas/_search).
...
The API also allows to retrieve a single [schema by ID](/reference#tag/users-schema-preview/GET/resources/v3alpha/user_schemas/{id}).
