...
<Tabs>
  ...
  First [add a new SMS Provider of type HTTP](/reference/deprecated#tag/admin-service/POST/admin/v1/sms/http) to create a new HTTP provider that can be used to send SMS messages:
  ...
  To use the HTTP provider you need to [activate the SMS provider](/reference/deprecated#tag/admin-service/POST/admin/v1/sms/{id}/_activate): 
  ...
  See full API reference for [SMS Providers](/reference/deprecated#tag/sms-providers) for more details.

  </TabItem>
  <TabItem value="email" label="Email">

    First [add a new Email Provider of type HTTP](/reference/deprecated#tag/email-providers/POST/admin/v1/email/) to create a new HTTP provider that can be used to send SMS messages:
  ...
  To use the HTTP provider you need to [activate the Email provider](/reference/deprecated#tag/email-providers/POST/admin/v1/email/{id}/_activate):
  ...
  See full API reference for [Email Providers](/reference/deprecated#tag/email-providers/POST/admin/v1/email/_search) for more details.
