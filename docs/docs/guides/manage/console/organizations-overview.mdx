...
1.  **Current User:** Create the organization with your currently logged-in user as the organization administrator. A membership for the new organization will be added to your account.
