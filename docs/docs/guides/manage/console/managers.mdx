...
You can add users of your organization or from external organizations. When adding users from other organizations you have to enter their username.
If you don't remember it navigate to the users page and copy the username from the detail page.
