...
As of October 2022, ZITADEL uses your users email as their username to login.
This means that usernames for your whole instance are unique.

### User Loginname must contain orgdomain

If this behaviour is not suitable for you, ZITADEL has the option to generate loginnames for each user of an organization.
