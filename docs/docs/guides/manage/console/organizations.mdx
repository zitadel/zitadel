...
To create a new organization, click on the organization dropdown and then select “New organization”.
You can either create a new organization with your logged-in user as the organization administrator or directly create another account.
If you choose your logged in user as organization administrator, a membership for the new organization will be added to the account.
...
- [**Verified domains**](/docs/guides/manage/console/organizations-overview#usernames-and-domains): This is where you manage your organization specific domains which can be used to build usernames
