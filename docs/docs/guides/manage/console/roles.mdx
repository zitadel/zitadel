...
In you would build out the POS use case you would probably need an application for administration.
...
Now you can retrieve those roles in your application. ZITADEL has multiple settings for you to access them more easily. Navigate the **General** section of your project and check your needed ones.
