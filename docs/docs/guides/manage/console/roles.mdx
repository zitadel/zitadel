...
If you wanted to test your application with your own user, navigate to the **Role Assignments** section under your project and click on **new**.
...
> Note: We set up the role assignments from projects, but this can be achieved from multiple locations in console. You can view and assign roles from the organization, the projects, or from the users page.
