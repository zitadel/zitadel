...
To create a project, navigate to your organization, then projects or directly via *https://`ZITADEL_DOMAIN`.zitadel.cloud/ui/console/projects*, and then click the button to create a new project.
...
In a B2B use case, you would typically use the organization setting. If you want to omit organization detection, you can preselect an organization with the [primary domain scope](/apis/openidoauth/scopes#reserved-scopes) (ex. *urn:zitadel:iam:org:domain:primary:`DOMAIN_NAME`*).
