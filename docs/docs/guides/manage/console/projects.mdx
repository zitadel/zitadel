...
- **Unspecified**: As soon as the user is identified, the branding of the organization of the identified user will be shown, before the system default is shown.
- **Use project setting**: The branding of the organization which owns the project will be shown
- **Use organization setting**: The branding of the organization of the project will be shown, but as soon as the user is identified, the setting of the organization of the identified user, will be shown.
