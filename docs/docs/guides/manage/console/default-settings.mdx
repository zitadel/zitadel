...
- **Multifactor Init Lifetime** specifies after which period a user will be prompted to setup a 2-Factor / Multifactor during the login process (value 0 will deactivate the prompt)
- **Second Factor Check Lifetime** specifies after which period a user has to revalidate the 2-Factor during the login process
- **Multifactor Login Check Lifetime** specifies after which period a user has to revalidate the Multifactor during the login process
