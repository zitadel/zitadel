...
Also you can enable the use of the default redirect URI as the url associated with the button that appears in every notification message

<img
  src="/docs//img/guides/solution-scenarios/use_default_redirect_uri_notification_links.png"
  alt="Login Policy Advanced Setting: Use default redirect URI for notification links"
  width="600px"
/>
