...
For a secure installation with Docker Compose, [go to the loadbalancing example](/docs/guides/manage/self-hosted/loadbalancing-example)
...
wget https://raw.githubusercontent.com/zitadel/zitadel/v2-alpha/docs/docs/guides/manage/self-hosted/configure/example-zitadel-values.yaml

# Download and adjust the example configuration file containing secret configuration
wget https://raw.githubusercontent.com/zitadel/zitadel/v2-alpha/docs/docs/guides/manage/self-hosted/configure/example-zitadel-values-secrets.yaml
