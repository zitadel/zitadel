...
For a secure installation with Docker Compose, [go to the loadbalancing example](/docs/guides/operate/loadbalancing-example)
...
wget https://raw.githubusercontent.com/zitadel/zitadel/v2-alpha/docs/docs/guides/operate/configure/example-zitadel-values.yaml

# Download and adjust the example configuration file containing secret configuration
wget https://raw.githubusercontent.com/zitadel/zitadel/v2-alpha/docs/docs/guides/operate/configure/example-zitadel-values-secrets.yaml
