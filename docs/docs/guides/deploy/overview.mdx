...
- When run as a proof of concept, ZITADEL does not need many resources, 1 CPU and 512MB memory are more than enough. (With more CPU, the password hashing might be faster)
...
As soon as you successfully created your first proof of concept using one of the deployment guides in this section,
...
For achieving high availablility, we recommend to use [Kubernetes](https://kubernetes.io/docs/home/).
