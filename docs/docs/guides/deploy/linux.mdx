...
Download a `cockroach` binary as described
[in the CockroachDB docs](https://www.cockroachlabs.com/docs/v22.1/install-cockroachdb).
...
Download the ZITADEL release according to your architecture from
[Github](https://github.com/zitadel/zitadel/releases/latest)
