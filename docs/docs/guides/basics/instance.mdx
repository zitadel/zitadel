...
Login with the user you have initialized. You will find the url to access your instance in the initialization email of your user or in the detail of your instance.

The domain is generated and looks something like this: {InstanceName}-{RandomString}.zitadel.cloud

**Customer Portal - Instance Find Instance Domain:**
