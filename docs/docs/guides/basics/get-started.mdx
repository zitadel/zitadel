...
Now you can proceed adding users to your organization as well as integrating your applications. 
Consider reading our [Architecture Scenarios](../architecture-scenarios/introduction) Guide for a more detailed guide to get started with our very own use case
and take a look at our [Quickstarts](../../quickstarts/introduction) for developers.
