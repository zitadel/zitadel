...
[API reference: User Metadata](https://zitadel.com/docs/apis/resources/mgmt/user-metadata)
:::
...
[API reference: User Authorization / Grants](https://zitadel.com/docs/apis/resources/auth/user-authorizations-grants)
:::