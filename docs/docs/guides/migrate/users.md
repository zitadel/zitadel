...
Creating individual users can be done with this endpoint: [ImportHumanUser](/docs/reference/deprecated#tag/management-service/POST/management/v1/users/human).
...
For bulk import use the [import endpoint](/docs/reference/deprecated#tag/importexport) on the admin API:
...
[API reference: User Metadata](/docs/reference/deprecated#tag/management-service/DELETE/management/v1/users/{id}/metadata/{key)
:::
...
[API reference: User Authorization / Grants](/docs/reference/deprecated#tag/my-user)
:::