...
The "Redirect URI" is preconfigured to http://localhost:3000/callback and the “Post Logout URI” to http://localhost:3000/ for the React App example.
...
3. Run the following command to create a new React Appnamed "react-oidc-zitadel":
