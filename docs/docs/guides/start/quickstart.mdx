...
![Create Application](/img/guides/quickstart/create_app_1.png)

5. Provide a name for your application (e.g., "App1") and choose the type of your application.
...
![Select Application Type](/img/guides/quickstart/create_app_2.png)

6. In the next step, choose the Authentication Method for your application. For this example, we will select "PKCE" (recommended because it's the most secure.) and click "Continue".

![Select Authentication Method](/img/guides/quickstart/create_app_3.png)

7. Now, we will configure the Redirect URLs for our application.
...
![Configure Redirect URLs](/img/guides/quickstart/create_app_4.png)

8. Click on "Continue" to proceed further, and you will see an overview of your application configuration.

![Application Configuration Overview](/img/guides/quickstart/create_app_5.png)
...
![Client ID and Secret](/img/guides/quickstart/create_app_6.png)

10. After creating the application, you will see a summary of your application's configuration.

![Application Summary](/img/guides/quickstart/create_app_8.png)
...
![Get URLs](/img/guides/quickstart/app_urls.png)
