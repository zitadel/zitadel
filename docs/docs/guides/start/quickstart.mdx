...
2. Provide a name for your instance and click on the Next button at the bottom of this screen.

![Create Instance Name](/img/guides/quickstart/create_instance_name.png)

3. Select your data region. Choose the data region closest to your users to ensure optimal performance and compliance with data regulations. After selecting the appropriate region, click "Next".

4. Next, you should see the following screen. Add a username and password for the instance administrator and click "Next".

![Create Instance Admin](/img/guides/quickstart/create_instance_admin.png)

5. Review your instance details and click on the "Create Instance" button.

6. After creating your first instance, you're ready to configure user authentication. To access the management console, click the 'Create your app' button.

![Sign In Instance](/img/guides/quickstart/sign_in_instance.png)

7. To log in to your instance, provide the username and password you set in the instance creation, and click “next”.

8. Skip the 2-factor authentication for now by clicking “skip”.

9. And there you go! You now have access to your instance.

![Instance Details](/img/guides/quickstart/instance_dashboard.png)

### 4. Create your first project and app with Quick Create

ZITADEL's Quick Create feature streamlines the setup process by automatically configuring your application and project with the optimal settings for your chosen framework.

#### What is Quick Create?

Quick Create automatically bootstraps all the core OIDC settings you need for your specific app type or framework, allowing you to get started quickly without manually configuring authentication settings. It pre-configures:

- **App Type** (User Agent for SPAs, Web for SSR frameworks)
- **Authentication Method** (appropriate for your framework's security profile)
- **Grant Types** (Authorization Code with PKCE)
- **Response Types** (Code flow)
- **Redirect URIs** (framework-specific callback URLs for local development)
- **Post Logout URIs** (where users return after signing out)
- **Additional Settings** (like ID token assertions for SSR frameworks)

:::info
All settings configured by Quick Create can be customized later in your application settings. This feature simply provides sensible defaults to help you get started faster.
:::

#### Create your app

1. Click the "Create Application" button or select your Framework/Language from the options on the right side

2. Select your designed framework and click continue.

![Project Name and Framework/Language](/img/guides/quickstart/create_project_react.png)

:::tip
If you want to select your own project name, or existing project, uncheck the "Create project for me" checkbox and enter your desired project name or select an existing project from the dropdown.
:::

:::info
The framework is arbitrary and only used to pre-fill recommended settings, and give guidance to appropriate examples and installation help. You can still use the generated configuration with any framework or language of your choice.
:::

#### Understanding the auto-generated configuration

For the React example, Quick Create automatically configures:

- **App Type**: User Agent (for Single Page Applications)
- **Auth Method**: None (PKCE provides security without client secrets)
- **Grant Types**: Authorization Code (the most secure OAuth 2.0 flow)
- **Response Types**: Code (for the Authorization Code flow)
- **Redirect URI**: `http://localhost:3000/callback` (where ZITADEL redirects after authentication)
- **Post Logout URI**: `http://localhost:3000` (where users return after logout)

We recommend using the [Authorization Code Flow](/docs/apis/openidoauth/grant-types#authorization-code) with [Proof Key for Code Exchange (PKCE)](/docs/apis/openidoauth/grant-types#authorization-code) for secure OIDC configuration. More about the different app types can be found [here](/docs/guides/integrate/login/oidc/oauth-recommended-flows#different-client-profiles).

:::note Different frameworks, different configurations
Quick Create adjusts settings based on your framework choice:

- **SPAs** (React, Vue, Angular): User Agent app type with PKCE
- **SSR frameworks** (Next.js, Nuxt, Astro): Web app type with additional token assertions
- **Mobile apps**: Native app type with appropriate redirect schemes
- **Backend services**: Service account or API configurations
  :::

3. The quickstart guide for your selected framework/language is displayed. Follow the steps in the guide to set up your application.

![Project Name and Framework/Language](/img/guides/quickstart/app_detail_overview_react.png)

:::tip Customizing your configuration
Need to adjust the auto-generated settings? You can modify any of these values later:

- Navigate to your project in the console
- Select your application
- Update settings in the "Configuration" tab
- Common changes include adding production redirect URIs or adjusting token lifetimes
  :::
