...
<li><b>Project</b>: A project is a logical separation within an organization and is a container for apps, roles, users and authorization policies for the resources it contains.</li> 
...
<li><b>Roles</b>: Roles are the sets of permissions and privileges that are assigned to users within a project. They define the actions that a user is allowed to perform within the project, such as reading and writing data, or managing other users and resources.</li> 
...
And with that, configuring Zitade for our application is complete. Now we can move on to building our React application. Let's get coding!
