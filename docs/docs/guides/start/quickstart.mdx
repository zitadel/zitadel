...
2. Enter **Project1** (or any name of your choice) as the project's name and select the framework/language you're using—in this case, "React"—then click the **Continue** button.
