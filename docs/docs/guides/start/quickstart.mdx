...
5. Enter your login details. Provide the password you just created. Click "next".
...
6. If you entered the correct login details (and if the PKCE parameters generated by the application match), you will be redirected to the callback page, which displays your user information.
