...
For example, you might create an instance for each product in a B2C scenario, or an instance for each tenant or customer in a B2B scenario.
The possibilities are endless. You can create your first instance for free.

1. Let’s create an instance. Click on “Create Instance”.
...
3. You will now see an overview of the configuration for the framework you have selected

![Project Configuration Overview - React App](/img/guides/quickstart/project_config_overview_react.png)

For some clarification what the configuration does:
...
4. Now you will see the detail configuration of your app.
