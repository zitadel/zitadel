...
To get started, you need to register on the ZITADEL Cloud Customer Portal.
1. **Sign Up**: Go to [zitadel.com](http://zitadel.com) and select Sign Up. You can register via Email, Google, or Gitlab.

![Home Page](/img/guides/quickstart/cloud_sign_up.png)
![Registration Page](/img/guides/quickstart/cloud_register.png)

2. **Register Team**: Enter your company or team name to initialize your Customer Portal account for shared management.

![Registration Team Page](/img/guides/quickstart/cloud_register_team.png)

3. **Verify Email**: Check your inbox and enter the verification code to activate your account.
...
4. **Secure your Account**: Select an authentication method.
Note: We recommend using Passkeys for the most secure and seamless login experience.

![Register Authentication Method](/img/guides/quickstart/cloud_register_authentication.png)
![Register Authentication Method Passkey](/img/guides/quickstart/cloud_register_authentication_passkey.png)

5. **Finalize**: Authenticate using your chosen method to enter the Customer Portal.
...
1. **Start**: Click the Create Instance button on your dashboard.

![Create Instance](/img/guides/quickstart/cloud_create_instance.png)

2. **Identity**: Provide an Instance Name (e.g., prod-customer-auth) and click Next.

![Create Instance Name](/img/guides/quickstart/cloud_create_instance_name.png)

3. **Locality**: Select your preferred Region.

![Create Instance Region](/img/guides/quickstart/cloud_create_instance_region.png)

4. **Admin Setup**: Define your Instance Administrator credentials. This user has root access to manage all settings within this specific instance.
