...
As you already learned at the [Terminologies](#zitadel-terminology-instances-organizations-projects-users-roles-authorizations-and-apps) ZITADEL knows the concept of Organizations.
You can define [default settings](/docs/guides/manage/console/instance-settings) for your ZITADEL, or you can overwrite them for an [Organization](/docs/guides/manage/console/organizations#organization-settings).
