...
[src/components/Login.tsx](https://github.com/zitadel/zitadel-react/blob/main/src/components/Login.tsx)
...
6.  Now you can think about styling your application. Edit the `index.css` and `App.css` to apply CSS styling to the pages.
