...
## Setting Up Application and Obtaining Keys
...
### Creating and Configuring the Auth Module
...
Our example includes a _StatehandlerService_ that redirects the user back to the route from which they initially came.
...
### Adding Logout to Your Application
