...
![Project settings in management console](/img/django/project-settings.png)
...
![Project roles in management console](/img/django/project-roles.png)

Finally, we can assign the roles to users in the project's authorizations tab.

![Project authorizations in management console](/img/django/project-authorizations.png)
...
![Create app in management console](/img/django/app-create.png)
...
![Configure app authentication method in management console](/img/django/app-auth-method.png)
...
![Configure app redirects management console](/img/django/app-redirects.png)
