...
import { EnvInterpolate } from "../../../src/components/environment";
...
<EnvInterpolate>
  {
    "Replace the clientId value 'YOUR-CLIENT-ID' with the generated client id of you application in ZITADEL Console ({clientId})"
  }
</EnvInterpolate>
