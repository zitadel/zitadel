...
> If you are following along with the [example](https://github.com/zitadel/zitadel-angular), set dev mode to `true` and the Redirect URIs to *http://<span></span>localhost:3000/api/auth/callback/zitadel*.
