...
The used base is the "Writing your first Django app"-app from the Django documentation under [https://docs.djangoproject.com/en/5.0/intro/](https://docs.djangoproject.com/en/5.0/intro/),
...
To connect with ZITADEL through OpenID connect, you need to install a OIDC dependency, we will use the [mozilla-django-oidc](https://github.com/mozilla/mozilla-django-oidc). Run the following command:
