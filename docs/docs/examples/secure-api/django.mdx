...
```python reference
https://github.com/zitadel/example-python-django-oauth/blob/main/mysite/settings.py#L127-L132
```
...
Install requests so the HTTP requests can be created:
...
```python reference
https://github.com/zitadel/example-python-django-oauth/blob/main/mysite/validator.py
```
...
```python reference
https://github.com/zitadel/example-python-django-oauth/blob/main/mysite/views.py
```

To handle endpoints the urls have to be added to the urls.py:

```python reference
https://github.com/zitadel/example-python-django-oauth/blob/main/mysite/urls.py
```
