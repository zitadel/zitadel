            ...
            "self-hosting/deploy/kubernetes",
            {
              ...
              "items": [
                ...
                },
                {
                  ...
                  "label": "Reverse Proxy",
                  "items": [
                    "self-hosting/manage/reverseproxy/traefik",
                    "self-hosting/manage/reverseproxy/nginx",
                    "self-hosting/manage/reverseproxy/caddy",
                    "self-hosting/manage/reverseproxy/httpd",
                    "self-hosting/manage/reverseproxy/cloudflare",
                    "self-hosting/manage/reverseproxy/cloudflare_tunnel",
                    "self-hosting/manage/reverseproxy/zitadel_cloud",
                  ],
                },
                {
                  "type": "category",
