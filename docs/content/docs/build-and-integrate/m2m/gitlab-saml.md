...
- existing ZITADEL Instance, if not present follow [this guide](/docs/build-and-integrate/quickstarts/quickstart)
- existing ZITADEL Organization, if not present follow [this guide](/docs/manage/org-management/organizations)
- existing ZITADEL project, if not present follow the first 3 steps [here](/docs/manage/projects-apps/projects)
