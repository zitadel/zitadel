...
- Make sure that you [verify the same domain also in your ZITADEL organization and set it as primary domain](/docs/manage/org-management/organizations#domain-verification-and-primary-domain)
