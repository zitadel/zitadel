...
10. Resource Server validates the JWT with [token introspection](/docs/build-and-integrate/token-inspection)
...
<Callout type="info" title="Make sure to save the key file. You won't be able to retrieve it again.">
...
* `aud` must be your [Custom Domain](/docs/learn/features/custom-domain)
...
Please refer to [JWT with private key](/docs/reference/openidoauth/authn-methods#jwt-with-private-key) API reference for further information.
...
* `scope` should contain any [Scopes](/docs/reference/openidoauth/scopes) you want to include, but must include `openid`.
...
Follow our guides on [how to access ZITADEL API](/docs/reference/api/guides/access-zitadel-apis) to use the ZITADEL APIs with your service user.
...
Follow our [guide on token introspection with private key JWT](/docs/build-and-integrate/token-inspection/private-key-jwt) to learn more.
...
* [JWT with private key](/docs/reference/openidoauth/authn-methods#jwt-with-private-key) API reference
* [Accessing ZITADEL API](/docs/reference/api/guides/access-zitadel-apis)
* [Token introspection with private key JWT](/docs/build-and-integrate/token-inspection/private-key-jwt)
