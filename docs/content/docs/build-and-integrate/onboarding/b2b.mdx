...
[Restrict the instance features](/docs/references/resources/admin/admin-service-set-restrictions)
...
Detailed description of [Setup Organization](/docs/references/resources/admin/admin-service-set-up-org#setup-organization)
...
[Set Organization Metadata](/docs/references/resources/mgmt/management-service-set-org-metadata)
If you have more than one field, you can use the bulk add request:
[Bulk Set Organization Metadata](/docs/references/resources/mgmt/management-service-bulk-set-org-metadata)

The same requests also exist on the user resource:
[Set User Metadata](/docs/references/resources/mgmt/management-service-set-user-metadata)
[Bulk Set User Metadata](/docs/references/resources/mgmt/management-service-bulk-set-user-metadata)
