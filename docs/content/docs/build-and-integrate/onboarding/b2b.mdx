...
We will also explain how to leverage [Managers](/docs/manage-and-govern/console/managers) to delegate self-service team management and configuration of policies to users of each organization.
...
Each ZITADEL instance does automatically bring a management console with it. The [console](/docs/manage-and-govern/console/overview) can be used to manage all your resources through a UI.
You can access it by calling the following URL: `${CUSTOM-DOMAIN}/ui/`
Make sure that your admins have a [Manager role](/docs/manage-and-govern/console/managers) with permissions on an instance level such as "INSTANCE_OWNER"
...
<img src="/img/guides/solution-scenarios/create-org-dropdown.png" alt="Create Organization Dropdown"/>

2. If you are on the instance level, go to the Organization tab and click the "+ New" button above the Organization list.

<img src="/img/guides/solution-scenarios/org-list-add-new.png" alt="Organization List - Add new Organization"/>
...
<img src="/img/guides/solution-scenarios/create-organization.png" alt="Create Organization"/>
...
import CreateUser from '../../manage-and-govern/console/_create-user.mdx';
...
If you do want to know more about the roles check out the [ZITADEL Managers Guide with the Role List](/docs/manage-and-govern/console/managers)
...
import AddManager from "../../manage-and-govern/console/_add_manager.mdx";
...
<Callout type="info" title="The following actions can also be configured by an Instance Administrator for their customer.">
...
2. [Add role "ORG_OWNER" to the user](./b2b#add-manager-role-to-user)
...
3. Configure the identity provider you need.
   Follow our detailed configuration description of the different providers we have: [Configure the needed identity provider](/docs/build-and-integrate/identity-providers/introduction)
...
<Callout type="info" title="It is only possible to automatically create accounts, that send all the required information to register a new user.">
...
[Example for prefilling user data automatically](/docs/build-and-integrate/identity-providers/additional-information#automatically-pre-fill-user-data)
...
<img src="/img/guides/solution-scenarios/user-login-with-external-idp.png" alt="User Login with SSO"/>
...
You can read more about the managers, roles and their meanings [here](/docs/manage-and-govern/console/managers)

<img src="/img/guides/solution-scenarios/register-organization.png" alt="Register Organization Form"/>
...
[Restrict the instance features](/docs/references/api-v1/admin/zitadel.admin.v1.AdminService.SetRestrictions)
...
<img src="/img/guides/solution-scenarios/register-team-graphic.png" alt="Setup Organiation with Admin User Graphic"/>
...
Detailed description of [Setup Organization](/docs/references/api-v1/admin/zitadel.admin.v1.AdminService.SetUpOrg)
...
[Set Organization Metadata](/docs/references/api-v1/management/zitadel.management.v1.ManagementService.SetOrgMetadata)
If you have more than one field, you can use the bulk add request:
[Bulk Set Organization Metadata](/docs/references/api-v1/management/zitadel.management.v1.ManagementService.BulkSetOrgMetadata)

The same requests also exist on the user resource:
[Set User Metadata](/docs/references/api-v1/management/zitadel.management.v1.ManagementService.SetUserMetadata)
[Bulk Set User Metadata](/docs/references/api-v1/management/zitadel.management.v1.ManagementService.BulkSetUserMetadata)
