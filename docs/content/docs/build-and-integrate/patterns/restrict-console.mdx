...
Read more about how to set the default redirect URI: [Settings - Default Redirect URI](/docs/manage/policies/default-settings#default-redirect-uri)

### Restricting Console in default-project

With this workaround, you will limit users from accessing the [default-project](/docs/learn/structure/projects#default-project), if they are not explicitly granted to use this project.
...
Start by granting the organization of your managers, that should be able to access the Console, the [default project](/docs/learn/structure/projects#default-project):
...
To avoid accidental lock-out, the [default project](/docs/learn/structure/projects#default-project) hides the checkbox "Check Project on Authentication" in the Console:
...
More detailed information about creating a PAT and manager roles you can find [here](/docs/build-and-integrate/m2m/personal-access-token)
