...
2. Configure the needed identity provider: Read this [guide](/docs/manage/federation/introduction) if you don't know how
...
More about the [scopes](/docs/reference/openidoauth/scopes#reserved-scopes)
...
Read more about [applications](/docs/manage/projects-apps/applications) and the [redirect urls](/docs/manage/projects-apps/applications)
