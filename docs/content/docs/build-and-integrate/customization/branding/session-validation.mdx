...
To get the current state of the session, you can call the [GetSession endpoint](/docs/reference/api/session/zitadel.session.v2.SessionService.GetSession),
resp. you can get several by [searching sessions](/docs/reference/api/session/zitadel.session.v2.SessionService.ListSessions).
