...
If you haven’t added a provider yet, have a look at the following guide first: [Identity Providers](/docs/manage/federation/introduction)
...
[Start Identity Provider Intent Documentation](/docs/reference/api/user/zitadel.user.v2.UserService.StartIdentityProviderIntent)
...
[Retrieve Identity Provider Intent Documentation](/docs/reference/api/user/zitadel.user.v2.UserService.RetrieveIdentityProviderIntent)
...
[Create User API Documentation](/docs/reference/api/user/zitadel.user.v2.UserService.AddHumanUser)
...
[Add IDP Link to existing user documentation](/docs/reference/api/user/zitadel.user.v2.UserService.AddIDPLink)
