...
Read more about the [SSO Endpoint Documentation](/docs/reference/saml/endpoints#sso-endpoint)
...
[Get SAML Request By ID Documentation](/docs/reference/api/saml/zitadel.saml.v2.SAMLService.GetSAMLRequest)
...
Implement all the steps you like the user to go trough by [creating](/docs/reference/api/session/zitadel.session.v2.SessionService.CreateSession) and [updating](/docs/reference/api/session/zitadel.session.v2.SessionService.SetSession) the user-session.
...
Read more about the [Finalize SAML Request Documentation](/docs/reference/api/saml/zitadel.saml.v2.SAMLService.CreateResponse)
