...
More detailed information about the API: [Get Login Settings Documentation](/docs/reference/api/settings/zitadel.settings.v2.SettingsService.GetLoginSettings)
