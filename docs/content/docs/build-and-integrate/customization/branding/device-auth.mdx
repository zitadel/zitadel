...
[Get Device Authorization Request Documentation](/docs/reference/api/oidc/zitadel.oidc.v2.OIDCService.GetDeviceAuthorizationRequest)
...
Implement all the steps you like the user the go trough by [creating](/docs/reference/api/session/zitadel.session.v2.SessionService.CreateSession) and [updating](/docs/reference/api/session/zitadel.session.v2.SessionService.SetSession) the user-session.
...
Read more about the [Authorize or Deny Device Authorization Request Documentation](/docs/reference/api/oidc/zitadel.oidc.v2.OIDCService.AuthorizeOrDenyDeviceAuthorization)
...
Additionally, we recommend you to proxy all the other [OIDC relevant endpoints](/docs/reference/openidoauth/endpoints).