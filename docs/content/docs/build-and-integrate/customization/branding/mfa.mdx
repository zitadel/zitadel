...
If ZITADEL should do it, make sure that you have registered an [SMS Provider](/docs/manage/policies/default-settings#sms) and send an empty sendCode object in the request.
