...
For an example on how to check the signature, [refer to the example](/docs/build-and-integrate/customization/actions/testing-request-signature).
...
The concept of events can be found under [Events](/docs/learn/architecture/software#events)
