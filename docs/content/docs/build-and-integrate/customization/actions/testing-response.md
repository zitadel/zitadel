...
<Callout type="info" title="The signature of the received request can be checked, [please refer to the example for more information on how to](/docs/build-and-integrate/customization/actions/testing-request-signature).">
