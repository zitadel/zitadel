...
If you want to know more where actions can be useful, take a look at the feature [here](/docs/learn/features/actions) or directly jump to an example of a custom behavior [here](/docs/build-and-integrate/customization/general/behavior).
