...
<img src="/img/actions-v2/webhook-xhr.png" alt="Screenshot: Webhook.site XHR Redirect configuration interface"/> 
...
<img src="/img/actions-v2/console.png" alt="Screenshot: Console output showing listener receiving webhook requests"/>
...
<img src="/img/actions-v2/webhook-url.png" alt="Screenshot: Webhook.site target creation interface"/>
...
<img src="/img/actions-v2/local-listener.png" alt="Screenshot: Local listener output"/>

Your Webhook.site should look like this:
<img src="/img/actions-v2/webhook-listener.png" alt="Screenshot: Webhook.site request log"/>
