...
In this guide, you will create a [ZITADEL action](/docs/learn/features/actions).
...
- [Your ZITADEL organization needs to have at least one external identity provider enabled](/docs/manage/federation/introduction)
- [You need to have at least one role configured for a project](/docs/manage/projects-apps/projects)
...
Now, make the action hook into the [external authentication flow](/docs/reference/actions/external-authentication).
...
- [Read more about the concepts around actions](/docs/learn/features/actions)
- [Read more about all the options you have with actions](/docs/reference/actions/introduction)
