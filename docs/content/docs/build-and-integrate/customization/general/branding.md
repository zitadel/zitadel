...
Send a [reserved scope](/docs/reference/openidoauth/scopes) with your [authorization request](/docs/reference/openidoauth/endpoints#authorization-endpoint) to trigger your organization.
