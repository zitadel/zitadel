...
However, if you are self-hosting and need to control your virtual instances usage, [read about the APIs for limits and quotas](/docs/operate/configure/usage_control) that are intended to be used by system users.
