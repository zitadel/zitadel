...
<Callout type="info" title="Back-Channel Logout is currently an experimental [beta](/docs/manage/support/software-release-cycles-support#beta) feature.">
...
configuration, e.g. [creating an OIDC application](https://zitadel.com/docs/reference/resources/mgmt/management-service-add-oidc-app).
