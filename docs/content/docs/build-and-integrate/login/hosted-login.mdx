...
It employs best practices for securing authentication processes, such as encryption, token-based authentication, and adherence to protocols like OAuth 2.0, [OpenID Connect](/docs/build-and-integrate/login/oidc), and [SAML](/docs/build-and-integrate/login/).
...
We have worked on a new, self-hostable implementation of our hosted MIT licensed login built with Next.js and leveraging our [Session API](/docs/build-and-integrate/login/login-users#zitadels-session-api).
