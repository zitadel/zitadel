...
More detailed information about the API: [Start TOTP Registration Documentation](/docs/references/api/user/zitadel.user.v2.UserService.RegisterTOTP)
...
More detailed information about the API: [Verify TOTP Documentation](/docs/references/api/user/zitadel.user.v2.UserService.VerifyTOTPRegistration)
...
More detailed information about the API: [Create new session Documentation](/docs/references/api/session/zitadel.session.v2.SessionService.CreateSession)
...
If ZITADEL should do it, make sure that you have registered an [SMS Provider](/docs/manage-and-govern/console/default-settings#sms) and send an empty sendCode object in the request.
...
More detailed information about the API: [Add phone](/docs/references/api/user/zitadel.user.v2.UserService.SetPhone)
...
More detailed information about the API: [Verify phone](/docs/references/api/user/zitadel.user.v2.UserService.VerifyPhone)
...
More detailed information about the API: [Add OTP SMS for a user](/docs/references/api/user/zitadel.user.v2.UserService.AddOTPSMS)
...
More detailed information about the API: [Add OTP Email for a user](/docs/references/api/user/zitadel.user.v2.UserService.AddOTPEmail)
...
More detailed information about the API: [Start U2F Registration Documentation](/docs/references/api/user/zitadel.user.v2.UserService.RegisterU2F)
...
More detailed information about the API: [Verify U2F Documentation](/docs/references/api/user/zitadel.user.v2.UserService.VerifyU2FRegistration)
