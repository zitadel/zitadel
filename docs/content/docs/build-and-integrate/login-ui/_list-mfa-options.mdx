...
More detailed information about the API: [Get Login Settings Documentation](/docs/references/api/settings/zitadel.settings.v2.SettingsService.GetLoginSettings)
