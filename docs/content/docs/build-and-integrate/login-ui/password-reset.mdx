...
[Request Password Reset Documentation](/docs/references/api/user/zitadel.user.v2.UserService.PasswordReset)
...
[Change Password Documentation](/docs/references/api/user/zitadel.user.v2.UserService.SetPassword)

<Callout type="info" title="This request can be used in the password reset flow as well as to let your user change the password manually.">
