...
Read more about the [Authorize Endpoint Documentation](/docs/references/openidoauth/endpoints#authorization-endpoint)
...
[Get Auth Request By ID Documentation](/docs/references/resources/oidc_service_v2/oidc-service-get-auth-request)
...
Implement all the steps you like the user the go trough by [creating](/docs/references/resources/session_service_v2/session-service-create-session) and [updating](/docs/references/resources/session_service_v2/session-service-set-session) the user-session.
...
Read more about the [Finalize Auth Request Documentation](/docs/references/resources/oidc_service_v2/oidc-service-create-callback)
...
Prompt the user to select a session, terminate it using the [corresponding endpoint](/docs/references/resources/session_service_v2/session-service-delete-session) and send the user to the `post_logout_redirect` URL.
