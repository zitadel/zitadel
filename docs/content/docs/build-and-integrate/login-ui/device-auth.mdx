...
[Get Device Authorization Request Documentation](/docs/references/resources/oidc_service_v2/oidc-service-get-device-authorization-request)
...
Read more about the [Authorize or Deny Device Authorization Request Documentation](/docs/references/resources/oidc_service_v2/oidc-service-authorize-or-deny-device-authorization)
