...
[Start Identity Provider Intent Documentation](/docs/references/api/user/zitadel.user.v2.UserService.StartIdentityProviderIntent)
...
[Retrieve Identity Provider Intent Documentation](/docs/references/api/user/zitadel.user.v2.UserService.RetrieveIdentityProviderIntent)
...
[Create User API Documentation](/docs/references/api/user/zitadel.user.v2.UserService.AddHumanUser)
...
[Add IDP Link to existing user documentation](/docs/references/api/user/zitadel.user.v2.UserService.AddIDPLink)
