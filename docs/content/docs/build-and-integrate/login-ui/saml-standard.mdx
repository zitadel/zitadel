...
Read more about the [SSO Endpoint Documentation](/docs/references/saml/endpoints#sso_endpoint)
...
[Get SAML Request By ID Documentation](/docs/references/resources/saml_service_v2/saml-service-get-saml-request)
...
Implement all the steps you like the user to go trough by [creating](/docs/references/resources/session_service_v2/session-service-create-session) and [updating](/docs/references/resources/session_service_v2/session-service-set-session) the user-session.
...
Read more about the [Finalize SAML Request Documentation](/docs/references/resources/saml_service_v2/saml-service-create-response)
