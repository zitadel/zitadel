...
If you are self-hosting, you can also enable the feature for the complete system (all instances) using the [set system level features](/docs/references/api/feature/zitadel.feature.v2.FeatureService.SetSystemFeatures) endpoint.
