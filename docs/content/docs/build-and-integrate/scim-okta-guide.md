...
1. **Create a Service User**:
   ...
   * Follow [this guide](https://zitadel.com/docs/manage-and-govern/console/users) to create a Service User within your ZITADEL Organization.
...
4. Detailed instructions to authenticate the Service User can be found [here](https://zitadel.com/docs/build-and-integrate/service-users/authenticate-service-users).
...
<img src="/img/manage/users/enable-scim-provisioning.png" alt="Enable SCIM provisioning in Okta"/> 
...
<img src="/img/manage/users/select-provisioning-actions.png" alt="Select provisioning actions in Okta"/>
...
*(Find more details about endpoints [here](https://zitadel.com/docs/references/scim2#supported-endpoints)).*
...
<img src="/img/manage/users/provisioning-to-app.png" alt="Enable provisioning to App in Okta"/>
...
* [Authenticate users with SAML](https://zitadel.com/docs/build-and-integrate/login/saml)

* [ZITADEL: Creating Service Users](https://zitadel.com/docs/manage-and-govern/console/users)

* [ZITADEL: Service User Authentication](https://zitadel.com/docs/build-and-integrate/service-users/authenticate-service-users)

* [ZITADEL SCIM 2.0 API Endpoints](https://zitadel.com/docs/references/scim2)

* [SCIM v2.0 (Preview) docs](https://zitadel.com/docs/manage-and-govern/user/scim2)