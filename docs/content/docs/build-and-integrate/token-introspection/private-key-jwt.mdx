...
This is a guide on how to secure your API using [JSON Web Token (JWT) profile (recommended)](/docs/references/openidoauth/authn-methods#client-secret-basic).  
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-1.png"
    width="75%"
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-2.png"
    width="75%"
    alt="Register the API"
/>
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-3.png"
    width="75%"
    alt="Register the API"
/>
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-4.png"
    width="75%"
    alt="Register the API"
/>
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-5.png"
    width="75%"
    alt="Register the API"
/>
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-6.png"
    width="75%"
    alt="Register the API"
/>
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-7.png"
    width="75%"
    alt="Register the API"
/>
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-8.png"
    width="75%"
    alt="Register the API"
/>
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-9.png"
    width="75%"
    alt="Register the API"
/>
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-10.png"
    width="75%"
    alt="Register the API"
/>
...
<img
    src="/docs/img/guides/token-introspection-jwt-profile-11.png"
    width="75%"
    alt="Register the API"
/>
