...
This is a guide on how to secure your API using [Basic Authentication](/docs/references/openidoauth/authn-methods#client-secret-basic).
...
<img
    src="/docs/img/guides/token-introspection-basic-auth-1.png"
    width="75%"
...
<img
    src="/docs/img/guides/token-introspection-basic-auth-2.png"
    width="75%"
    alt="Register the API"
/>
...
<img
     src="/docs/img/guides/token-introspection-basic-auth-3.png"
    width="75%"
    alt="Register the API"
/>
...
<img
     src="/docs/img/guides/token-introspection-basic-auth-4.png"
    width="75%"
    alt="Register the API"
/>
...
<img
     src="/docs/img/guides/token-introspection-basic-auth-5.png"
    width="75%"
    alt="Register the API"
/>
...
<img
    src="/docs/img/guides/token-introspection-basic-auth-6.png"
    width="75%"
    alt="Register the API"
/>
...
<img
     src="/docs/img/guides/token-introspection-basic-auth-7.png"
    width="75%"
    alt="Register the API"
/>
