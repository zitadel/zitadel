...
You can do so by customizing the [runtime configuration](/docs/operate-and-self-host/manage/configure/configure#runtime-configuration-file).
...
* [ZITADEL API Documentation](/docs/references/introduction)
