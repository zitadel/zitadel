...
You need to give a user the [manager role](/docs/manage-and-govern/console/managers) IAM_OWNER_VIEWER or IAM_OWNER to access the Event API.
...
Call the [ListEvents](/docs/references/api-v1/admin/zitadel.admin.v1.AdminService.ListEvents) endpoint in the Administration API to get all the events you need.
...
To be able to filter for the different event types ZITADEL knows, you can request the [EventTypesList](/docs/references/api-v1/admin/zitadel.admin.v1.AdminService.ListEventTypes)
...
To be able to filter for the different aggregate types (resources) ZITADEL knows, you can request the [AggregateTypesList](/docs/references/api-v1/admin/zitadel.admin.v1.AdminService.ListAggregateTypes)
