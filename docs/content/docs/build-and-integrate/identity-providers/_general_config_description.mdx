---
title: General Config Description
---
...
<Callout type="info" title="Either account creation or account linking have to be enabled. Otherwise, the provider can't be used.">
