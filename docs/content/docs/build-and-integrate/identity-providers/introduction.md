...
For those utilizing a SAML Service Provider, the SAML Service Provider option is available. You can learn how to set up a SAML Service Provider with our [MockSAML example](/docs/build-and-integrate/identity-providers/mocksaml).

Should you wish to transition from a generic OIDC provider to Entra ID (formerly Azure Active Directory) or Google, consider following this [guide](/docs/build-and-integrate/identity-providers/migrate).
...
- [The ZITADEL API reference for managing external IdPs](/docs/references/resources/admin/identity-providers)
