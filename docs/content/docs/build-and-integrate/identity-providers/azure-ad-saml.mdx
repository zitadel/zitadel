...
This is relevant if you want to [programmatically sign users in at ZITADEL via a SAML Service Provider](/docs/build-and-integrate/login-ui/external-login).
