...
- [Add Default SAML Identity Provider](/docs/references/resources/admin/admin-service-add-saml-provider)
- [Add SAML Identity Provider on Organization](/docs/references/resources/mgmt/management-service-add-saml-provider)
...
- [Update Default SAML Identity Provider](/docs/references/resources/admin/admin-service-update-saml-provider)
- [Update SAML Identity Provider on Organization](/docs/references/resources/mgmt/management-service-update-saml-provider)
