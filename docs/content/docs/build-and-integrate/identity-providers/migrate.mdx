...
To migrate, you either use the [Migrate Generic OIDC Identity Provider (Instance)](/docs/references/api-v1/admin/zitadel.admin.v1.AdminService.MigrateGenericOIDCProvider#migrate-generic-oidc-identity-provider) or [Migrate Generic OIDC Identity Provider (Organization)](/docs/references/api-v1/management/zitadel.management.v1.ManagementService.MigrateGenericOIDCProvider#migrate-generic-oidc-identity-provider) API request.
