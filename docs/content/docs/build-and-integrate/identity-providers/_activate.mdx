...
- [Activate Default Identity Provider](/docs/references/resources/admin/admin-service-add-idp-to-login-policy)
- [Activate Organization Identity Provider](/docs/references/resources/mgmt/management-service-add-idp-to-login-policy)
