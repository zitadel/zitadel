...
- [JSON Web Token (JWT) Profile (Recommended)](/docs/build-and-integrate/token-inspection/private-key-jwt)
- [Basic Authentication](/docs/build-and-integrate/token-inspection/basic-auth)

## Service users

If there are client APIs or systems that need to access other protected APIs, these APIs or systems must be declared as [service users](/docs/learn/structure/users).
...
- [Introspection API reference](/docs/reference/openidoauth/endpoints#token-endpoint)
- [JWT vs. opaque tokens](/docs/learn/standards/opaque-tokens)
