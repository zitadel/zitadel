...
<table>
	<tr>
		<td width="100px">
			<img width="100px" src="/img/tech/nodejs.svg" alt="node.js logo"/>
		</td>
		<td>
...
<Callout type="info" title="**This is a Management API Client, not an Authentication SDK.**">
...
[Zitadel documentation on authenticating service users](https://zitadel.com/docs/build-and-integrate/service-users/authenticate-service-users).
