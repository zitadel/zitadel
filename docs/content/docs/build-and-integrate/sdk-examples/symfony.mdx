...
<table>
    <tr>
        <td width="100px">
            <img width="100px" src="/img/tech/php.svg" alt="php logo"/>
        </td>
        <td>
...
- [Step-By-Step Guide](/docs/build-and-integrate/examples/login/symfony)
...
Check out our [Example Application](/docs/build-and-integrate/sdk-examples/symfony#example-application)
...
The [Step-By-Step Guide](/docs/build-and-integrate/examples/login/symfony) leads you through the whole process from configuring the right application in ZITADEL to a ready application with integrated Login.
