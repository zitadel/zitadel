...
<table>
    <tr>
        <td width="100px">
            <img width="100px" src="/img/tech/django.png" alt="phyton logo"/>
        </td>
        <td>
...
- [API App Step-By-Step Guide](/docs/build-and-integrate/examples/secure-api/python-django)
- [Example Web App Repository](https://github.com/zitadel/example-python-django-oidc)
- [Web App Step-By-Step Guide](/docs/build-and-integrate/examples/login/python-django)
