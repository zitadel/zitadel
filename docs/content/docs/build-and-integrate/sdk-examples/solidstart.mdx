...
2. Create a `.env` file and configure it with the values from your [Zitadel application](https://zitadel.com/docs/manage-and-govern/console/overview). Use the exact environment variable names from the repository:
   ```
   ...
   Replace these values with:
	- Your actual [Zitadel instance URL](https://zitadel.com/docs/manage-and-govern/console/instance-settings) (the **Issuer**)
	- The **Client ID** you copied when [creating the application](/docs/manage-and-govern/console/applications)
