...
<table>
    <tr>
        <td width="100px">
            <img width="100px" src="/img/tech/flask.svg" alt="phyton logo" className="hideonlight"/>
            <img width="100px" src="/img/tech/flasklight.svg" alt="phyton logo" className="hideondark"/>
        </td>
        <td>
...
- [API APP Step-By-Step Guide](/docs/build-and-integrate/examples/secure-api/python-flask)
