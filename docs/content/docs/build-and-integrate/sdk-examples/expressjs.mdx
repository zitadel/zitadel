...
2. Create a `.env.local` file and configure it with the values from your [Zitadel application](https://zitadel.com/docs/manage-and-govern/console/overview). Use the exact environment variable names from the repository:
   ...
   Replace these values with:
	- Your actual Zitadel instance URL (the **Issuer** from the [PKCE setup guide](/docs/build-and-integrate/login/oidc/pkce-setup))
