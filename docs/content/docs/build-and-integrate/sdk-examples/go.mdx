...
<table>
    <tr>
        <td width="100px">
            <img width="100px" src="/img/tech/golang.svg" alt="go logo"/>
        </td>
        <td>
...
- [Web APP Step-By-Step Guide](/docs/build-and-integrate/examples/login/go)
- [API APP Step-By-Step Guide](/docs/build-and-integrate/examples/secure-api/go)
