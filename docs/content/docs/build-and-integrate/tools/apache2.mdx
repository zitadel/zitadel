...
| OIDCScope | OpenID Connect scopes that should be included. You can find a list of [all scopes](/docs/references/openidoauth/scopes) in our documentation. | "openid profile" |
