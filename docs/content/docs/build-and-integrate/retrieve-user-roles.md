...
- [Generate tokens for service users](/docs/build-and-integrate/service-users/authenticate-service-users)
...
If the access token is valid, the information about the user (depending on the granted scopes) is returned. Check the [Claims page](/docs/references/openidoauth/claims) for more details. 
