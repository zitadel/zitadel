...
You can decide whether a organization is preselected for the login or if the user is redirected to the default login screen. Using OpenID Connect, you can send the user to a specific organization by defining the organization in a [reserved scope](/docs/references/openidoauth/scopes#reserved-scopes) (primary domain).
...
- [Creating an organization](/docs/manage-and-govern/console/organizations)
