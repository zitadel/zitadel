...
Read more about how to set the default redirect URI: [Settings - Default Redirect URI](/docs/manage-and-govern/console/default-settings#default-redirect-uri)
...
You need to use the [update project API call](/docs/references/api-v1/management/zitadel.management.v1.ManagementService.UpdateProject) to set the configuration on the project.
...
More detailed information about creating a PAT and manager roles you can find [here](/docs/build-and-integrate/service-users/personal-access-token)
