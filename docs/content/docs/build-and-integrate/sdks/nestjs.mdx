...
2. Create a `.env` file in the project root and configure it with the values from your [Zitadel application](https://zitadel.com/docs/manage/console-overview). **Use the exact environment variable names from the repository:**
   ```
