...
6. Optionally enable [refresh tokens](https://zitadel.com/docs/learn/tokens) in Token Settings for long-lived sessions
...
2. Create a `.env` file (copy from `.env.example`) and configure it with the values from your [ZITADEL application](https://zitadel.com/docs/manage/console-overview). **Use these exact environment variable names:**
   ...
   Replace these values with:
	- Your actual [ZITADEL instance URL](https://zitadel.com/docs/manage/console-overview) for `ZITADEL_DOMAIN` (the issuer)
