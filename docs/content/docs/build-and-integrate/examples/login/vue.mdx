...
<Callout type="tip" title="This documentation references our [example](https://github.com/zitadel/zitadel-vue) on GitHub.">
...
<Callout type="tip" title="If you are following along with the [example](https://github.com/zitadel/zitadel-vue), set the dev mode switch to `true`.">
