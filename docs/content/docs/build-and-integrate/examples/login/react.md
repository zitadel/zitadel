...
We recommend that you use [Proof Key for Code Exchange (PKCE)](/docs/reference/openidoauth/grant-types#proof-key-for-code-exchange) for all single page applications.
...
To do this, [refer to the API docs](/docs/reference/introduction) or check out [the ZITADEL Console code on GitHub](https://github.com/zitadel/zitadel) which uses gRPC to access data.
