...
<Callout type="tip" title="This documentation references our [example](https://github.com/zitadel/zitadel-react) on GitHub.">
...
We recommend that you use [Proof Key for Code Exchange (PKCE)](/docs/references/openidoauth/grant-types#proof-key-for-code-exchange) for all single page applications.
...
<Callout type="tip" title="If you are following along with the [example](https://github.com/zitadel/zitadel-react), set the dev mode switch to `true`.">
...
To do this, [refer to the API docs](/docs/references/introduction) or check out [the ZITADEL Console code on GitHub](https://github.com/zitadel/zitadel) which uses gRPC to access data.
