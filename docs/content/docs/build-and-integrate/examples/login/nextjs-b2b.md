...
If you need more info on B2B use cases consider reading our guide for the [B2B solution scenario](/docs/build-and-integrate/patterns/b2b).
...
Now switch back to the organization `Demo-Customer` and [create a new user](/docs/manage/org-management/users#create-user) in this organization.
...
To make this happen, we need give Alice an [Manager Role](/docs/learn/structure/managers) within the Organization `Demo-Customer`.
...
[Grant all roles of the Project](/docs/manage/projects-apps/projects#grant-a-project) to the organization `demo-customer.{YourDomain}.zitadel.cloud`.
