...
You can find a comprehensive guide on how to use the events API for different use cases here: [Get Events from ZITADEL](/docs/build-and-integrate/zitadel-apis/event-api)
...
With the [log module](/docs/references/actions/modules#log) you can log any custom message to stdout.
...
The [http module](/docs/references/actions/modules#http) allows you to make a request to a REST API. 
