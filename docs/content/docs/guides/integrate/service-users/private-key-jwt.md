...
![private key jwt authentication sequence diagram](/guides/integrate/service-users/sequence-private-key-jwt.svg)
...
![Create private key](/console_serviceusers_new_key.gif)
