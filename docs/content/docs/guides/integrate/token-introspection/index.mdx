...
- [JSON Web Token (JWT) Profile (Recommended)](/docs/guides/integrate/token-introspection/private-key-jwt)
- [Basic Authentication](/docs/guides/integrate/token-introspection/basic-auth)
...
Read the introduction on how to [authenticate service users](/docs/guides/integrate/service-users/authenticate-service-users).

## Further references

- [Introspection API reference](/docs/apis/openidoauth/endpoints#token-endpoint)
