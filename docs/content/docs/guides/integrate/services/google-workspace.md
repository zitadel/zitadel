...
![SSO with third-party IdP](/guides/integrate/services/google-workspace-sso-overview.png)
...
![domain-specific service URLs](/guides/integrate/services/google-workspace-domain-sepcific-urls.png)

Save the settings.

![SSO with third-party IdP lower part](/guides/integrate/services/google-workspace-sso-bottom.png)
...
![SSO Profile Overview](/guides/integrate/services/google-workspace-sso-zitadel.png)

You can copy the "Entity ID" and "ACS URL" from the "SP details" section.

![ZITADEL SSO Profile](/guides/integrate/services/google-workspace-zitadel-profile-configured.png)
...
![domain-specific service URLs with ZITADEL SSO](/guides/integrate/services/google-workspace-zitadel-set-profile.png)

Save the settings.

![SSO with third-party IdP lower part with ZITADEL SSO](/guides/integrate/services/google-workspace-sso-zitadel.png)
