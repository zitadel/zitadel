...
![Navigation Authentication Enterprise](/saml/auth0/auth_enterprise.png)

1. Press the "+" button right to "SAML"  
   ![Enterprise Connections](/saml/auth0/enterprise_connections.png)
2. Fill out the fields as follows in the SAML Connection:
   ![New SAML Connection](/saml/auth0/connection.png)
...
![Authentication Enterprise Try](/saml/auth0/auth_enterprise_try.png)
