...
1. Press the "+" button right to "OpenID Connect"  
  ![Create new connection](/oidc/auth0/auth0-create-app.png)
...
![initial connection configuration](/oidc/auth0/auth0-init-app.png)
...
2. Copy the client secret from ZITADEL and past it into the **Client Secret** field
   ![full configuration](/oidc/auth0/auth0-full.png)
3. click Create
...
6. Click on the "..." button right to the newly created connection and click "Try"
   ![click try](/oidc/auth0/auth0-try.png)
...
8. After you logged in you should see the following:
   ![full configuration](/oidc/auth0/auth0-works.png)
