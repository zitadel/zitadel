...
1. As described you have to create a new provider, with a unique identifier:
   ![Create IDP Profile](/saml/pingidentity/create_idp_profile.png)

We recommend activating signing the auth request whenever possible:
![Configure PingOne Connection](/saml/pingidentity/conf_connection.png)
...
- Import certificate, provided from the certificate endpoint
  ![Configure IDP Connection](/saml/pingidentity/conf_idp_connection.png)
...
![Identity Providers P1 Connection](/saml/pingidentity/idp_p1_connection.png)
![Identity Providers IDP Configuration](/saml/pingidentity/idp_idp_configuration.png)
