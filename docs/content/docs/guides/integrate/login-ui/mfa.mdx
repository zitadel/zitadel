...
![Register TOTP](/docs/img/guides/login-ui/register-totp-flow.png)
...
![Authenticate TOTP](/docs/img/guides/login-ui/authenticate-totp-flow.png)
...
![Register SMS OTP](/docs/img/guides/login-ui/register-phone-otp-flow.png)
...
![Authenticate SMS OTP](/docs/img/guides/login-ui/authenticate-phone-otp-flow.png)
...
![Register Email OTP](/docs/img/guides/login-ui/register-email-otp-flow.png)
...
![Authenticate OTP Email](/docs/img/guides/login-ui/authenticate-email-otp-flow.png)
...
![Register U2F](/docs/img/guides/login-ui/register-u2f-flow.png)
...
![Authenticate U2F](/docs/img/guides/login-ui/authenticate-u2f-flow.png)
