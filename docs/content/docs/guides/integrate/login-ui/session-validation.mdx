...
To get the current state of the session, you can call the [GetSession endpoint](/docs/apis/resources/session_service_v2/session-service-get-session),
resp. you can get several by [searching sessions](/docs/apis/resources/session_service_v2/session-service-list-sessions).
