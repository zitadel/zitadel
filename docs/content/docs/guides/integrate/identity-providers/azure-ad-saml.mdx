...
![Azure SAML App Creation](/guides/azure_saml_app_create.png)
...
![Disable assignment required check](/guides/azure_disable_assignment_required.png)
...
![Azure Entra overview](/guides/azure_saml_overview.png)
...
![Azure SAML App Creation](/guides/zitadel_azure_saml_provider.png)
...
![Azure SAML App URLs](/guides/zitadel_azure_saml_provider_urls.png)
...
![Azure Entra configuration overview](/guides/azure_saml_overview2.png)
...
![Activate Azure SAML Provider](/guides/zitadel_activate_azure_saml.png)
...
![Azure Entra Button](/guides/zitadel_login_azure_saml.png)

Click **Microsoft Entra**

![Entra ID Login](/guides/microsoft_login.png)
