...
![Azure SAML App Creation](/docs/img/guides/azure_saml_app_create.png)
...
![Disable assignment required check](/docs/img/guides/azure_disable_assignment_required.png)
...
![Azure Entra overview](/docs/img/guides/azure_saml_overview.png)
...
![Azure SAML App Creation](/docs/img/guides/zitadel_azure_saml_provider.png)
...
![Azure SAML App URLs](/docs/img/guides/zitadel_azure_saml_provider_urls.png)
...
![Azure Entra configuration overview](/docs/img/guides/azure_saml_overview2.png)
...
![Activate Azure SAML Provider](/docs/img/guides/zitadel_activate_azure_saml.png)
...
![Azure Entra Button](/docs/img/guides/zitadel_login_azure_saml.png)

Click **Microsoft Entra**

![Entra ID Login](/docs/img/guides/microsoft_login.png)
