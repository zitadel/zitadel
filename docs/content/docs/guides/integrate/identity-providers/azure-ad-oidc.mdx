...
![Azure Provider](/docs/img/guides/zitadel_azure_provider2.png)
...
![Azure App Registration](/docs/img/guides/azure_app_registration.png)

![Azure Client ID and Tenant ID](/docs/img/guides/azure_client_tenant_id.png)
...
![Azure Client Secret](/docs/img/guides/azure_client_secret.png)
...
![Azure Token configuration](/docs/img/guides/azure_token_configuration.png)
...
![Azure API permissions](/docs/img/guides/azure_api_permissions.png)
...
![Activate Entra ID](/docs/img/guides/zitadel_activate_azure.png)
...
![Entra ID Button](/docs/img/guides/zitadel_login_azure.png)
