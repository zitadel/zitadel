...
![Azure Provider](/guides/zitadel_azure_provider2.png)
...
![Azure App Registration](/guides/azure_app_registration.png)

![Azure Client ID and Tenant ID](/guides/azure_client_tenant_id.png)
...
![Azure Client Secret](/guides/azure_client_secret.png)
...
![Azure Token configuration](/guides/azure_token_configuration.png)
...
![Azure API permissions](/guides/azure_api_permissions.png)
...
![Activate Entra ID](/guides/zitadel_activate_azure.png)
...
![Entra ID Button](/guides/zitadel_login_azure.png)
