...
![GitLab Provider](/guides/zitadel_gitlab_create_provider.png)
...
![Register an OAuth application](/guides/gitlab_app_registration.png)
...
![Client ID and Secret](/guides/gitlab_app_id_secret.png)
...
![Activate the GitLab](/guides/zitadel_activate_gitlab.png)
...
![GitLab Button](/guides/zitadel_login_gitlab.png)

![GitLab Login](/guides/gitlab_login.png)

<UnlinkedOAuth provider="GitLab"/>

![GitLab Login](/guides/zitadel_login_external_not_found_registration.png)
