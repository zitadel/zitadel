...
![GitLab Provider](/docs/img/guides/zitadel_gitlab_create_provider.png)
...
![Register an OAuth application](/docs/img/guides/gitlab_app_registration.png)
...
![Client ID and Secret](/docs/img/guides/gitlab_app_id_secret.png)
...
![Activate the GitLab](/docs/img/guides/zitadel_activate_gitlab.png)
...
![GitLab Button](/docs/img/guides/zitadel_login_gitlab.png)

![GitLab Login](/docs/img/guides/gitlab_login.png)

<UnlinkedOAuth provider="GitLab"/>

![GitLab Login](/docs/img/guides/zitadel_login_external_not_found_registration.png)
