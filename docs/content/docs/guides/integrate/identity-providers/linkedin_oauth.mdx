...
![Add new Application in LinkedIn](/docs/img/guides/linkedin_add_app.png)
...
![LinkedIn Provider](/docs/img/guides/zitadel_linkedin_create_provider.png)

### Activate IdP

<Activate components={props.components} />

![Activate the LinkedIn Provider](/docs/img/guides/zitadel_activate_linkedin.png)

## Test the setup

<TestSetup components={props.components}  loginscreen="your LinkedIn login"/>

![LinkedIn Button](/docs/img/guides/zitadel_login_linkedin.png)

![LinkedIn Login](/docs/img/guides/linkedin_login.png)
