...
![Add new Application in LinkedIn](/guides/linkedin_add_app.png)
...
![LinkedIn Provider](/guides/zitadel_linkedin_create_provider.png)

### Activate IdP

<Activate/>

![Activate the LinkedIn Provider](/guides/zitadel_activate_linkedin.png)

## Test the setup

<TestSetup loginscreen="your LinkedIn login"/>

![LinkedIn Button](/guides/zitadel_login_linkedin.png)

![LinkedIn Login](/guides/linkedin_login.png)
