...
![Activate PingFederate SAML provider in ZITADEL](/docs/img/guides/zitadel-activate-pingfederate-saml.png)
...
![Image: PingFederate button on ZITADEL login](/docs/img/guides/zitadel-login-pingfederate-button.png)
