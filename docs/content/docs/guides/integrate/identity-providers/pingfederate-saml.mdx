...
![Activate PingFederate SAML provider in ZITADEL](/guides/zitadel-activate-pingfederate-saml.png)
...
![Image: PingFederate button on ZITADEL login](/guides/zitadel-login-pingfederate-button.png)
