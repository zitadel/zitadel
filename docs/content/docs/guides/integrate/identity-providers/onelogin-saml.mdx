...
![Image: OneLogin Add Apps screen showing SAML connector selection](/guides/onelogin-add-apps.png)
...
![SAML Provider](/guides/zitadel_saml_create_provider.png)
...
![Image: OneLogin SAML configuration with ZITADEL URLs](/guides/onelogin-configuration.png)
...
![Activate OneLogin SAML provider in ZITADEL](/guides/zitadel-activate-onelogin-saml.png)
...
![Image: OneLogin button on ZITADEL login](/guides/zitadel-login-onelogin-button.png)
