...
![Activate OneLogin SAML provider in ZITADEL](/docs/img/guides/zitadel_activate_onelogin_saml.png)
...
![Image: OneLogin button on ZITADEL login](/docs/img/guides/zitadel_login_onelogin_button.png)
