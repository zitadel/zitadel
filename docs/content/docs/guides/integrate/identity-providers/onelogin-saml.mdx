...
![Image: OneLogin Add Apps screen showing SAML connector selection](/docs/img/guides/onelogin-add-apps.png)
...
![SAML Provider](/docs/img/guides/zitadel_saml_create_provider.png)
...
![Image: OneLogin SAML configuration with ZITADEL URLs](/docs/img/guides/onelogin-configuration.png)
...
![Activate OneLogin SAML provider in ZITADEL](/docs/img/guides/zitadel-activate-onelogin-saml.png)
...
See the [Actions V2 Response Manipulation](/docs/guides/integrate/actions/testing-response-manipulation.md)
...
![Image: OneLogin button on ZITADEL login](/docs/img/guides/zitadel-login-onelogin-button.png)
