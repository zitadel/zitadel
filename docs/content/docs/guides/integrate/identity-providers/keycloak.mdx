...
![Generic OIDC Provider](/guides/zitadel_generic_oidc_create_provider.png)
...
![Add new OIDC Client in Keycloak](/guides/keycloak_add_client.png)
![Get Client Secret](/guides/keycloak_client_secret.png)
...
![Keycloak Provider](/guides/zitadel_keycloak_create_provider.png)

### Activate IdP

<Activate/>

![Activate the Keycloak Provider](/guides/zitadel_activate_keycloak.png)
...
![Keycloak Button](/guides/zitadel_login_keycloak.png)

![Keycloak Login](/guides/keycloak_login.png)
