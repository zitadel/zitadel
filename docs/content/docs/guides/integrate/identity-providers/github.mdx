...
![GitHub Provider](/docs/img/guides/zitadel_github_create_provider.png)
...
![Register an OAuth application](/docs/img/guides/github_oauth_app_registration.png)
...
![Client ID and Secret](/docs/img/guides/github_oauth_client_id_secret.png)
...
![Activate the GitHub](/docs/img/guides/zitadel_activate_github.png)
...
![GitHub Button](/docs/img/guides/zitadel_login_github.png)

![GitHub Login](/docs/img/guides/github_login.png)

<UnlinkedOAuth provider="GitHub"/>

![GitHub Login](/docs/img/guides/zitadel_login_external_not_found_registration.png)
