...
![GitHub Provider](/guides/zitadel_github_create_provider.png)
...
![Register an OAuth application](/guides/github_oauth_app_registration.png)
...
![Client ID and Secret](/guides/github_oauth_client_id_secret.png)
...
![Activate the GitHub](/guides/zitadel_activate_github.png)
...
![GitHub Button](/guides/zitadel_login_github.png)

![GitHub Login](/guides/github_login.png)

<UnlinkedOAuth provider="GitHub"/>

![GitHub Login](/guides/zitadel_login_external_not_found_registration.png)
