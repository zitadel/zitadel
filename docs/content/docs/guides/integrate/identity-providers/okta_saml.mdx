...
![OKTA Provider Empty](/guides/zitadel_okta_saml_provider_empty.png)

After you created the SAML Provider in ZITADEL, you can copy the URLs you need to configure in your OKTA application.

![OKTA SAML App URLs](/guides/zitadel_okta_saml_provider_urls.png)
...
![Add new SAML Application in OKTA](/guides/okta_add_saml_app.png)
...
![Add Attribute Mapping ](/guides/okta_saml_attribute_mapping.png)
...
![Add new SAML Application in OKTA](/guides/okta_assign_user_to_app.png)
...
![OKTA Provider Empty](/guides/zitadel_okta_saml_provider_filled.png)
...
![Activate the OKTA Provider](/guides/zitadel_activate_okta_saml.png)
...
![OKTA Button](/guides/zitadel_login_okta.png)

![OKTA Login](/guides/okta_login.png)
