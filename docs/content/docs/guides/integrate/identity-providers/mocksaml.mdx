...
![Activate the SAML Provider](/docs/img/guides/zitadel_activate_saml.png)
...
![SAML Button](/docs/img/guides/zitadel_login_saml.png)

![SAML Login](/docs/img/guides/mocksaml_login.png)