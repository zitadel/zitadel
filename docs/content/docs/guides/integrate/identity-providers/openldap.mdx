...
![LDAP Provider](/guides/zitadel_ldap_create_provider.png)

### Activate IdP

<Activate/>

![Activate the LDAP Provider](/guides/zitadel_activate_ldap.png)
...
![LDAP Button](/guides/zitadel_login_ldap.png)

![LDAP Login](/guides/zitadel_login_ldap_input.png)
