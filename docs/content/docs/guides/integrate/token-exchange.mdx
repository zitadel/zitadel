...
![Screenshot showing enabling of Token Exchange grant on a ZITADEL application](/docs/img/guides/token-exchange/app-token-exchange-grant.png)
...
![Screenshot showing enabling of the impersonation security setting](/docs/img/guides/token-exchange/instance-security-impersonation.png)
...
![Screenshot showing assignment of an impersonator role](/docs/img/guides/token-exchange/org-role-end-user-impersonator.png)
...
![Screenshot showing the user audit log with token creation and impersonation](/docs/img/guides/token-exchange/user-audit-log.png)
