...
The API documentation to create a target can be found [here](/docs/apis/resources/action_service_v2/action-service-create-target)
...
Each Target resource now contains also a Signing Key, which gets generated and returned when a Target is [created](/docs/apis/resources/action_service_v2/action-service-create-target),
and can also be newly generated when a Target is [patched](/docs/apis/resources/action_service_v2/action-service-update-target).
...
The API documentation to set an Execution can be found [here](/docs/apis/resources/action_service_v2/action-service-set-execution)
...
- [All available Methods](/docs/apis/resources/action_service_v2/action-service-list-execution-methods), for example `/zitadel.user.v2.UserService/AddHumanUser`
- [All available Services](/docs/apis/resources/action_service_v2/action-service-list-execution-services), for example `zitadel.user.v2.UserService`

### Condition for Functions

The available conditions can be found under [all available Functions](/docs/apis/resources/action_service_v2/action-service-list-execution-functions).
