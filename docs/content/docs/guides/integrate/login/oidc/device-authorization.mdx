...
2. Under “Applications” click the “New” button.
    ...
    <img src="../../../../img/device-auth/device-auth-01.png" alt="Device Authorization Flow in ZITADEL"/>

3. Select “Native” and enter a name for the application, and click “Continue”.

    <img src="../../../../img/device-auth/device-auth-02.png" alt="Device Authorization Flow in ZITADEL"/>

4. Select “Device Code”. Click “Continue”.

    <img src="../../../../img/device-auth/device-auth-03.png" alt="Device Authorization Flow in ZITADEL"/>


5. Check the details and click “Create”.

    <img src="../../../../img/device-auth/device-auth-04.png" alt="Device Authorization Flow in ZITADEL"/>

6. Copy the “Client ID” and store it for later use.

    <img src="../../../../img/device-auth/device-auth-05.png" alt="Device Authorization Flow in ZITADEL"/>
...
- `ISSUER`: server address of your instance or domain. You can find the issuer URL in the “URLs” section. In this example, it will be set to [https://test-0o6zvq.zitadel.cloud](https://test-0o6zvq.zitadel.cloud). **Do not use a trailing slash!**
    ...
    <img src="../../../../img/device-auth/device-auth-06.png" alt="Device Authorization Flow in ZITADEL"/>
...
<img src="../../../../img/device-auth/device-auth-07.png" alt="Device Authorization Flow in ZITADEL"/>

<img src="../../../../img/device-auth/device-auth-08.png" alt="Device Authorization Flow in ZITADEL"/>

<img src="../../../../img/device-auth/device-auth-09.png" alt="Device Authorization Flow in ZITADEL"/>

<img src="../../../../img/device-auth/device-auth-10.png" alt="Device Authorization Flow in ZITADEL"/>

<img src="../../../../img/device-auth/device-auth-11.png" alt="Device Authorization Flow in ZITADEL"/>
