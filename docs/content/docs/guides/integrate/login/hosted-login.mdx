...
![Screenshot of ZITADEL console showing different identity provider templates](/docs/img/guides/integrate/login/login-external-idp-templates.png)
...
<Tabs queryString="deployment">
    <Tab value="zitadel_cloud" label="Activate Zitadel Cloud V2 Login" default="true">
        ...
        ![Login V2 Application Configuration](/docs/img/guides/integrate/login/login-v2-app-config.png)
