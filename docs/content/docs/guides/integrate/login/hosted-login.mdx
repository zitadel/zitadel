...
![Screenshot of ZITADEL console showing different identity provider templates](/guides/integrate/login/login-external-idp-templates.png)
...
<Tabs queryString="deployment">
    <TabItem value="zitadel_cloud" label="Activate Zitadel Cloud V2 Login" default="true">
        ...
        ![Login V2 Application Configuration](/guides/integrate/login/login-v2-app-config.png)
