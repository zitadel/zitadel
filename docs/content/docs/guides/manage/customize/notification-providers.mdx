...
<Tabs>
  ...
  First [add a new SMS Provider of type HTTP](/docs/apis/resources/admin/admin-service-add-sms-provider-http) to create a new HTTP provider that can be used to send SMS messages:
  ...
  To use the HTTP provider you need to [activate the SMS provider](/docs/apis/resources/admin/admin-service-activate-sms-provider): 
  ...
  See full API reference for [SMS Providers](/docs/apis/resources/admin/sms-provider) for more details.

  </TabItem>
  <TabItem value="email" label="Email">

    First [add a new Email Provider of type HTTP](/docs/apis/resources/admin/admin-service-add-email-provider-http) to create a new HTTP provider that can be used to send Email messages:
  ...
  To use the HTTP provider you need to [activate the Email provider](/docs/apis/resources/admin/admin-service-activate-email-provider):
  ...
  See full API reference for [Email Providers](/docs/apis/resources/admin/admin-service-list-email-providers) for more details.
