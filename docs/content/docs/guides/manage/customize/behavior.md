...
Now, make the action hook into the [external authentication flow](/docs/apis/actions/external-authentication).
...
- [Read more about the concepts around actions](/docs/concepts/features/actions)
- [Read more about all the options you have with actions](/docs/guides/manage/console/actions-overview)
