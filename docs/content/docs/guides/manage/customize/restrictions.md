...
Users with the role IAM_OWNER can change the restrictions of their instance using the [Feature Restrictions Admin API](/docs/apis/resources/admin/feature-restrictions).
