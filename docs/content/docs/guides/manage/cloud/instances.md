...
![Instance Overview](/manuals/portal/customer_portal_instance_overview.png)
...
![New Instance](/manuals/portal/customer_portal_new_instance.gif)

## Detail

The detail shows you general information about your instance, the region and your usage.

![New Instance](/manuals/portal/customer_portal_instance_detail.png)
...
![Upgrade to Pro](/manuals/portal/customer_portal_upgrade_tier.png)
...
![Add custom domain](/manuals/portal/customer_portal_add_domain.png)
