...
![Customer Portal Landing Page](/docs/img/manuals/portal/customer_portal_landing_page.png)

In a second step fill out your user data like First-, Last- and Team-name.

![Customer Portal Landing Page Step 2](/docs/img/manuals/portal/customer_portal_landing_page_2.png)
...
![Customer Portal Landing Page Step 3](/docs/img/manuals/portal/customer_portal_landing_page_3.png)
