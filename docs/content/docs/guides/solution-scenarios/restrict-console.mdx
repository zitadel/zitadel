...
![Project Settings: Check for Project on authentication](/guides/solution-scenarios/console-check-project-auth.png)
...
1. Click on the default-project > Grants > New +
   ![Project Settings: Default Project - Grants](/guides/solution-scenarios/console-zitadel-project-grants.png)

2. On the next screen select the organization to which you want to give the grant
  ![Project Settings: Grants - Choose Organization](/guides/solution-scenarios/console-create-project-grant-org.png)
...
![Console access restricted](/guides/solution-scenarios/console-access-restricted.png)
