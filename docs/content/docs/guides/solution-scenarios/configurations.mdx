...
![Domain Policy: Organization domain as suffix](/docs/img/guides/scenarios/domain_policy_org_domain_disabled.png)
...
![Login Policy Advanced Setting: Disable email for login](/docs/img/guides/scenarios/login_policy_advanced.png)
...
![Login Policy Advanced Setting: Disable phone for login](/docs/img/guides/scenarios/login_policy_advanced_phone.png)
...
![Security Settings: Allow iFrame](/docs/img/guides/scenarios/security_policy.png)
...
![Login Behavior Settings: Multi-factor init lifetime](/docs/img/guides/scenarios/login-settings-mfa-init-lifetime.png)
