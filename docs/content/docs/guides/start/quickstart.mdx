...
![Home Page](/guides/quickstart/v3_1.png)
...
![Registration Page](/guides/quickstart/v3_2.png)

3. Next, complete your details and click "Continue".

![Congratulations Page](/guides/quickstart/v3_3.png)
...
![Login](/guides/quickstart/v3_8.png)
...
![Onboarding Questions](/guides/quickstart/onboarding_questions.png)
...
![Sign In Instance](/guides/quickstart/sign_in_instance.png)
...
![Instance Details](/guides/quickstart/instance_dashboard.png)
...
![Project Name and Framework/Language](/guides/quickstart/create_project_react.png)

3. An overview of the configuration for the framework you have selected is shown

![Project Configuration Overview - React App](/guides/quickstart/project_config_overview_react.png)
...
![Project Name and Framework/Language](/guides/quickstart/app_detail_overview_react.png)
...
![Add User](/guides/quickstart/26.png)
...
![Add User](/guides/quickstart/27.png)

3. The newly created user details will be displayed as shown below.

![User Info](/guides/quickstart/28.png)
...
![User Info](/guides/quickstart/29.png)
...
![Add Authorization](/guides/quickstart/35.png)
...
![Add Authorization](/guides/quickstart/37.png)
...
![Get URLs](/guides/quickstart/51.png)
...
![Get URLs](/guides/quickstart/52.png)
