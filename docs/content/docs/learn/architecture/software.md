...
You can read more about this in our [ES documentation](/docs/learn/event-sourcing/overview).
...
The only exception is the [OpenID Connect & OAuth](/docs/reference/openidoauth/endpoints) and [Asset API](/docs/reference/introduction#assets) due their unique nature.

- [OpenID Connect & OAuth](/docs/reference/openidoauth/endpoints) - allows to request authentication and authorization of Zitadel
- [SAML](/docs/reference/saml/endpoints) - allows to request authentication and authorization of Zitadel through the SAML standard
- [Authentication API](/docs/reference/introduction#authentication) - allow a user to do operation in its own context
- [Management API](/docs/reference/introduction#management) - allows an admin or machine to manage the Zitadel resources on an organization level
- [Administration API](/docs/reference/introduction#administration) - allows an admin or machine to manage the Zitadel resources on an instance level
- [System API](/docs/reference/introduction#system) - allows to create and change new Zitadel instances
- [Asset API](/docs/reference/introduction#assets) - is used to upload and download static assets
...
Make sure to read our [Production Guide](/docs/operate/configure/database/database) before you decide on using one of them.

<Callout type="info" title="Zitadel v2 supported CockroachDB and PostgreSQL. Zitadel v3 only supports PostgreSQL. Please refer to [the mirror guide](/docs/reference/cli/mirror) to migrate to PostgreSQL.">
