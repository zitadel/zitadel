...
To learn how to set up a project read this console guide [here](../../manage/projects-apps/projects.mdx).
...
All applications in a project share the roles. Read more about roles [here](/docs/manage/org-management/roles)
