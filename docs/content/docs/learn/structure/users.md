...
Read more on how to [login users with ZITADEL](/docs/build-and-integrate/login/login-users).
...
Learn how to [use service users](/docs/build-and-integrate/m2m/authenticate-service-users) with ZITADEL.

### Managers

Any user, human or service user, can be given a [Manager](/docs/learn/structure/managers) role.
...
In a multi-tenancy architecture, you might use [organizations](/docs/learn/structure/organizations) to separate user groups.
...
Users can only exist within one [organization](/docs/learn/structure/organizations).
...
You might want to adjust this general setup based on your scenario. 
...
- [Manage users in the Console](../../manage/org-management/users)
- [ZITADEL APIs: Users](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.ListUsers)
- [User onboarding and registration](/docs/manage/org-management/onboarding/end-users)
