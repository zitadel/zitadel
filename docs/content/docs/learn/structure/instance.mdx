...
Within an instance all the default [settings](/docs/learn/structure/policies),
...
One instance can contain multiple [organizations](/docs/learn/structure/organizations),
which in turn can represent your own company (e.g. departments), your business customers or a consumer organization.

Read more about how to configure your instance in our [instance guide](/docs/manage/policies/default-settings).
...
Nevertheless, you can add more virtual instances via the [system API](/docs/reference/api-v1/system/zitadel.system.v1.SystemService.CreateInstance).
