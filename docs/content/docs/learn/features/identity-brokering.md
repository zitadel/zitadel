...
[Domain discovery](/docs/build-and-integrate/patterns/domain-discovery) ensures that users are redirected to their external identity provider based on their email-address or username.
...
For popular IdPs such as EntraID, Okta, Google, Facebook, and GitHub, ZITADEL [offers pre-configured templates](/docs/manage/federation/introduction).
...
* [Detailed integration guide for many identity providers](/docs/manage/federation/introduction)
* [Setup identity providers with Console](/docs/manage/policies/default-settings#identity-providers)
* [Configure identity providers with the ZITADEL API](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.ListOrgIDPs)
