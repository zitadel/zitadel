...
<Callout type="info" title="We're working on Actions continuously. In the [roadmap](https://zitadel.com/roadmap), you see how we are planning to expand and improve it. Please tell us about your needs and help us prioritize further fixes and features.">

</Callout>

<Callout type="warn" title="To use Actions v2 activate the feature flag "Actions" [feature flag](/docs/reference/api/feature/zitadel.feature.v2.FeatureService.SetInstanceFeatures), to be able to manage the related resources.">
...
- Function, to react to different functionality in ZITADEL, replaces [Actions](/docs/learn/features/actions).
- Event, to create to different events which get created in ZITADEL, for example to inform somebody if a user gets locked

<Callout type="info" title="Currently, the defined Actions v2 will be executed additionally to the defined [Actions](/docs/learn/features/actions).">

</Callout>

## Migration

- [Migrate Actions v1 to Actions v2](/docs/build-and-integrate/customization/actions/migrate-from-v1)

## Further reading

- [Actions v2 reference](/docs/build-and-integrate/customization/actions/usage)
- [Actions v2 example execution for request](/docs/build-and-integrate/customization/actions/testing-request)
- [Actions v2 example execution for request manipulation](/docs/build-and-integrate/customization/actions/testing-request-manipulation)
- [Actions v2 example execution for request signature check](/docs/build-and-integrate/customization/actions/testing-request-signature)
- [Actions v2 example execution for response](/docs/build-and-integrate/customization/actions/testing-response)
- [Actions v2 example execution for response manipulation](/docs/build-and-integrate/customization/actions/testing-response-manipulation)
- [Actions v2 example execution for function](/docs/build-and-integrate/customization/actions/testing-function)
- [Actions v2 example execution for function manipulation](/docs/build-and-integrate/customization/actions/testing-function-manipulation)
- [Actions v2 example execution for event](/docs/build-and-integrate/customization/actions/testing-event)