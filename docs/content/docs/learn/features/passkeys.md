...
* **Documentation:** Passkeys Guide: [https://zitadel.com/docs/build-and-integrate/customization/branding/passkey](/docs/build-and-integrate/customization/branding/passkey)
* **Create Passkey Registration Link API:** [https://zitadel.com/docs/manage/org-management/user-management/reg-create-user](/docs/manage/org-management/user-management/reg-create-user)
...
* Passkeys are bound to your domain, thus we recommend configuring a [custom domain](/docs/learn/features/custom-domain) before setting up passkeys.
