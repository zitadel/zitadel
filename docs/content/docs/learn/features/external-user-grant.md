...
* [API reference for user grants](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.ListUserGrants)
* [How to manage user grants through ZITADEL's console](/docs/manage/org-management/roles#authorizations)
