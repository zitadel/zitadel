...
The console is available by navigating to the [custom domain](/docs/learn/features/custom-domain) of your instance and appending the path `/ui/console`.
Administrators can [restrict end-users from accessing the console](/docs/build-and-integrate/patterns/restrict-console).

Here's an overview of what the console enables users to do:

1. **Default Settings:** [Managers](/docs/learn/structure/managers) can access and manage the default settings of the ZITADEL system. This includes configuring authentication methods, security policies, and other system-wide parameters to meet the organization's requirements.
...
5. **Audit Logging:** The console offers access to [audit logs](/docs/learn/features/audit-trail) that track user activity and changes made to resources and system settings. Administrators can review these logs to monitor security-related events, track changes, and maintain compliance with regulatory requirements.
...
7. **Manager Assignment:** Administrators can assign ZITADEL [managers](/docs/learn/structure/managers) who have elevated privileges for managing resources within the organization. This allows for the delegation of administrative tasks while maintaining proper oversight and control.
...
- Detailed guide on [using the console](/docs/manage/console-overview)
- [Restrict access](/docs/build-and-integrate/patterns/restrict-console) to the console
