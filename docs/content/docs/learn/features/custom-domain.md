...
Learn how to [configure a custom domain in ZITADEL Cloud](/docs/manage/cloud/instances#add-custom-domain) or how to configure [custom domain when self-hosting](/docs/operate/configure/custom-domain).
