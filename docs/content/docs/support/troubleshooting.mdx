...
![Same Site Strict Enforcement](/manuals/errors/same-site-strict.png)

**Settings > Safari > disable: "Block All cookies"** 
![Block all cookies](/manuals/errors/block-cookies.png)
...
![Organization must be granted Error](/support/login_not_possible_error.png)
...
![Project Grant Missing](/support/project_grant_missing.png)
...
![Project Settings](/support/check_for_project_on_authentication.png)
...
![Project Grant for Organization B](/support/project_grant_for_customer_b.png)
