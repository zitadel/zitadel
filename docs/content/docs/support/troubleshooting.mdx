...
![Same Site Strict Enforcement](/docs/img/manuals/errors/same-site-strict.png)

**Settings > Safari > disable: "Block All cookies"** 
![Block all cookies](/docs/img/manuals/errors/block-cookies.png)
...
![Organization must be granted Error](/docs/img/support/login_not_possible_error.png)
...
![Project Grant Missing](/docs/img/support/project_grant_missing.png)
...
![Project Settings](/docs/img/support/check_for_project_on_authentication.png)
...
![Project Grant for Organization B](/docs/img/support/project_grant_for_customer_b.png)
