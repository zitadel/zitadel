...
For detailed instructions on authenticating with the SCIM interface, refer to the [Authenticate Service Users Guide](/docs/build-and-integrate/m2m/authenticate-service-users).
...
```json
{
  ...
  "documentationUri": "https://zitadel.com/docs/manage/org-management/user-management/scim2",
  "patch": {
    "supported": true
  },
  "bulk": {
  ...
  "authenticationSchemes": [
    {
      ...
      "documentationUri": "https://zitadel.com/docs/build-and-integrate/m2m/authenticate-service-users",
...
- **[Zitadel SCIM Documentation](/docs/manage/org-management/user-management/scim2)**: Documentation of Zitadel's SCIM implementation, including configuration details and known limitations.
