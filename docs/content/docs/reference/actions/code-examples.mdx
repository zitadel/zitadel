...
- Internal Authentication
  - [Pre Creation](/docs/reference/actions/internal-authentication#pre-creation)
- External Authentication
  - [Pre Creation](/docs/reference/actions/external-authentication#pre-creation)
...
- Internal Authentication
  - [Post Creation](/docs/reference/actions/internal-authentication#post-creation)
- External Authentication
  - [Post Creation](/docs/reference/actions/external-authentication#post-creation)
...
- Internal Authentication
  - [Pre Creation](/docs/reference/actions/internal-authentication#pre-creation)
  - [Post Authentication](/docs/reference/actions/internal-authentication#post-authentication)
- External Authentication
  - [Pre Creation](/docs/reference/actions/internal-authentication#pre-creation)
  - [Post Authentication](/docs/reference/actions/internal-authentication#post-authentication)
...
If you use [Okta as an identity provider](/docs/manage/federation/okta-oidc) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use [Gitlab as an identity provider](/docs/build-and-integrate/social-login/gitlab) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use [Github as an identity provider](/docs/build-and-integrate/social-login/github) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use a [generic OIDC identity provider](/docs/manage/federation/migrate#migrate-generic-oidc-provider) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use [Okta as an identity provider](/docs/manage/federation/okta_saml#add-attribute-statements) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use [Microsoft Entra as SAML identity provider](/docs/manage/federation/azure-ad-saml) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use a [SAML identity provider like mocksaml](/docs/manage/federation/mocksaml) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
- External Authentication
  - [Pre Creation](/docs/reference/actions/external-authentication#pre-creation)
  - [Post Creation](/docs/reference/actions/external-authentication#post-creation)
  - [Post Authentication](/docs/reference/actions/external-authentication#post-authentication)
...
This example uses [zitadel's log module](/docs/reference/actions/modules#log)
...
Allows you to limit the user interaction. The error thrown will be shown to the user if the action is not [allowed to fail](/docs/learn/features/actions#how-it-works).
