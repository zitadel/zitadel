...
This object contains context information about the request to the [authorization endpoint](/docs/reference/openidoauth/endpoints#authorization-endpoint).
...
Additionally there could additional fields depending on the configuration of your [project](../../manage/projects-apps/projects#role-settings) and your [application](../../manage/projects-apps/applications#token-settings)
...
- `grants` Array of
  - `id` *string*
  - `projectGrantId` *string*  
    The id of the [project grant](/docs/build-and-integrate/patterns/saas#project-grant)
  - `state` *Number*  
