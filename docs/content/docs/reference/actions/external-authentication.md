...
This flow is executed if the user logs in using an [identity provider](/docs/manage/federation/introduction).
...
The first parameter contains the following fields
  ...
  - `v1`
    ...
    - `authRequest` [*auth request*](/docs/reference/actions/objects#auth-request)
    - `httpRequest` [*http request*](/docs/reference/actions/objects#http-request)
    - `providerInfo` *Any*  
