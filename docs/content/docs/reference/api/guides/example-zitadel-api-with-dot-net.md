...
However, we recommend you read the guide on [how to access ZITADEL API](/docs/reference/api/guides/access-zitadel-apis) and the associated guides for a basic knowledge of :

 - [Recommended Authorization Flows](/docs/build-and-integrate/login/oidc/oauth-recommended-flows)
 - [Service Users](/docs/build-and-integrate/m2m/authenticate-service-users)
...
Checkout more [examples from the SDK](https://github.com/zitadel/zitadel-go/blob/main/example) or refer to our [API Docs](/docs/reference/introduction).
