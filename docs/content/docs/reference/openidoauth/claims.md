...
|:-------------------|:---------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| acr                | TBA                                                            | TBA                                                                                                                                                                        |
| act                | `{"iss": "$CUSTOM-DOMAIN","sub": "259241944654282754"}`        | JSON object describing the actor from the `actor_token` after [token exchange](/docs/build-and-integrate/login/authentication/token-exchange#actor-token)                                          |
...
You can add custom claims using the [complement token flow](/docs/reference/actions/complement-token) of the [actions feature](/docs/reference/actions/introduction).
