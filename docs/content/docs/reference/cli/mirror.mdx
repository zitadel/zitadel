...
* [Linux](/docs/operate/deploy/linux)
* [MacOS](/docs/operate/deploy/macos)

Or use the following commands for [Docker Compose](/docs/operate/deploy/compose)

```bash
# Download the docker compose example configuration.
wget https://raw.githubusercontent.com/zitadel/zitadel/main/docs/operate/deploy/docker-compose.yaml
