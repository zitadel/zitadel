...
| OIDCScope | OpenID Connect scopes that should be included. You can find a list of [all scopes](/docs/reference/openidoauth/scopes) in our documentation. | "openid profile" |
