...
You can add custom attributes using the [complement SAMLresponse](/docs/reference/actions/customize-samlresponse) of the [actions feature](/docs/reference/actions/introduction).
