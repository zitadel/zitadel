...
The test implementats [Support for (OIDC) Standard in a Custom Login UI flow](https://zitadel.com/docs/build-and-integrate/customization/branding/oidc-standard).
...
import OutputSource from '@/src/data/benchmarks/v2.70.0/oidc_session/output.json';

import { BenchmarkChart } from '@/components/benchmark_chart';

<BenchmarkChart testResults={OutputSource} />

## k6 output <a id="k6-output"></a>
