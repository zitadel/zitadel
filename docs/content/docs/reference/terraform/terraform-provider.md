...
This Terraform provider acts as a bridge, allowing you to manage various aspects of your ZITADEL instance directly through the [ZITADEL API](/docs/reference/introduction), using Terraform's declarative configuration language.
...
- [A ZITADEL Instance](/docs/build-and-integrate/quickstarts/quickstart)
- [A service user](/docs/build-and-integrate/m2m/authenticate-service-users) with [enough authorization](/docs/manage/org-management/managers) to manage the desired resources
...
- [Deploy ZITADEL in your infrastructure](/docs/operate/deploy/overview)
- [ZITADEL CLI](/docs/reference/cli/overview)
- [Configuration Options in ZITADEL](/docs/operate/configure/configure)
