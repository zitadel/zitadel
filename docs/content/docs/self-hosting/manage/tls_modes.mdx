...
- [Read more about how ZITADEL utilizes HTTP/2](/docs/self-hosting/manage/http2).
- [Explore some concrete proxy configuration examples for ZITADEL](/docs/self-hosting/manage/reverseproxy/reverse_proxy).
