...
Do not use it for production yet. To test it out, you need to enable the `UserSchema` [feature flag](/docs/references/api/feature/zitadel.feature.v2.FeatureService.SetInstanceFeatures).
