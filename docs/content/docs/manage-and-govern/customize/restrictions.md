...
Users with the role IAM_OWNER can change the restrictions of their instance using the [Feature Restrictions Admin API](/docs/references/api-v1/admin/feature-restrictions).
