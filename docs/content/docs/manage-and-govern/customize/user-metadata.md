...
You can do so by using [Console](../console/users) or [setting user metadata](/docs/references/api-v1/management/zitadel.management.v1.ManagementService.SetUserMetadata) through the management API.
...
You can request the user's metadata with the [List My Metadata](/docs/references/api-v1/auth/zitadel.auth.v1.AuthService.ListMyMetadata) method:
