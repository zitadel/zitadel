...
<Tabs>
  ...
  First [add a new SMS Provider of type HTTP](/docs/references/api-v1/admin/admin-service-add-sms-provider-http) to create a new HTTP provider that can be used to send SMS messages:
  ...
  To use the HTTP provider you need to [activate the SMS provider](/docs/references/api-v1/admin/admin-service-activate-sms-provider): 
  ...
  See full API reference for [SMS Providers](/docs/references/api-v1/admin/sms-provider) for more details.

  </Tab>
  <Tab value="email" label="Email">

    First [add a new Email Provider of type HTTP](/docs/references/api-v1/admin/admin-service-add-email-provider-http) to create a new HTTP provider that can be used to send Email messages:
  ...
  To use the HTTP provider you need to [activate the Email provider](/docs/references/api-v1/admin/admin-service-activate-email-provider):
  ...
  See full API reference for [Email Providers](/docs/references/api-v1/admin/admin-service-list-email-providers) for more details.
