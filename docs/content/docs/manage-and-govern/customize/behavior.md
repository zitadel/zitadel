...
Now, make the action hook into the [external authentication flow](/docs/references/actions/external-authentication).
...
- [Read more about all the options you have with actions](/docs/references/actions/introduction)
