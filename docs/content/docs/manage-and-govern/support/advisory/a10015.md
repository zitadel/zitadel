...
To upgrade your self-hosted deployment to Zitadel v3 migrate to PostgreSQL. Please refer to [this guide](/docs/operate-and-self-host/manage/cli/mirror) to mirror the data to PostgreSQL before you deploy Zitadel v3.