...
However, this can be modified by including a [prompt or a login hint](/docs/references/openidoauth/endpoints#additional-parameters) in the authentication request.
...
If you want to prompt users to always select their account on purpose, please make sure to include the `select_account` [prompt](/docs/references/openidoauth/endpoints#additional-parameters) in your authentication request.
