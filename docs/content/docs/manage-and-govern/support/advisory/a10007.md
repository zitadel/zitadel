...
In upcoming ZITADEL versions, RBAC also applies to [system users defined in the ZITADEL runtime configuration](/docs/build-and-integrate/zitadel-apis/access-zitadel-system-api#runtime-configuration).
