...
<Callout type="info" title="We describe our [support services](/docs/manage-and-govern/legal/service-description/support-services) and information required in more detail in our legal section. Beware that not all features may be supported by your subscription and consult the [support states](/docs/manage-and-govern/support/software-release-cycles-support#support-states).">
