...
<Callout type="warn" title="Be careful on which features you enable as they can be in an experimental state.">
...
Branding settings applied on you instance act as a default for all your organizations. If you need custom branding on a organization take a look at our guide under [organization settiong](../customize/branding).
...
<Callout type="info" title="You have to activate your SMTP provider so Zitadel can use it to send your emails. Only one provider can be active.">

</Callout>

<Callout type="warn" title="The built-in SMTP provider is intended **only for testing and evaluation purposes**.">
...
<img src="/img/guides/console/smtp.png" alt="SMTP" width="800px" />

While you create/update a SMTP provider you have the chance to test your SMTP configuration

<img src="/img/guides/console/smtp_test.png" alt="SMTP" width="800px" />
...
<img src="/img/guides/console/smtp_table.png" alt="SMTP" width="800px" />
...
<img src="/img/guides/console/twilio.png" alt="Twilio" />
...
| Disable login with email address | By default users can additionally [login with the email attribute](/docs/build-and-integrate/solution-scenarios/configurations#use-an-email-address-as-username) of their user. Check this option to disable.                                                                                                                                                                                                                                                              |
| Disable login with phone number  | By default users can additionally [login with the phonenumber attribute](/docs/build-and-integrate/solution-scenarios/configurations#use-a-phone-number-as-username) of their user. Check this option to disable.                                                                                                                                                                                                                                                          |
...
For a detailed guide about how to configure a new identity provider for identity brokering have a look at our [identity provider guides](/docs/build-and-integrate/identity-providers/introduction).
...
More about how to verify a domain [here](/docs/manage-and-govern/console/organizations#domain-verification-and-primary-domain).
...
Please refer to the [configuration guide](/docs/build-and-integrate/solution-scenarios/configurations#use-email-to-login) for more information.
...
<img src="/img/console_languages.png" alt="Languages" width="800px" />
