...
<Callout type="info" title="Note that the resources will be migrated without the event stream. This means that you will not have the audit trail for the imported objects.">
...
3. Create a [personal access token](/docs/build-and-integrate/service-users/personal-access-token)
4. Go to the Default settings
5. Add the import_user as [manager](/docs/manage-and-govern/console/managers) with the role "IAM Owner"
...
3. Create a [personal access token](/docs/build-and-integrate/service-users/personal-access-token)
4. Go to the Default settings
5. Add the export_user as [manager](/docs/manage-and-govern/console/managers) with the role "IAM Owner"
...
<Callout type="warn" title="Clean-up">
...
<Callout type="info" title="To import the exported data into you new instance, you have to have an already existing instance on a ZITADEL, with all desired configuration and global resources.">
...
<Callout type="info" title="To use this requests you have to have an access token with enough permissions to export and import.">
