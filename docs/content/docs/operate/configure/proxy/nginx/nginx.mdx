...
import ConfigDisabled from './nginx-disabled-tls.conf?raw';
import ConfigExternal from './nginx-external-tls.conf?raw';
import ConfigEnabled from './nginx-enabled-tls.conf?raw';
