...
- [Read more abouth how ZITADEL utilizes HTTP/2](/docs/operate/configure/http2).
- [Explore some concrete proxy configuration examples for ZITADEL](/docs/operate/configure/proxy/reverse_proxy).
