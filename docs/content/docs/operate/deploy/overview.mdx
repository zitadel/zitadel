...
- A PostgreSQL as only needed storage. Make sure to read our [Production Guide](/docs/operate/configure/database/database) before you decide to use Postgresql.
...
To do so, jump straight to the [production setup guide](/docs/operate/operations/production).
