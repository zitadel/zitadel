...
You can find a comprehensive guide on how to use the events API for different use cases here: [Get Events from ZITADEL](/docs/reference/api/guides/event-api)

## ZITADEL Actions

ZITADEL [Actions](/docs/learn/features/actions) offer a powerful mechanism for extending the platform's capabilities and integrating with external systems tailored to your specific requirements. 
...
With the [log module](/docs/reference/actions/modules#log) you can log any custom message to stdout.
...
The [http module](/docs/reference/actions/modules#http) allows you to make a request to a REST API. 
