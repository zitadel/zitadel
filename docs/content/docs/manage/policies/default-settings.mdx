...
Branding settings applied on you instance act as a default for all your organizations. If you need custom branding on a organization take a look at our guide under [organization settiong](/docs/build-and-integrate/customization/general/branding).
...
| Disable login with email address | By default users can additionally [login with the email attribute](/docs/build-and-integrate/patterns/configurations#use-an-email-address-as-username) of their user. Check this option to disable.                                                                                                                                                                                                                                                              |
| Disable login with phone number  | By default users can additionally [login with the phonenumber attribute](/docs/build-and-integrate/patterns/configurations#use-a-phone-number-as-username) of their user. Check this option to disable.                                                                                                                                                                                                                                                          |
...
For a detailed guide about how to configure a new identity provider for identity brokering have a look at our [identity provider guides](/docs/manage/federation/introduction).
...
More about how to verify a domain [here](/docs/manage/org-management/organizations#domain-verification-and-primary-domain).
...
Please refer to the [configuration guide](/docs/build-and-integrate/patterns/configurations#use-email-to-login) for more information.
