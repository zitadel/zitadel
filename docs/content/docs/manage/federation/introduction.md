...
- [Google](/docs/build-and-integrate/social-login/google)
- [Entra ID (OIDC)](./azure-ad-oidc)
- [Entra ID SAML](./azure-ad-saml)
- [GitHub](/docs/build-and-integrate/social-login/github)
- [GitLab](/docs/build-and-integrate/social-login/gitlab)
- [Apple](/docs/build-and-integrate/social-login/apple)
- [LDAP](./ldap) 
...
For those utilizing a SAML Service Provider, the SAML Service Provider option is available. You can learn how to set up a SAML Service Provider with our [MockSAML example](/docs/manage/federation/mocksaml).

Should you wish to transition from a generic OIDC provider to Entra ID (formerly Azure Active Directory) or Google, consider following this [guide](/docs/manage/federation/migrate).
...
- [Identity brokering in ZITADEL](/docs/learn/features/identity-brokering)
- [The ZITADEL API reference for managing external IdPs](/docs/reference/api-v1/admin/zitadel.admin.v1.AdminService.ListIDPs)
- [Handle external logins in a custom login UI](/docs/build-and-integrate/customization/branding/external-login)
