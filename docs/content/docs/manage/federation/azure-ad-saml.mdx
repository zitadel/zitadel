...
<Callout type="info" title="You can ignore the ZITADEL ACS Intent API URL for now.">
This is relevant if you want to [programmatically sign users in at ZITADEL via a SAML Service Provider](/docs/build-and-integrate/customization/branding/external-login).
