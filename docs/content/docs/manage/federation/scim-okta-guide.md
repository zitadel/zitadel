...
1. **Create a Service User**:
   ...
   * Follow [this guide](https://zitadel.com/docs/manage/org-management/users) to create a Service User within your ZITADEL Organization.
...
4. Detailed instructions to authenticate the Service User can be found [here](https://zitadel.com/docs/build-and-integrate/m2m/authenticate-service-users).
...
*(Find more details about endpoints [here](https://zitadel.com/docs/reference/scim2#supported-endpoints)).*
...
* [ZITADEL: Creating Service Users](https://zitadel.com/docs/manage/org-management/users)

* [ZITADEL: Service User Authentication](https://zitadel.com/docs/build-and-integrate/m2m/authenticate-service-users)

* [ZITADEL SCIM 2.0 API Endpoints](https://zitadel.com/docs/reference/scim2)

* [SCIM v2.0 (Preview) docs](https://zitadel.com/docs/manage/org-management/user-management/scim2)