...
Please refer to the [service description](./cloud-service-description#enterprise-license-and-self-hosted) for an overview of ZITADEL Enterprise.
...
<Tabs>
    <Tab value="in" label="Topics in scope">
      <ul>
    ...
    <Tab value="out" label="Topics out of scope" default>
      <ul>
