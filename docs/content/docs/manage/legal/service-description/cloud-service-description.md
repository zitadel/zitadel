...
Your obligations while operating and using ZITADEL are detailed in our [terms of service](/docs/manage/legal/terms-of-service#your-obligations) given the provisions in our [acceptable use policy](/docs/manage/legal/policies/acceptable-use-policy).
When using ZITADEL Cloud, we may processing data on behalf according to the [data processing agreement](/docs/manage/legal/data-processing-agreement).
...
Please consult the [migration guides](/docs/manage/migrate/introduction) for more information.
