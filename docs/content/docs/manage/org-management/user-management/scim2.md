...
To learn more about Zitadel's SCIM API, see the API documentation [here](/docs/reference/scim2).
...
For more information about user metadata, see [here](/docs/build-and-integrate/customization/general/user-metadata).
...
- **[Zitadel SCIM API Documentation](/docs/reference/scim2)**: Documentation of Zitadel's SCIM API implementation.
