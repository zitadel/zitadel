...
OpenID Connect (OIDC) allows you to control the initial screen by sending a [prompt](/docs/reference/openidoauth/endpoints#additional-parameters) parameter in the authorization request.
...
Please follow the configuration guides for the needed providers: [Let Users Login with Preferred Identity Provider in ZITADEL](/docs/manage/federation/introduction)
...
You can find all the guides here: [Build your own login UI](/docs/build-and-integrate/customization/branding/login-app)

#### Custom fields

The [create user request](/docs/reference/api/user/zitadel.user.v2.UserService.AddHumanUser) also allows you to add [metadata](/docs/build-and-integrate/customization/general/user-metadata) (key, value) to the user.
...
Those metadata can also directly be included in the [token](/docs/build-and-integrate/customization/general/user-metadata#use-tokens-to-get-user-metadata) of the user.
