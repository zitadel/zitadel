...
We will also explain how to leverage [Managers](/docs/manage/org-management/managers) to delegate self-service team management and configuration of policies to users of each organization.
...
Each ZITADEL instance does automatically bring a management console with it. The [console](/docs/manage/console-overview) can be used to manage all your resources through a UI.
You can access it by calling the following URL: `${CUSTOM-DOMAIN}/ui/`
Make sure that your admins have a [Manager role](/docs/manage/org-management/managers) with permissions on an instance level such as "INSTANCE_OWNER"
...
If you do want to know more about the roles check out the [ZITADEL Managers Guide with the Role List](/docs/manage/org-management/managers)
...
3. Configure the identity provider you need.
   Follow our detailed configuration description of the different providers we have: [Configure the needed identity provider](/docs/manage/federation/introduction)
...
[Example for prefilling user data automatically](/docs/manage/federation/additional-information#automatically-pre-fill-user-data)
...
You can read more about the managers, roles and their meanings [here](/docs/manage/org-management/managers)
...
[Restrict the instance features](/docs/reference/api-v1/admin/zitadel.admin.v1.AdminService.SetRestrictions)
...
Detailed description of [Setup Organization](/docs/reference/api-v1/admin/zitadel.admin.v1.AdminService.SetUpOrg)
...
[Set Organization Metadata](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.SetOrgMetadata)
If you have more than one field, you can use the bulk add request:
[Bulk Set Organization Metadata](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.BulkSetOrgMetadata)

The same requests also exist on the user resource:
[Set User Metadata](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.SetUserMetadata)
[Bulk Set User Metadata](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.BulkSetUserMetadata)
