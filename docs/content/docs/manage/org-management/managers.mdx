...
import ManagerDescription from '../../learn/structure/_manager_description.mdx';
...
import permissionDataRaw from '../../../../../cmd/defaults.yaml';
...
<PermissionTable data={yaml.load(permissionDataRaw)} />