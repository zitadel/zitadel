...
If you would build out the [POS use case example](/docs/manage/projects-apps/projects#example) you would probably need an application for administration.
...
> You can also add users of other organizations. Click on the hint below the username field to create an [external user grant](/docs/learn/features/external-user-grant).
...
Now you can retrieve those roles in your application. ZITADEL has [multiple settings](/docs/manage/projects-apps/projects#project-settings) for you to access them more easily. Navigate to the **General** section of your project and check your needed ones.
