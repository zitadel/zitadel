...
import OrgDescription from '../../learn/structure/_org_description.mdx';
...
This setting is called **User Loginname must contain orgdomain** and is part of your [Domain settings](/docs/manage/policies/default-settings#domain-settings).
...
If the "validate org domains" settings in the [Domain Settings](/docs/manage/policies/default-settings#domain-settings) is set to true, you have to prove the ownership of your domain, by DNS or HTTP challenge.
...
<Callout type="info" title="You can also disable domain verification with DNS challenge in the [default settings](/docs/manage/policies/default-settings#domain-settings).">
...
- [**Login Behavior and Access**](/docs/manage/policies/default-settings#login-behavior-and-access): Multifactor Authentication Options and Enforcement, Define whether Passwordless authentication methods are allowed or not, Set Login Lifetimes and advanced behavour for the login interface.
- [**Identity Providers**](/docs/manage/policies/default-settings#identity-providers): Define IDPs which are available for all organizations
- [**Password Complexity**](/docs/manage/policies/default-settings#password-complexity): Requirements for Passwords ex. Symbols, Numbers, min length and more.
- [**Lockout**](/docs/manage/policies/default-settings#lockout): Set the maximum attempts a user can try to enter the password or any (T)OTP method. When the number is exceeded, the user gets locked out and has to be unlocked.
- [**Verified domains**](/docs/manage/org-management/organizations#verify-your-domain-name): This is where you manage your organization specific domains which can be used to build usernames
- [**Domain settings**](/docs/manage/policies/default-settings#domain-settings): Whether users use their email or the generated username to login. Other Validation, SMTP settings
- [**Branding**](/docs/manage/policies/default-settings#branding): Appearance of the login interface.
- [**Message Texts**](/docs/manage/policies/default-settings#message-texts): Text and internationalization for emails
- [**Login Interface Texts**](/docs/manage/policies/default-settings#login-interface-texts): Text and internationalization for the login interface
- [**External Links**](/docs/manage/policies/default-settings#external-links): Links to your own Terms of Service and Privacy Policy regulations, Help Page, Support email, documentation link...
...
The behavior of the login page, applying custom design, is then defined on your projects detail page. Read more about it [here](/docs/manage/projects-apps/projects#branding)

## Show Organization Login

As you should know by now ZITADEL knows the concept of Organizations.
You can define [default settings](/docs/manage/policies/default-settings) for your ZITADEL, or you can overwrite them for an [Organization](#organization-settings).
...
Read more about the [scopes](/docs/reference/openidoauth/scopes#reserved-scopes) or try it out in our [OIDC Playground](https://zitadel.com/playgrounds/oidc).
...
When no organization was selected (eg, with the auth request or through [Domain Discovery](/docs/build-and-integrate/patterns/domain-discovery)), then all users are allowed to login and users can self-register to this default organization.
