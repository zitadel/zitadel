...
<Callout type="info" title="Technical Advisories">
If you want to stay up to date on our technical advisories, we recommend [subscribing here to the mailing list](/docs/manage/support/technical_advisory#subscribe-to-our-mailing-list).
...
<Callout type="info" title="Mandatory Information">
