...
<Callout type="info" title="We describe our [support services](/docs/manage/legal/service-description/support-services) and information required in more detail in our legal section. Beware that not all features may be supported by your subscription and consult the [support states](/docs/manage/support/software-release-cycles-support#support-states).">
