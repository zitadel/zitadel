...
3. Create a [personal access token](/docs/build-and-integrate/m2m/personal-access-token)
4. Go to the Default settings
5. Add the import_user as [manager](/docs/manage/org-management/managers) with the role "IAM Owner"
...
3. Create a [personal access token](/docs/build-and-integrate/m2m/personal-access-token)
4. Go to the Default settings
5. Add the export_user as [manager](/docs/manage/org-management/managers) with the role "IAM Owner"
