...
See: [Managing Organizations in ZITADEL](https://zitadel.com/docs/manage/org-management/organizations).
...
- **Client Credentials Flow**  
  [Learn how to authenticate with client credentials.](https://zitadel.com/docs/build-and-integrate/m2m/client-credentials)

- **Personal Access Token (PAT)**  
  [Learn how to create and use a PAT.](https://zitadel.com/docs/build-and-integrate/m2m/authenticate-service-users#personal-access-token)

**Reference:** [Service Users & API Authentication](https://zitadel.com/docs/build-and-integrate/m2m/authenticate-service-users#authentication-methods)

### 5.2. Import Data with the ZITADEL API

- Use your **access token** or **PAT** to authorize the request.
- Call the [Admin API – Import Data](https://zitadel.com/docs/reference/resources/admin/admin-service-import-data) endpoint, passing your generated JSON file.
