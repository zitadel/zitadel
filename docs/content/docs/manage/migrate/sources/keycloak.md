...
* **Personal Access Token (PAT)**
  [Learn how to create and use a PAT.](https://zitadel.com/docs/build-and-integrate/m2m/personal-access-token)
...
Use your **access token** or **PAT** to authenticate, then call the [Management API – Human User Import](https://zitadel.com/docs/reference/resources/admin/admin-service-import-data) endpoint.
