...
As ZITADEL Cloud customer, you can also login to the <a href="https://zitadel.com/admin">ZITADEL Customer Portal</a> and enable the Technical Advisory <a href="https://zitadel.com/admin/settings">Notifications</a> in your settings.
...
ZITADEL is built for [zero downtime upgrades](/docs/learn/architecture/solution#zero-downtime-updates) at upgrades can be executed without downtime by just updating to a more recent version.
