...
specify this by providing [an organization scope](/docs/reference/openidoauth/scopes#reserved-scopes).
...
Already existing instances will still use the instance settings by default and can switch to the new default by ["Activating the 'LoginDefaultOrg' feature"](/docs/reference/api-v1/admin/zitadel.admin.v1.AdminService.ActivateFeatureLoginDefaultOrg) through the Admin API.
