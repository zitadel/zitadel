...
Read more about [Console Managers](./org-management/managers) here.
...
Depending on your use case, multiple organizations can be created (B2B) or you can stick to your global organization (B2C). To get an understanding of your use cases and how we recommend setting up your organizations, read the [Solution Scenario](/docs/build-and-integrate/patterns/configurations) guides.
...
Please follow this [guide](/docs/build-and-integrate/patterns/restrict-console) to achieve that.
