...
import Compose from './docker-compose.yaml?raw';
import ConfigDisabled from './traefik-disabled-tls.yaml?raw';
import ConfigExternal from './traefik-external-tls.yaml?raw';
import ConfigEnabled from './traefik-enabled-tls.yaml?raw';
