    ...
    return (
        <div>
            <CodeBlock language="bash">
                ...
                {'export ZITADEL_CONFIG_FILES=https://raw.githubusercontent.com/zitadel/zitadel/main/docs/docs/operate-and-self-host/manage/reverseproxy\n'}
