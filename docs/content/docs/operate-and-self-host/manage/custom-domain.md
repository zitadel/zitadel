...
However, if you want to access ZITADEL at an organization domain, [you can add additional domains using the System API](/docs/references/api-v1/system/zitadel.system.v1.SystemService.AddDomain).
