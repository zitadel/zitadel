...
* [Linux](/docs/operate-and-self-host/deploy/linux#run-postgresql)
* [MacOS](/docs/operate-and-self-host/deploy/macos#install-postgresql)

Or use the following commands for [Docker Compose](/docs/operate-and-self-host/deploy/compose)

```bash
# Download the docker compose example configuration.
wget https://raw.githubusercontent.com/zitadel/zitadel/main/docs/docs/operate-and-self-host/deploy/docker-compose.yaml
