...
- [Read more abouth how ZITADEL utilizes HTTP/2](/docs/operate-and-self-host/manage/http2).
- [Explore some concrete proxy configuration examples for ZITADEL](/docs/operate-and-self-host/manage/reverseproxy/reverse_proxy).
