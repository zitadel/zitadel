...
For production setups, we recommend that you [run ZITADEL in a highly available mode](/docs/operate-and-self-host/manage/production).
...
If you use the [official ZITADEL Helm chart](/docs/operate-and-self-host/deploy/kubernetes),
