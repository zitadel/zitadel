...
As soon as you successfully deployed ZITADEL as a proof of concept using one of our [deployment guides](/docs/operate-and-self-host/deploy/overview),
...
like [Kubernetes](/docs/operate-and-self-host/deploy/kubernetes).
...
Read more about separating the init and setup phases on the [Updating and Scaling page](/docs/operate-and-self-host/manage/updating_scaling).
...
- To make ZITADEL available at the domain of your choice, [you need to configure the ExternalDomain property](/docs/operate-and-self-host/manage/custom-domain).
- To enable and restrict access to **HTTPS**, head over to [the description of your TLS options](/docs/operate-and-self-host/manage/tls_modes).
- If you want to front ZITADEL with a reverse proxy, web application firewall or content delivery network, make sure to support **[HTTP/2](/docs/operate-and-self-host/manage/http2)**.
- You can also refer to some **[example reverse proxy configurations](/docs/operate-and-self-host/manage/reverseproxy/reverse_proxy)**.
