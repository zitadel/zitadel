...
- A PostgreSQL as only needed storage. Make sure to read our [Production Guide](/docs/operate-and-self-host/manage/production#prefer-postgresql) before you decide to use Postgresql.
...
To do so, jump straight to the [production setup guide](/docs/operate-and-self-host/manage/production).
