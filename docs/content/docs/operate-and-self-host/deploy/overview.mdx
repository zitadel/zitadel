...
- A PostgreSQL as only needed storage. Make sure to read our [Production Guide](/docs/operate-and-self-host/manage/database/database) before you decide to use Postgresql.
