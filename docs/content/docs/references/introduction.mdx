...
Additionally, you can use the [session API](../apis/resources/session_service_v2/) to authenticate users, for example by building a [custom login UI](/docs/build-and-integrate/login-ui/).
...
ZITADEL allows to authenticate users by creating a session with the [Session API](/docs/references/resources/session_service_v2), get OIDC authentication request details with the [OIDC service API](/docs/references/resources/oidc_service_v2) or get SAML request details with the [SAML service API](/docs/references/resources/saml_service_v2).
User authorizations can be [retrieved as roles from our APIs](/docs/build-and-integrate/retrieve-user-roles).

Refer to our guide to learn how to [build your own login UI](/docs/build-and-integrate/login-ui)

## ZITADEL APIs (resource-based)

ZITADEL provides APIs for each [core resource](/docs/references/v2):

- [User](/docs/references/resources/user_service_v2)
- [Session](/docs/references/resources/session_service_v2)
- [Settings](/docs/references/resources/settings_service_v2)
