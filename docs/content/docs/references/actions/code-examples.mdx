...
- Internal Authentication
  - [Pre Creation](/docs/references/actions/internal-authentication#pre-creation)
- External Authentication
  - [Pre Creation](/docs/references/actions/external-authentication#pre-creation)
...
- Internal Authentication
  - [Post Creation](/docs/references/actions/internal-authentication#post-creation)
- External Authentication
  - [Post Creation](/docs/references/actions/external-authentication#post-creation)
...
- Internal Authentication
  - [Pre Creation](/docs/references/actions/internal-authentication#pre-creation)
  - [Post Authentication](/docs/references/actions/internal-authentication#post-authentication)
- External Authentication
  - [Pre Creation](/docs/references/actions/internal-authentication#pre-creation)
  - [Post Authentication](/docs/references/actions/internal-authentication#post-authentication)
...
If you use [Okta as an identity provider](/docs/build-and-integrate/identity-providers/okta-oidc) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use [Gitlab as an identity provider](/docs/build-and-integrate/identity-providers/gitlab) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use [Github as an identity provider](/docs/build-and-integrate/identity-providers/github) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use a [generic OIDC identity provider](/docs/build-and-integrate/identity-providers/migrate#migrate-generic-oidc-provider) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use [Okta as an identity provider](/docs/build-and-integrate/identity-providers/okta_saml#add-attribute-statements) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use [Microsoft Entra as SAML identity provider](/docs/build-and-integrate/identity-providers/azure-ad-saml) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
If you use a [SAML identity provider like mocksaml](/docs/build-and-integrate/identity-providers/mocksaml) you can improve the onboarding experience of new users by prefilling some basic information during authentication.
...
- External Authentication
  - [Pre Creation](/docs/references/actions/external-authentication#pre-creation)
  - [Post Creation](/docs/references/actions/external-authentication#post-creation)
  - [Post Authentication](/docs/references/actions/external-authentication#post-authentication)
...
This example uses [zitadel's log module](/docs/references/actions/modules#log)
...
Allows you to limit the user interaction. The error thrown will be shown to the user if the action is not [allowed to fail](/docs/concepts/features/actions#how-it-works).
