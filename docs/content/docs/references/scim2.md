...
```json
{
  ...
  "documentationUri": "https://zitadel.com/docs/manage-and-govern/user/scim2",
  "patch": {
    "supported": true
  },
  "bulk": {
  ...
  "authenticationSchemes": [
    {
      ...
      "documentationUri": "https://zitadel.com/docs/build-and-integrate/service-users/authenticate-service-users",
