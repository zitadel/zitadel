...
You can add custom attributes using the [complement SAMLresponse](/docs/references/actions/customize-samlresponse) of the [actions feature](/docs/references/actions/introduction).
