...
Not all request parameters are available in the playground. Please refer to the full documentation of the [authorization endpoint](/docs/references/openidoauth/endpoints#authorization-endpoint).
...
More in the <a href="/docs/references/openidoauth/endpoints#required-request-parameters">documentation</a> about required Parameters.
...
More in the [documentation](/docs/references/openidoauth/authn-methods) about authentication methods.
...
There are many more additional parameters. Please refer to the [documentation](/docs/references/openidoauth/endpoints#additional-parameters) about additional parameters.
...
Not all scopes are available in the playground. Please refer to the full [documentation](/docs/references/openidoauth/scopes) for the exhaustive list of available standard and reserved scopes.
...
Please refer to the [documentation](/docs/references/openidoauth/scopes#reserved-scopes) for a full list of available reserved scopes.
...
Please refer to the full [guide on branding](/docs/manage-and-govern/customize/branding).

### Get user metadata

Pass the scope `urn:zitadel:iam:user:metadata` to request a user's metadata.
Please refer to the full [guide on user-metadata](/docs/manage-and-govern/customize/user-metadata) for further details.

### Access core apis

Calling the [core API](/docs/references/introduction) with the authenticated user, requires that the projectID of ZITADEL is included in the audience claim.
...
OpenID Connect certified libraries should allow you to customize the parameters and define scopes for the authorization request. You can also continue by using one of our [example applications](/docs/build-and-integrate/sdk-examples/introduction).
