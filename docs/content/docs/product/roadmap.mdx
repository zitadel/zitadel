...
<table id="zitadel-versions">
    ...
    <tbody>
        ...
        <tr>
            <th scope="row">[v4.x](/docs/product/roadmap#v-4-x)</th>
            <td colSpan={3}></td>
            <td colSpan={3} class="release-impl">Implementation</td>
            <td class="release-rc">RC</td>
            <td colspan={5} class="release-stable">GA / Stable </td>
        ...
        <tr>
            <th scope="row">[v5.x](/docs/product/roadmap#v-5-x)</th>
...
<table id="zitadel-versions">
    ...
    <tbody>
        ...
        <tr>
            <td scope="row">
                [v2.x](/docs/product/roadmap#v-2-x)
            </td>
            <td scope="row">
                [v3.x](/docs/product/roadmap#v-3-x)
                <ul>
                    <li>
                        Actions V2
                    </li>
            ...
            <td scope="row">
                [v4.x](/docs/product/roadmap#v-4-x)
                <ul>
                    <li>Resource API</li>
                    <li>
                        Login v2 as default
            ...
            <td scope="row">
                [v5.x](/docs/product/roadmap#v-5-x)
                <div>Release: TBC</div>
                <ul>
                    <li>Analytics</li>
                    <li>User Groups</li>
        ...
        <tr>
            ...
            <td scope="row">
                <ul>
                    <li>
                        [Initial Version of PHP SDK](/docs/product/roadmap#v-3-x-php)
                    </li>
                    <li>
                        [Initial Version of Java SDK](/docs/product/roadmap#v-3-x-java)
                    </li>
                    <li>
                        [Initial Version of Ruby SDK](/docs/product/roadmap#v-3-x-ruby)
                    </li>
                    <li>
                        [Initial Version of Python SDK](/docs/product/roadmap#v-3-x-python)
                    </li>
                </ul>
            </td>
            <td scope="row">
...
<details>
    ...
    <details>
        ...
        Check out the [new API](/docs/reference/api/action)
...
<details>
    ...
    <details>
        ...
        - [Actions V2](/docs/reference/api/action)
    </details>
</details>
