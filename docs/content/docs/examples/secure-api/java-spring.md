...
![Create app in console](/java-spring/api-create.png)

Select Basic Auth for authenticating at the Introspection Endpoint.

![Create app in console](/java-spring/api-create-auth.png)
...
![Create api key in console](/java-spring/api-create-clientid-secret.png)
...
![Create project role in console](/java-spring/api-project-role.png)
...
![Created authorization in console](/java-spring/api-project-auth.png)
