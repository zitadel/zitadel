...
![Project settings in console](/docs/img/django/project-settings.png)
...
![Project roles in console](/docs/img/django/project-roles.png)

Finally, we can assign the roles to users in the project's authorizations tab.

![Project authorizations in console](/docs/img/django/project-authorizations.png)
...
![Create app in console](/docs/img/django/app-create.png)
...
![Configure app authentication method in console](/docs/img/django/app-auth-method.png)
...
![Configure app redirects console](/docs/img/django/app-redirects.png)
