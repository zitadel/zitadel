...
![Project settings in console](/django/project-settings.png)
...
![Project roles in console](/django/project-roles.png)

Finally, we can assign the roles to users in the project's authorizations tab.

![Project authorizations in console](/django/project-authorizations.png)
...
![Create app in console](/django/app-create.png)
...
![Configure app authentication method in console](/django/app-auth-method.png)
...
![Configure app redirects console](/django/app-redirects.png)
