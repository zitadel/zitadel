...
![Create app in console](/react/app-create.png)
...
![Create project role "admin"](/react/project-role.png)

![Assign the "admin" role to your user](/react/project-authz.png)
...
![App in console](/react/app-screen.png)
