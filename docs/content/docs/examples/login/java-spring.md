...
![Create app in console](/java-spring/app-create.png)
...
![Create app in console - set auth method](/java-spring/app-create-auth.png)
...
![Create app in console - set redirectURI](/java-spring/app-create-redirect.png)
...
![Create app in console - copy client_id](/java-spring/app-create-clientid.png)
...
![Profile Page](/java-spring/app-profile.png)
