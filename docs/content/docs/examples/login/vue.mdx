...
![Create app in console](/vue/app-create.png)
...
![Tick refresh token checkbox](/vue/tick-refresh-token.png)
...
![Create project role "admin"](/vue/project-role.png)

![Assign the "admin" role to your user](/vue/project-authz.png)
...
![App in console](/vue/app-screen.png)
