...
![Create app in console](/go/app-create.png)
...
![Create app in console - set auth method](/go/app-create-auth.png)
...
![Create app in console - set redirectURI](/go/app-create-redirect.png)
...
![Create app in console - copy client_id](/go/app-create-clientid.png)
...
![Profile Page](/go/app-profile.png)
