...
![Project settings in console](/symfony/project-settings.png)
...
![Project roles in console](/symfony/project-roles.png)

Finally, we can assign the roles to users in the project's authorizations tab.

![Project authorizations in console](/symfony/project-authorizations.png)
...
![Create app in console](/symfony/app-create.png)
...
![Configure app authentication method in console](/symfony/app-auth-method.png)
...
![Configure app redirects console](/symfony/app-redirects.png)
