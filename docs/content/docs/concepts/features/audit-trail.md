...
You can check the last changes of most objects in the [Console](/docs/manage-and-govern/console/overview).
In the following screenshot you can see an example of last changes on an [user](/docs/manage-and-govern/console/users).
...
Administrators can see all events across an instance and filter them directly in [Console](/docs/manage-and-govern/console/overview).
...
Follow our guide on how to [integrate ZITADEL with external systems for streaming events and audit logs](/docs/build-and-integrate/external-audit-log).
