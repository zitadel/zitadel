...
Learn how to [configure a custom domain in ZITADEL Cloud](/docs/manage-and-govern/cloud/instances#add-custom-domain) or how to configure [custom domain when self-hosting](/docs/operate-and-self-host/manage/custom-domain).
