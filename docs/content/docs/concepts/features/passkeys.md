...
* **Documentation:** Passkeys Guide: [https://zitadel.com/docs/build-and-integrate/login-ui/passkey](/docs/build-and-integrate/login-ui/passkey)
* **Create Passkey Registration Link API:** [https://zitadel.com/docs/manage-and-govern/user/reg-create-user](/docs/manage-and-govern/user/reg-create-user)
