...
Users who use [Kubernetes/Helm](/docs/operate-and-self-host/deploy/kubernetes) or serverless container services like Google Cloud Run can benefit from the fact the above process is automated.
