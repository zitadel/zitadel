...
Learn how to [use service users](/docs/build-and-integrate/service-users/authenticate-service-users) with ZITADEL.
...
In a multi-tenancy architecture, you might use [organizations](/docs/concepts/structure/organizations) to separate user groups.
...
- [ZITADEL APIs: Users](/docs/references/api-v1/management/zitadel.management.v1.ManagementService.ListUsers)
- [User onboarding and registration](/docs/build-and-integrate/onboarding/end-users)
