...
The default configuration can be overridden for each organization, some policies are currently only available on the instance level. Learn more about our different policies [here](/docs/manage-and-govern/console/default-settings.mdx).
