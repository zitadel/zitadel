...
![Organization Grant](/docs/img/concepts/objects/organization_grants.png)
...
To learn more about how to setup Project grants, read this guide [here](../../guides/manage/console/projects-overview#granted-projects-b-2-b)
