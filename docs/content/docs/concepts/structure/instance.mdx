...
Read more about how to configure your instance in our [instance guide](/docs/manage-and-govern/console/default-settings).
...
Nevertheless, you can add more virtual instances via the [system API](/docs/references/api-v1/system/zitadel.system.v1.SystemService.CreateInstance).
