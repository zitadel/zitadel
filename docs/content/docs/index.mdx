...
Follow our [quick start guide](/docs/build-and-integrate/quickstarts).
...
If you're unsure, consider the generous free tier of [ZITADEL Cloud](/docs/manage/cloud/start).

Choose [ZITADEL Cloud](/docs/manage/cloud/start) if you want:
...
Choose [ZITADEL self-hosted](/docs/operate/deploy/overview) if you want:
