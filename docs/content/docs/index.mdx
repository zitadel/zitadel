...
Follow our [quick start guide](/docs/quickstarts).
...
If you're unsure, consider the generous free tier of [ZITADEL Cloud](/docs/manage-and-govern/cloud/start).

Choose [ZITADEL Cloud](/docs/manage-and-govern/cloud/start) if you want:
...
Choose [ZITADEL self-hosted](/docs/operate-and-self-host/deploy/overview) if you want:
