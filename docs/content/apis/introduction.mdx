...
[Actions](/docs/guides/manage/console/actions-overview) allow to extend ZITADEL with custom code to change default behaviors or calling external systems.
...
Additionally, you can use the [session API](/docs/reference/api/session) to authenticate users, for example by building a [custom login UI](/docs/guides/integrate/login-ui).
...
ZITADEL allows to authenticate users by creating a session with the [Session API](/docs/reference/api/session), get OIDC authentication request details with the [OIDC service API](/docs/reference/api/oidc) or get SAML request details with the [SAML service API](/docs/reference/api/saml).
...
- [User](/docs/reference/api/user)
- [Session](/docs/reference/api/session)
...
API Reference:
[OpenAPI Docs](/docs/reference/api-v1/auth)
...
API Reference:
[OpenAPI Docs](/docs/reference/api-v1/management)
...
API Reference:
[OpenAPI Docs](/docs/reference/api-v1/admin)
...
API Reference:
[OpenAPI Docs](/docs/reference/api-v1/system)
