...
![Configuration](../../../../public/img/guides/integrate/tools/apache-configuration.png)
![Redirect Settings](../../../../public/img/guides/integrate/tools/apache-redirect_settings.png)

You can find the url to your discovery endpoint under "URLs":
![Discovery Endpoint](../../../../public/img/guides/integrate/tools/apache-urls.png)
