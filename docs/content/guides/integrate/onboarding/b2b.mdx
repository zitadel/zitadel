...
Each ZITADEL instance does automatically bring a management console with it. The [console](/docs/guides/manage/console/console-overview) can be used to manage all your resources through a UI.
...
[Example for prefilling user data automatically](/docs/guides/integrate/identity-providers/additional-information#automatically-pre-fill-user-data)
</Callout>
...
If you do not want to allow users to register organizations with this form, you can disable it with the following request27: [Restrict the instance features](/docs/reference/api-v1/admin/zitadel.admin.v1.AdminService.SetRestrictions)
