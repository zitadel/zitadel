...
![Security Center](/docs/img/saml/atlassian/atlassian-01.png)

For Identity Provider select "Other provider" and enter a Directory Name.
![Add identity provider](/docs/img/saml/atlassian/atlassian-02.png)
...
![Add SAML details](/docs/img/saml/atlassian/atlassian-03.png)
...
![Copy URLs](/docs/img/saml/atlassian/atlassian-04.png)
...
![Authentication policies](/docs/img/saml/atlassian/atlassian-05.png)

Add members to your policy.
![Add Members](/docs/img/saml/atlassian/atlassian-06.png)
