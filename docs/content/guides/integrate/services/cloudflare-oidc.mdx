...
- Existing ZITADEL instance, organization, and project. Follow our [get started](/docs/guides/start/quickstart) guide to get started. If not present follow [this guide](/docs/guides/start/quickstart)
...
![user info inside id token](../../../../public/img/guides/integrate/services/user-info-inside-id-token.png)
