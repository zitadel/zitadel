...
![GitHub Provider](../../../../public/img/guides/zitadel_github_create_provider.png)
...
![Register an OAuth application](../../../../public/img/guides/github_oauth_app_registration.png)
...
![Client ID and Secret](../../../../public/img/guides/github_oauth_client_id_secret.png)
...
![Activate the GitHub](../../../../public/img/guides/zitadel_activate_github.png)
...
![GitHub Button](../../../../public/img/guides/zitadel_login_github.png)

![GitHub Login](../../../../public/img/guides/github_login.png)

<UnlinkedOAuth components={props.components}  provider="GitHub"/>

![GitHub Login](../../../../public/img/guides/zitadel_login_external_not_found_registration.png)
