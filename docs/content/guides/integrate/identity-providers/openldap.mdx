...
![LDAP Provider](/docs/img/guides/zitadel_ldap_create_provider.png)

### Activate IdP

<Activate components={props.components} />

![Activate the LDAP Provider](/docs/img/guides/zitadel_activate_ldap.png)
...
![LDAP Button](/docs/img/guides/zitadel_login_ldap.png)

![LDAP Login](/docs/img/guides/zitadel_login_ldap_input.png)
