...
![Apple Provider](/docs/img/guides/zitadel_apple_create_provider.png)
...
![Apple Service](/docs/img/guides/apple_service_create.png)
...
![Activate the Apple Provider](/docs/img/guides/zitadel_activate_apple.png)
...
![Apple Button](/docs/img/guides/zitadel_login_apple.png)

![Apple Login](/docs/img/guides/apple_login.png)
