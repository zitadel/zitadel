...
![Activate OneLogin SAML provider in ZITADEL](/img/guides/zitadel_activate_onelogin_saml.png)
...
![Image: OneLogin button on ZITADEL login](/img/guides/zitadel_login_onelogin_button.png)
