...
![Activate PingFederate SAML provider in ZITADEL](/img/guides/zitadel_activate_pingfederate_saml.png)
...
![Image: PingFederate button on ZITADEL login](/img/guides/zitadel_login_pingfederate_button.png)
