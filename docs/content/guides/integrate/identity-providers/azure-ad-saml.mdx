...
![Azure SAML App Creation](../../../../public/img/guides/azure_saml_app_create.png)
...
![Disable assignment required check](../../../../public/img/guides/azure_disable_assignment_required.png)
...
![Azure Entra overview](../../../../public/img/guides/azure_saml_overview.png)
...
![Azure SAML App Creation](../../../../public/img/guides/zitadel_azure_saml_provider.png)
...
![Azure SAML App URLs](../../../../public/img/guides/zitadel_azure_saml_provider_urls.png)
...
This is relevant if you want to [programmatically sign users in at ZITADEL via a SAML Service Provider](/docs/guides/integrate/login-ui/external-login).
</Callout>

![Azure Entra configuration overview](../../../../public/img/guides/azure_saml_overview2.png)
...
![Activate Azure SAML Provider](../../../../public/img/guides/zitadel_activate_azure_saml.png)
...
![Azure Entra Button](../../../../public/img/guides/zitadel_login_azure_saml.png)

Click **Microsoft Entra**

![Entra ID Login](../../../../public/img/guides/microsoft_login.png)
