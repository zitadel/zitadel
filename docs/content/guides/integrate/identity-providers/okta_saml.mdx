...
![OKTA Provider Empty](/docs/img/guides/zitadel_okta_saml_provider_empty.png)

After you created the SAML Provider in ZITADEL, you can copy the URLs you need to configure in your OKTA application.

![OKTA SAML App URLs](/docs/img/guides/zitadel_okta_saml_provider_urls.png)
...
![Add new SAML Application in OKTA](/docs/img/guides/okta_add_saml_app.png)
...
![Add Attribute Mapping ](/docs/img/guides/okta_saml_attribute_mapping.png)
...
![Add new SAML Application in OKTA](/docs/img/guides/okta_assign_user_to_app.png)
...
![OKTA Provider Empty](/docs/img/guides/zitadel_okta_saml_provider_filled.png)
...
![Activate the OKTA Provider](/docs/img/guides/zitadel_activate_okta_saml.png)
...
![OKTA Button](/docs/img/guides/zitadel_login_okta.png)

![OKTA Login](/docs/img/guides/okta_login.png)
