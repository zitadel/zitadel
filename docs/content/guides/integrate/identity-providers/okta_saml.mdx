...
- [Add Default SAML Identity Provider](/docs/reference/api-v1/admin/zitadel.admin.v1.AdminService.AddSAMLProvider)
- [Add SAML Identity Provider on Organization](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.AddSAMLProvider)

![OKTA Provider Empty](../../../../public/img/guides/zitadel_okta_saml_provider_empty.png)

After you created the SAML Provider in ZITADEL, you can copy the URLs you need to configure in your OKTA application.

![OKTA SAML App URLs](../../../../public/img/guides/zitadel_okta_saml_provider_urls.png)
...
![Add new SAML Application in OKTA](../../../../public/img/guides/okta_add_saml_app.png)
...
![Add Attribute Mapping ](../../../../public/img/guides/okta_saml_attribute_mapping.png)
...
![Add new SAML Application in OKTA](../../../../public/img/guides/okta_assign_user_to_app.png)
...
- [Update Default SAML Identity Provider](/docs/reference/api-v1/admin/zitadel.admin.v1.AdminService.UpdateSAMLProvider)
- [Update SAML Identity Provider on Organization](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.UpdateSAMLProvider)

![OKTA Provider Empty](../../../../public/img/guides/zitadel_okta_saml_provider_filled.png)
...
![Activate the OKTA Provider](../../../../public/img/guides/zitadel_activate_okta_saml.png)
...
![OKTA Button](../../../../public/img/guides/zitadel_login_okta.png)

![OKTA Login](../../../../public/img/guides/okta_login.png)
