...
![GitLab Provider](../../../../public/img/guides/zitadel_gitlab_create_provider.png)
...
![Register an OAuth application](../../../../public/img/guides/gitlab_app_registration.png)
...
![Client ID and Secret](../../../../public/img/guides/gitlab_app_id_secret.png)
...
![Activate the GitLab](../../../../public/img/guides/zitadel_activate_gitlab.png)
...
![GitLab Button](../../../../public/img/guides/zitadel_login_gitlab.png)

![GitLab Login](../../../../public/img/guides/gitlab_login.png)

<UnlinkedOAuth components={props.components}  provider="GitLab"/>

![GitLab Login](../../../../public/img/guides/zitadel_login_external_not_found_registration.png)
