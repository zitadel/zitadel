...
export const pkce = () => (
  <tr key="pkce">
    <td>
      <img
        width="300px"
        src="../../../../public/img/guides/application/pkce-logo-dark.png"
        alt="pkce preview"
      />
    </td>
    <td>
...
export const code = () => (
  <tr key="code">
    <td>
      <img
        width="300px"
        src="../../../../public/img/guides/application/code-logo-dark.png"
        alt="code preview"
      />
    </td>
    <td>
...
export const jwt = () => (
  <tr key="jwt">
    <td>
      <img
        width="300px"
        src="../../../../public/img/guides/application/jwt-logo-dark.png"
        alt="jwt preview"
      />
    </td>
    <td>
...
export const post = () => (
  <tr key="post">
    <td>
      <img
        width="300px"
        src="../../../../public/img/guides/application/post-logo-dark.png"
        alt="post preview"
      />
    </td>
    <td>
...
export const implicit = () => (
  <tr key="implicit">
    <td>
      <img
        width="300px"
        src="../../../../public/img/guides/application/implicit-logo-dark.png"
...
export const basic = () => (
  <tr key="basic">
    <td>
      <img
        width="300px"
        src="../../../../public/img/guides/application/basic-logo-dark.png"
        alt="Basic preview"
      />
    </td>
    <td>
