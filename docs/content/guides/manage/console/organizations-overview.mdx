...
* **Multi-tenancy:** Multiple organizations can be managed within one [instance](/docs/concepts/structure/instance).
...
To create a new organization, click on the organizations dropdown in the Console and select **New organization**.
...
<img
  width="400px"
  src="../../../../public/img/console_org_select.png"
...
<img
  width="400px"
  src="../../../../public/img/console_org_register.png"
...
When no specific organization is selected (e.g., during an auth request or via [Domain Discovery](/docs/guides/solution-scenarios/domain-discovery)), users are directed to this default organization for login and self-registration.
...
<Callout>
You can disable domain verification requirements in the [default settings](/docs/guides/manage/console/default-settings#domain-settings) if you are running a self-hosted instance and do not require strict validation.
</Callout>
...
<img
  width="400px"
  src="../../../../public/img/console_verify_domain.png"
...
This value is a [reserved scope](/docs/apis/openidoauth/scopes#reserved-scopes) within ZITADEL.