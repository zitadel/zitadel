...
- prompt ([the OIDC prompt parameter](/docs/apis/openidoauth/endpoints#additional-parameters))
...
We hope you enjoyed the tutorial and encourage you to check out the ZITADEL [documentation](/docs/docs) for more information on how to use the ZITADEL platform to its full potential. Thanks for joining us!
