...
![Home Page](/docs/img/guides/quickstart/v3_1.png)
...
![Registration Page](/docs/img/guides/quickstart/v3_2.png)

3. Next, complete your details and click "Continue".

![Congratulations Page](/docs/img/guides/quickstart/v3_3.png)
...
![Login](/docs/img/guides/quickstart/v3_8.png)
...
![Onboarding Questions](/docs/img/guides/quickstart/onboarding_questions.png)
...
![Sign In Instance](/docs/img/guides/quickstart/sign_in_instance.png)
...
![Instance Details](/docs/img/guides/quickstart/instance_dashboard.png)
...
![Project Name and Framework/Language](/docs/img/guides/quickstart/create_project_react.png)

3. An overview of the configuration for the framework you have selected is shown

![Project Configuration Overview - React App](/docs/img/guides/quickstart/project_config_overview_react.png)
...
![Project Name and Framework/Language](/docs/img/guides/quickstart/app_detail_overview_react.png)
...
![Add User](/docs/img/guides/quickstart/26.png)
...
![Add User](/docs/img/guides/quickstart/27.png)

3. The newly created user details will be displayed as shown below.

![User Info](/docs/img/guides/quickstart/28.png)
...
![User Info](/docs/img/guides/quickstart/29.png)
...
![Add Authorization](/docs/img/guides/quickstart/35.png)
...
![Add Authorization](/docs/img/guides/quickstart/37.png)
...
![Get URLs](/docs/img/guides/quickstart/51.png)
...
![Get URLs](/docs/img/guides/quickstart/52.png)
...
![Login](/docs/img/guides/quickstart/login1.png)

4. You will be redirected to the ZITADEL login page. Add your username/email and click on “next”.

![Redirect](/docs/img/guides/quickstart/login2.png)

5. Enter your password and click on “next”.

![Redirect](/docs/img/guides/quickstart/login3.png)
