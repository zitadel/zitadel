...
![Project Settings: Check for Project on authentication](/docs/img/guides/solution-scenarios/console-check-project-auth.png)
...
1. Click on the default-project > Grants > New +
   ![Project Settings: Default Project - Grants](/docs/img/guides/solution-scenarios/console-zitadel-project-grants.png)

2. On the next screen select the organization to which you want to give the grant
  ![Project Settings: Grants - Choose Organization](/docs/img/guides/solution-scenarios/console-create-project-grant-org.png)
...
![Console access restricted](/docs/img/guides/solution-scenarios/console-access-restricted.png)
