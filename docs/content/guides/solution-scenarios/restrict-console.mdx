...
With this workaround, you will limit users from accessing the [default-project](/docs/guides/manage/console/projects-overview#the-default-project), if they are not explicitly granted to use this project.
...
![Project Settings: Check for Project on authentication](../../../public/img/guides/solution-scenarios/console-check-project-auth.png)

Start by granting the organization of your managers, that should be able to access the Console, the [default project](/docs/guides/manage/console/projects-overview#the-default-project):

1. Click on the default-project > Grants > New +
   ![Project Settings: Default Project - Grants](../../../public/img/guides/solution-scenarios/console-zitadel-project-grants.png)

2. On the next screen select the organization to which you want to give the grant
  ![Project Settings: Grants - Choose Organization](../../../public/img/guides/solution-scenarios/console-create-project-grant-org.png)
...
To avoid accidental lock-out, the [default project](/docs/guides/manage/console/projects-overview#the-default-project) hides the checkbox "Check Project on Authentication" in the Console:
![Default Project](../../../public/img/guides/solution-scenarios/console-default-project.png)

You need to use the [update project API call](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.UpdateProject) to set the configuration on the project.
...
![Console access restricted](../../../public/img/guides/solution-scenarios/console-access-restricted.png)
