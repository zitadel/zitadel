...
More about the [scopes](/docs/apis/openidoauth/scopes#reserved-scopes)
...
Read more about [applications](../manage/console/applications) and the [redirect urls](../manage/console/applications#redirect-ur-is)
...
![Domain Policy: Organization domain as suffix](../../../public/img/guides/scenarios/domain_policy_org_domain_disabled.png)
...
![Login Policy Advanced Setting: Disable email for login](../../../public/img/guides/scenarios/login_policy_advanced.png)
...
![Login Policy Advanced Setting: Disable phone for login](../../../public/img/guides/scenarios/login_policy_advanced_phone.png)

## Embedding ZITADEL in an iFrame

To maximize the security during login and in the Console UI, ZITADEL follows security best practices by setting a
...
![Security Settings: Allow iFrame](../../../public/img/guides/scenarios/security_policy.png)
...
![Login Behavior Settings: Multi-factor init lifetime](../../../public/img/guides/scenarios/login-settings-mfa-init-lifetime.png)
