...
![Overview](/docs/img/concepts/objects/object_overview.png)
...
![Two instances with each organizations in it using the same database](/docs/img/concepts/objects/instances.png)
