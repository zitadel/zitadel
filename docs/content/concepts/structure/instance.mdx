...
One instance can contain multiple [organizations](/docs/guides/manage/console/organizations-overview),
which in turn can represent your own company (e.g. departments), your business customers or a consumer organization.

Read more about how to configure your instance in our [instance guide](/docs/guides/manage/console/default-settings).

![Overview](../../../public/img/concepts/objects/object_overview.png)
...
Nevertheless, you can add more virtual instances via the [system API](/docs/reference/api-v1/system).
...
![Two instances with each organizations in it using the same database](../../../public/img/concepts/objects/instances.png)
