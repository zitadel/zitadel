...
![Create app in console](/docs/img/vue/app-create.png)
...
![Tick refresh token checkbox](/docs/img/vue/tick-refresh-token.png)
...
![Create project role "admin"](/docs/img/vue/project-role.png)

![Assign the "admin" role to your user](/docs/img/vue/project-authz.png)
...
![App in console](/docs/img/vue/app-screen.png)
