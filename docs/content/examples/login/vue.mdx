...
![Create app in console](../../../public/img/vue/app-create.png)
...
![Tick refresh token checkbox](../../../public/img/vue/tick-refresh-token.png)
...
![Create project role "admin"](../../../public/img/vue/project-role.png)

![Assign the "admin" role to your user](../../../public/img/vue/project-authz.png)
...
![App in console](../../../public/img/vue/app-screen.png)
