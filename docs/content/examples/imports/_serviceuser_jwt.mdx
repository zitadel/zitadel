...
![Register the API](../../../public/img/examples/secure-api/service-user-jwt/1.png)

2. To add a service user, click on the **New** button.

![Register the API](../../../public/img/examples/secure-api/service-user-jwt/2.png)
...
![Register the API](../../../public/img/examples/secure-api/service-user-jwt/3.png)


4. Now you will see the saved details.

![Register the API](../../../public/img/examples/secure-api/service-user-jwt/4.png)
...
![Register the API](../../../public/img/examples/secure-api/service-user-jwt/5.png)


6. Select type **JSON** and click **Add**.

![Register the API](../../../public/img/examples/secure-api/service-user-jwt/6.png)

7. Download the key by clicking **Download**. After the download, click **Close**.

![Register the API](../../../public/img/examples/secure-api/service-user-jwt/7.png)


8. You will see the following screen afterwards.

![Register the API](../../../public/img/examples/secure-api/service-user-jwt/8.png)
