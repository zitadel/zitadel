...
![Register the API](../../../public/img/examples/secure-api/app-jwt/10.png)
...
![Register the API](../../../public/img/examples/secure-api/app-jwt/11.png)