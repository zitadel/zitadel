...
core_generate_all:
	...
	go install golang.org/x/tools/cmd/stringer@v0.22.0 && \
	go generate ./...
# Versions:
# https://pkg.go.dev/github.com/dmarkham/enumer?tab=versions
# https://pkg.go.dev/github.com/rakyll/statik?tab=versions
# https://pkg.go.dev/go.uber.org/mock/mockgen?tab=versions
...
# https://pkg.go.dev/github.com/grpc-ecosystem/grpc-gateway/v2/protoc-gen-grpc-gateway?tab=versions
# https://pkg.go.dev/github.com/grpc-ecosystem/grpc-gateway/v2/protoc-gen-openapiv2?tab=versions
# https://pkg.go.dev/github.com/envoyproxy/protoc-gen-validate?tab=versions
# https://pkg.go.dev/github.com/bufbuild/buf/cmd/buf?tab=versions
