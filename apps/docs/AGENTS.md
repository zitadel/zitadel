...
|------|--------|---------------|
| `content/v*/` | Fetched from git tags via `scripts/fetch-remote-content.mjs` | Update `content/versions.json` and re-run the generate target |
| `content/versions.json` | Generated by fetch script | Do not edit manually |
| `content/reference/api/` | Generated from proto definitions | Run `pnpm nx run @zitadel/docs:generate` after proto changes |
| `content/reference/api-v1/` | Generated from proto definitions | Run `pnpm nx run @zitadel/docs:generate` after proto changes |
| `openapi/` | Generated from proto definitions | Run `pnpm nx run @zitadel/docs:generate` after proto changes |
