...
- **Terminology**: For user-facing naming changes in docs/UI/API descriptions, follow `.github/TERMINOLOGY.md` (issue #5888 source). Copilot code review will flag discouraged terms automatically on PRs touching these paths.
