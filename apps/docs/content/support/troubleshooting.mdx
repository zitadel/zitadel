...
description: "A-00001: User agent mismatch issues occur with ZITADEL login due to SameSite strict enforcement on iPhone devices running specific Safari settings"
