...
<table>
  ...
  <tr>
    <td>
      <a href="./advisory/a10017">A-10017</a>
    </td>
    <td>OIDC web keys required for v4 upgrades</td>
    <td>Breaking Behavior Change</td>
    <td>
      Upgrading to v4 without previously enabling OIDC web keys can invalidate
      existing JWTs. Stage through v3.4.1+ and soak before moving to v4.
    </td>
    <td>&gt;= v4.0.0</td>
    <td>2026-07-15</td>
  </tr>
