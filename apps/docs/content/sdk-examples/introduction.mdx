...
---
 main:docs/docs/sdk-examples/introduction.mdx
...
To further streamline your setup, simply visit the management console in Zitadel where you can select one of the languages or frameworks. This will allow you to instantly set up the configuration for that specific sample in Zitadel, ensuring you have everything you need to get started right away. main:docs/docs/sdk-examples/introduction.mdx
