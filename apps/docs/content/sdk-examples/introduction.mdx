...
To further streamline your setup, simply visit the management console in Zitadel where you can select one of the languages or frameworks. This will allow you to instantly set up the configuration for that specific sample in Zitadel, ensuring you have everything you need to get started right away.

![](../../public/img/sdk-examples/console.png)

To begin configuring login for any of these samples, start [here](/guides/manage/console/overview).
