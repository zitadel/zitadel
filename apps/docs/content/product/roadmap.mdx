...
<details>
    ...
    <details>
        ...
        Administrators can define [groups](/concepts/structure/groups) within an organization, assign users to these groups,
        receive group memberships in tokens through the `groups` scope, and grant project roles to groups.
