...
<table id="zitadel-versions">
    ...
    <tbody>
        ...
        <tr>
            <th scope="row">[v4.x](/product/roadmap#v-4-x)</th>
            <td colSpan={3}></td>
            <td colSpan={3} class="release-impl">Implementation</td>
            <td class="release-rc">RC</td>
            <td colspan={5} class="release-stable">GA / Stable </td>
        ...
        <tr>
            <th scope="row">[v5.x](/product/roadmap#v5x)</th> main:docs/docs/product/roadmap.mdx
...
<table id="zitadel-versions">
    ...
    <tbody>
        ...
        <tr>
            <td scope="row">
                [v2.x](/product/roadmap#v-2-x)
            </td>
            <td scope="row">
                [v3.x](/product/roadmap#v-3-x)
                <ul>
                    <li>
                        Actions V2
                    </li>
            ...
            <td scope="row">
                [v5.x](/product/roadmap#v5x) main:docs/docs/product/roadmap.mdx
                <div>Release: TBC</div>
                <ul>
                    <li>Analytics</li>
                    <li>User Groups</li>
