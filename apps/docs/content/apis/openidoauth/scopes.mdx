...
description: "Request specific information from ZITADEL using standard and reserved scopes to customize authentication and authorization flows precisely"
