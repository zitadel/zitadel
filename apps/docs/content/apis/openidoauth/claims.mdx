...
| phone              | `+41 79 XXX XX XX`                                             | Phone number provided by the User (Human)                                                                                                                                          |
...
| sid                | `291693710356251044`                                           | String identifier for a session. This represents a session of a User (Human) agent for a logged-in end-User. Different sid values are used to identify distinct sessions at an OP. |
