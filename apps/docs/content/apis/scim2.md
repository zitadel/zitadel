...
For detailed instructions on authenticating with the SCIM interface, refer to the [Authenticate Service Users Guide](/docs/guides/integrate/service-users/authenticate-service-users).
...
- **[Zitadel SCIM Documentation](/docs/guides/manage/user/scim2)**: Documentation of Zitadel's SCIM implementation, including configuration details and known limitations.
