---
title: Usage Control
description: "Limit usage of self-hosted ZITADEL instances by blocking requests, restricting audit trails, or setting quotas on authenticated requests and action run seconds"
