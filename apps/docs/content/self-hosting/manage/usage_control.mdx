...
Requests to paths with the prefix */ui/login* return a redirect with HTTP status *302 Found* to */ui/console*, where the User (Human) is guided to *InstanceManagementURL*.
