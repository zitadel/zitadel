...
import DockerComposeYaml from './compose.yaml';
...
wget https://raw.githubusercontent.com/zitadel/zitadel/main/apps/docs/content/self-hosting/manage/configure/compose.yaml
