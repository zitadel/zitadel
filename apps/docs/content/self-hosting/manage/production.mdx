...
ZITADEL uses a [CQRS architecture](/concepts/architecture/software), which results in concurrent read and writes against this table.
...
keeping the eventstore reads performant. PostgreSQL uses [routined vacuum](https://www.postgresql.org/docs/current/routine-vacuuming.html)
...
solving the problem of the routing intervals going to infinite.
