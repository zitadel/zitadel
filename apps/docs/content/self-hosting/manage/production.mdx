...
We strongly advise implementing [rate limiting](/self-hosting/manage/usage_control) and bot detection. Even with robust cryptography, reducing request volume helps protect against brute-force and denial-of-service attacks.
