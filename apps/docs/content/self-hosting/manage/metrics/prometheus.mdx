...
- The metric exporter is set to `prometheus` in your [Instrumentation](/self-hosting/manage/instrumentation#metrics) configuration. If you explicitly disabled metrics in your configuration, re-enable them before proceeding.
