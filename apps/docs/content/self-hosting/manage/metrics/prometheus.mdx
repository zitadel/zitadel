---
title: Prometheus
description: "Configure Prometheus to scrape ZITADEL metrics using Kubernetes autodiscovery, ServiceMonitor with Prometheus Operator or standalone setup for monitoring"
---
