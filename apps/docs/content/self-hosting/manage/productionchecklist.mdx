...
description: "Implement a comprehensive production checklist for self-hosted ZITADEL instances covering infrastructure, security, and monitoring best practices"
