...
- [ ] Use a Layer 7 Web Application Firewall to secure ZITADEL that supports **[HTTP/2](/self-hosting/manage/http2)**
  ...
  - [ ] Implement rate limiting for specific endpoints (e.g. API vs frontend) to protect against brute-force and denial-of-service attacks. See the [ZITADEL Cloud rate limits](/legal/policies/rate-limit-policy) for reference.
