...
Use an appropriate monitoring solution to have an overview about your ZITADEL instance. Refer to [Instrumentation](/self-hosting/manage/instrumentation) for the full configuration reference. In particular, you may want to watch out for things like:
