...
export const Commands = ({mode, name, lower, configfilename}) => {
    ...
    const code = [
        ...
        'export ZITADEL_CONFIG_FILES=https://raw.githubusercontent.com/zitadel/zitadel/main/docs/self-hosting/manage/reverseproxy',
...
<details open>
    ...
    <DynamicCodeBlock lang={props.lower === 'nginx' ? 'nginx' : props.lower === 'httpd' ? 'apache' : props.lower === 'caddy' ? 'caddyfile' : 'yaml'} code={props.configfilecontent} />
</details>
