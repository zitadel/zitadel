...
<details>
    ...
    <ol>
        ...
        <li><a href="../../self-hosting/manage/login-client#create-login-client">Manually create a login application personal access token (PAT) for the now running v2 login</a>.</li>
