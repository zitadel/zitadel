...
```
With k3d, edit `ExternalPort: 80` → `ExternalPort: 8080` in the downloaded `quickstart-values.yaml`, then use `http://localhost:8080/ui/console`.
</Callout>
...
That's it. Visit [http://localhost/ui/console](http://localhost/ui/console) to open the console.
