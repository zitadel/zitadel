...
```bash
ZITADEL_DATABASE_POSTGRES_DSN="postgresql://root:postgres@localhost:5432/zitadel?sslmode=disable" ZITADEL_EXTERNALSECURE=false zitadel start-from-init --masterkey "MasterkeyNeedsToHave32Characters" --tlsMode disabled
```
