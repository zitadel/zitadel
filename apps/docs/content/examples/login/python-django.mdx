...
![](../../../public/img/django/project-settings.png)
...
![](../../../public/img/django/project-roles.png)

Finally, we can assign the roles to users in the project's authorizations tab.

![](../../../public/img/django/project-authorizations.png)
...
![](../../../public/img/django/app-create.png)
...
![](../../../public/img/django/app-auth-method.png)
...
![](../../../public/img/django/app-redirects.png)
