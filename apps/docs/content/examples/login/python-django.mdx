...
![Project settings in console](../../../public/img/django/project-settings.png)
...
![Project roles in console](../../../public/img/django/project-roles.png)

Finally, we can assign the roles to users in the project's authorizations tab.

![Project authorizations in console](../../../public/img/django/project-authorizations.png)
...
We use [Authorization Code](/docs/apis/openidoauth/grant-types#authorization-code) for our Django application.

![Create app in console](../../../public/img/django/app-create.png)
...
![Configure app authentication method in console](../../../public/img/django/app-auth-method.png)
...
![Configure app redirects console](../../../public/img/django/app-redirects.png)
