...
![Project settings in management console](../../../public/img/django/project-settings.png) main:docs/docs/examples/login/python-django.mdx
...
![Project roles in management console](../../../public/img/django/project-roles.png)

Finally, we can assign the roles to users in the project's authorizations tab.

![Project authorizations in management console](../../../public/img/django/project-authorizations.png) main:docs/docs/examples/login/python-django.mdx
...
![Create app in management console](../../../public/img/django/app-create.png)
...
![Configure app authentication method in management console](../../../public/img/django/app-auth-method.png) main:docs/docs/examples/login/python-django.mdx
...
![Configure app redirects management console](../../../public/img/django/app-redirects.png) main:docs/docs/examples/login/python-django.mdx
