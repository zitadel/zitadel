...
description: "Configure Django to use ZITADEL as an OIDC provider for authentication and role mapping with mozilla-django-oidc library"
...
![Project settings in management console](../../../public/img/django/project-settings.png)
...
![Project authorizations in management console](../../../public/img/django/project-authorizations.png)
...
![Configure app authentication method in management console](../../../public/img/django/app-auth-method.png)
...
![Configure app redirects management console](../../../public/img/django/app-redirects.png)
