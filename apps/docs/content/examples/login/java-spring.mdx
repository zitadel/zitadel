...
description: "Integrate ZITADEL with Java Spring Boot to enable secure user login and fetch profile data using OIDC"
...
![Create app in management console - set auth method](../../../public/img/java-spring/app-create-auth.png)
...
![Create app in management console - set redirectURI](../../../public/img/java-spring/app-create-redirect.png)
...
![Create app in management console - copy client_id](../../../public/img/java-spring/app-create-clientid.png)
