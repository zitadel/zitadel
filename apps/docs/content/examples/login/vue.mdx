...
![Create app in management console](../../../public/img/vue/app-create.png) main:docs/docs/examples/login/vue.mdx
...
![App in management console](../../../public/img/vue/app-screen.png) main:docs/docs/examples/login/vue.mdx
