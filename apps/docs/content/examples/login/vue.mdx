...
![Create app in management console](../../../public/img/vue/app-create.png)
...
![](../../../public/img/vue/tick-refresh-token.png)

## Create a project role "admin" and assign it to your user

Also note the projects ID, as you will need it to configure your Vue application.

![](../../../public/img/vue/project-role.png)

![](../../../public/img/vue/project-authz.png)
...
![App in management console](../../../public/img/vue/app-screen.png)
