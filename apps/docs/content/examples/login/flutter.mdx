---
title: Flutter Web Application Login with ZITADEL
description: Learn how to integrate ZITADEL authentication into a Flutter web app.
sidebar_label: Flutter Web App
