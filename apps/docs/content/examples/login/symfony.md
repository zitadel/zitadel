...
![Project settings in console](../../../public/img/symfony/project-settings.png)
...
![Project roles in console](../../../public/img/symfony/project-roles.png)

Finally, we can assign the roles to users in the project's authorizations tab.

![Project authorizations in console](../../../public/img/symfony/project-authorizations.png)
...
![Create app in console](../../../public/img/symfony/app-create.png)
...
![Configure app authentication method in console](../../../public/img/symfony/app-auth-method.png)
...
![Configure app redirects console](../../../public/img/symfony/app-redirects.png)
...
Now that you have enabled authentication, it's time for you to add more authorizations to your application using ZITADEL APIs. To do this, you can refer to the [docs](/docs/apis/introduction) or check out the ZITADEL Console code on [GitHub](https://github.com/zitadel/zitadel) which uses gRPC and OpenAPI to access data.
