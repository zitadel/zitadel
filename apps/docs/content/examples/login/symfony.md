...
![Project settings in management console](../../../public/img/symfony/project-settings.png) main:docs/docs/examples/login/symfony.md
...
![Project roles in management console](../../../public/img/symfony/project-roles.png)

Finally, we can assign the roles to users in the project's authorizations tab.

![Project authorizations in management console](../../../public/img/symfony/project-authorizations.png) main:docs/docs/examples/login/symfony.md
...
![Create app in management console](../../../public/img/symfony/app-create.png)
...
![Configure app authentication method in management console](../../../public/img/symfony/app-auth-method.png) main:docs/docs/examples/login/symfony.md
...
![Configure app redirects management console](../../../public/img/symfony/app-redirects.png) main:docs/docs/examples/login/symfony.md
...
See [User Constraints](/guides/manage/console/users-overview#considerations) for more details. main:docs/docs/examples/login/symfony.md
