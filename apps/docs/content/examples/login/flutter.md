...
![Create app in console](../../../public/img/flutter/nativeapp.png)
...
<div style={{display: 'grid', 'gridColumnGap': '1rem', 'gridTemplateColumns': '1fr 1fr', 'maxWidth': '500px', 'margin': '0 auto'}}>
    <img src="../../../public/img/flutter/not-authed.png" alt="Unauthenticated" height="500px" />
    <img src="../../../public/img/flutter/authed.png" alt="Flutter Authenticated" height="500px" />
</div>

<div style={{display: 'grid', 'gridColumnGap': '1rem', 'gridTemplateColumns': '1fr 1fr', 'maxWidth': '800px', 'margin': '0 auto'}}>
    <img src="../../../public/img/flutter/web-not-authed.png" alt="Unauthenticated" height="500px" />
    <img src="../../../public/img/flutter/web-authed.png" alt="Flutter Authenticated" height="500px" />
</div>
