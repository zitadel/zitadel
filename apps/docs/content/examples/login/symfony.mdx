...
description: "Integrate ZITADEL into a Symfony PHP application to enable secure login and fetch user data using OIDC protocol standards"
...
![Project settings in management console](../../../public/img/symfony/project-settings.png)
...
![Project role assignments in management console](../../../public/img/symfony/project-authorizations.png)
...
![Configure app authentication method in management console](../../../public/img/symfony/app-auth-method.png)
...
![Configure app redirects management console](../../../public/img/symfony/app-redirects.png)
