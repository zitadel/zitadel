...
description: "Integrate ZITADEL with Angular apps using OIDC and PKCE for secure login functionality and user profile access"
...
![Create app in management console](../../../public/img/angular/app-create.png)
...
![App in management console](../../../public/img/angular/app-screen.png)
