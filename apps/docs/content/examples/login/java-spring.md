...
![Create app in management console](../../../public/img/java-spring/app-create.png)
...
![Create app in management console - set auth method](../../../public/img/java-spring/app-create-auth.png) main:docs/docs/examples/login/java-spring.md
...
![Create app in management console - set redirectURI](../../../public/img/java-spring/app-create-redirect.png) main:docs/docs/examples/login/java-spring.md
...
![Create app in management console - copy client_id](../../../public/img/java-spring/app-create-clientid.png) main:docs/docs/examples/login/java-spring.md
