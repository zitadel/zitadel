...
description: "Integrate ZITADEL with your React application to enable secure user login and fetch user profile data using OIDC"
sidebar_label: React
---
...
![Create app in management console](../../../public/img/react/app-create.png)
...
![App in management console](../../../public/img/react/app-screen.png)
