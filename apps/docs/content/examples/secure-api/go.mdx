...
description: "Secure a Go API using OAuth 2 Token Introspection with ZITADEL for protected endpoints and role-based authorization"
sidebar_label: Go
---
...
### Create service account and personal access token (PAT)
...
![Created authorization in management console](../../../public/img/go/api-project-auth.png)
