...
![Create api key in management console](../../../public/img/java-spring/api-create-clientid-secret.png) main:docs/docs/examples/secure-api/java-spring.md
...
![Create project role in management console](../../../public/img/java-spring/api-project-role.png) main:docs/docs/examples/secure-api/java-spring.md
...
![Created authorization in management console](../../../public/img/java-spring/api-project-auth.png) main:docs/docs/examples/secure-api/java-spring.md
