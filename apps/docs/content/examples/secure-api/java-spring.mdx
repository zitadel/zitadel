...
description: "Secure your Java Spring Boot API using OAuth 2 Token Introspection with ZITADEL for authorized access control"
...
![Created authorization in management console](../../../public/img/java-spring/api-project-auth.png)
