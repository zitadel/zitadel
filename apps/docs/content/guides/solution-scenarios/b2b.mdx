...
In ZITADEL an [organization](/guides/manage/console/organizations-overview) can represent a business partner or partner who typically has its own branding and has different access settings like an additional federated login for its users. main:docs/docs/guides/solution-scenarios/b2b.mdx
...
Settings to the branding or the login options of the organization can be made from the organization section in [Console](/guides/manage/console/console-overview). main:docs/docs/guides/solution-scenarios/b2b.mdx
