...
description: "Implement multi-tenancy authentication and authorization using ZITADEL for B2B scenarios with custom organization branding and access settings"
sidebar_label: B2B
---
