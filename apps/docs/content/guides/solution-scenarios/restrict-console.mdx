...
ZITADEL includes a management console that allows Managers to configure all resources. All uses, including end-users, by default, view and manage their profile information.
...
With this workaround, you will limit users from accessing the [default-project](/guides/manage/console/projects-overview#the-default-project) if they are not explicitly granted to use this project. main:docs/docs/guides/solution-scenarios/restrict-console.mdx
...
Start by granting the organization of your managers, that should be able to access the Management Console, the [default project](/guides/manage/console/projects-overview#the-default-project): main:docs/docs/guides/solution-scenarios/restrict-console.mdx
...
![Default Project](../../../public/img/guides/solution-scenarios/console-default-project.png) main:docs/docs/guides/solution-scenarios/restrict-console.mdx

You need to use the [update project API call](/reference/api/management/zitadel.management.v1.ManagementService.UpdateProject) to set the configuration on the project.
...
More detailed information about creating a PAT and administrator roles you can find [here](/guides/integrate/service-users/personal-access-token) main:docs/docs/guides/solution-scenarios/restrict-console.mdx
