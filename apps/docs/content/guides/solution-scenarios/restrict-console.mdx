...
Start by granting the organization of your managers, that should be able to access the Console, the [default project](/guides/manage/console/projects-overview#the-default-project):
...
To avoid accidental lock-out, the [default project](/guides/manage/console/projects-overview#the-default-project) hides the checkbox "Check Project on Authentication" in the Console:
![Default Project](../../../public/img/guides/solution-scenarios/console-default-project.png)

You need to use the [update project API call](/reference/api-v1/management/zitadel.management.v1.ManagementService.UpdateProject) to set the configuration on the project.
...
More detailed information about creating a PAT and manager roles you can find [here](/guides/integrate/service-users/personal-access-token)
