...
5. Add the import_user as [manager](/guides/manage/console/managers) with the role "instance Owner"
...
3. Create a [personal access token](/guides/integrate/service-users/personal-access-token)
4. Go to the Default settings
5. Add the export_user as [manager](/guides/manage/console/managers) with the role "instance Owner"
