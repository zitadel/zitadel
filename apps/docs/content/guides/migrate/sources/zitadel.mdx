...
5. Add the import_user as [manager](/guides/manage/console/administrators) with the role "IAM Owner"
...
3. Create a [personal access token](/guides/integrate/service-accounts/personal-access-token)
4. Go to the Default settings
5. Add the export_user as [manager](/guides/manage/console/administrators) with the role "IAM Owner"
