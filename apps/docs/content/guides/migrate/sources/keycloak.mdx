...
**Reference:** [Service Users & API Authentication](https://zitadel.com/docs/guides/integrate/service-accounts/authenticate-service-accounts#authentication-methods)

---

### 5.2. Import Data with the ZITADEL API

Use your **access token** or **PAT** to authenticate, then call the [Management API – User (Human) Import](/reference/api/management/zitadel.management.v1.ManagementService.ImportHumanUser) endpoint.
