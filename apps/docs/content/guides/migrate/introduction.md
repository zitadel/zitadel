...
Multi-tenancy in ZITADEL can be achieved through either [Instances](/concepts/structure/instance) or [Organizations](/concepts/structure/instance) or [Organizations](/guides/manage/console/organizations-overview). main:docs/docs/guides/migrate/introduction.md
...
Projects can be granted to [Organization](/guides/manage/console/organizations-overview#organization-grants) or even to individual users. main:docs/docs/guides/migrate/introduction.md
...
Delegated access management is a great way of keeping the management overhead low and enabling [self-service](/concepts/features/selfservice#managers-in-delegation) for Organizations to manage their own Settings and Authorizations.

## Actions

ZITADEL [Actions](/guides/manage/console/actions-overview) is the key feature to customize and create workflows and change the default behavior of the platform. main:docs/docs/guides/migrate/introduction.md
...
Metadata can be access directly with the correct [scopes](/apis/openidoauth/scopes#reserved-scopes) or transformed to custom claims (see above).
...
- Create a pre-authentication [Action](/guides/manage/console/actions-overview) to request user data from the legacy system and create a new user in ZITADEL. main:docs/docs/guides/migrate/introduction.md
