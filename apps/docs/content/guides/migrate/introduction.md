...
Multi-tenancy in ZITADEL can be achieved through either [Instances](/concepts/structure/instance) or [Organizations](/guides/manage/console/organizations-overview).
...
Projects can be granted to [Organization](/guides/manage/console/organizations-overview#organization-grants) or even to individual users.
