...
[Add Passkey Registration ](/apis/resources/mgmt) main:docs/docs/guides/manage/user/reg-create-user.md
...
[Send Passkey Registration ](/apis/resources/mgmt) main:docs/docs/guides/manage/user/reg-create-user.md
