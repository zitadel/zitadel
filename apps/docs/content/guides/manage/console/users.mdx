...
A User (Human) has an email address and a password, and can additionally save information about phone, nickname, gender, language.
...
A User (Human) can authenticate itself with his password, add multiple factors for additional security, and enable passkey authentication.
