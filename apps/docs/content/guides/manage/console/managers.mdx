...
In the right part of the management console you can find **MANAGERS** in the details part. Here you have a list of the current managers and can add a new one. main:docs/docs/guides/manage/console/managers.mdx
