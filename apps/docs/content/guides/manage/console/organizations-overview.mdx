...
Each organization has its own pool of users, covering both User (Human) and service users. How these users authenticate depends on your domain configuration.
