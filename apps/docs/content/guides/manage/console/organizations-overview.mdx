...
Each organization has its own pool of users, covering both users (humans) and service accounts. How these users authenticate depends on your domain configuration.
