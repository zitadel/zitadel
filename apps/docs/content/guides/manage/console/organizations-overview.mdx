...
![Overview ZITADEL Organizations](../../../../public/img/concepts/objects/organization.png) main:docs/docs/guides/manage/console/organizations-overview.mdx

## Structure and Delegation

### Projects within Organizations
You can use **Projects** within your organization to manage the security context of closely related components, such as roles, grants, and authorizations for multiple clients. You can set up multiple projects within a single organization.
...
![Organization Grant](../../../../public/img/concepts/objects/organization_grants.png) main:docs/docs/guides/manage/console/organizations-overview.mdx

## Managing Organizations

### Create a new organization

To create a new organization, click on the organizations dropdown in the Management Console and select **New organization**. main:docs/docs/guides/manage/console/organizations-overview.mdx
...
When no specific organization is selected (e.g., during an auth request or via [Domain Discovery](/guides/solution-scenarios/domain-discovery)), users are directed to this default organization for login and self-registration. main:docs/docs/guides/manage/console/organizations-overview.mdx

## Usernames and Domains

Each organization has its own pool of users, covering both human and service users. How these users authenticate depends on your domain configuration.
...
::: main:docs/docs/guides/manage/console/organizations-overview.mdx

### Primary Domain
An organization can have multiple domain names, but only one is **Primary**. The primary domain determines:
...
:::caution
Setting a Primary Domain affects users.
...
If the **validate org domains** setting in [Domain Settings](./default-settings#domain-settings) is set to `true`, you must prove ownership of your domain via DNS or HTTP challenge.
...
This value is a [reserved scope](/apis/openidoauth/scopes#reserved-scopes) within ZITADEL. main:docs/docs/guides/manage/console/organizations-overview.mdx
