...
sidebar_position: 4
---
 main:docs/docs/guides/manage/console/projects-overview.mdx
import ProjectDescription from "../../../concepts/structure/_project_description.mdx";

## What is a project?

<ProjectDescription name="ProjectDescription" /> main:docs/docs/guides/manage/console/projects-overview.mdx
...
![POS Project](../../../../public/img/guides/console/posproject.png) main:docs/docs/guides/manage/console/projects-overview.mdx
...
* **Group:** Enables better handling in the ZITADEL Management Console (e.g., giving a user all roles of a specific group). main:docs/docs/guides/manage/console/projects-overview.mdx
...
![Default Project](../../../../public/img/guides/solution-scenarios/console-default-project.png) main:docs/docs/guides/manage/console/projects-overview.mdx
