---
title: Users
description: "Manage different user types in ZITADEL to control authentication and authorization across various scenarios and organizations effectively always"
sidebar_label: Users
sidebar_position: 3
---
