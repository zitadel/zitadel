...
<img src="../../../../public/img/guides/console/usersmenu.png" width="420px" alt="User types" />
...
### Managers
Any user—whether Human or Service User—can be assigned a [Manager Role](/docs/concepts/structure/managers).
A user with a manager role is not just an end-user of your application but also has permissions to manage specific aspects of the ZITADEL instance, organization, or project (e.g., `ORG_OWNER`, `PROJECT_OWNER`).
...
<img
  width="460px"
  src="../../../../public/img/guides/console/usermetadata.png"
  alt="User Metadata"
/>
...
<img
  src="../../../../public/img/guides/console/appidtokensettings.png"
  width="650px"
...
- [Manage users in the Console](./users-overview#managing-users)
- [Migrate to ZITADEL](/docs/guides/migrate/introduction)
