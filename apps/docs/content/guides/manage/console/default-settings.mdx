...
Branding settings applied on you instance act as a default for all your organizations. If you need custom branding on a organization take a look at our guide under [organization setting](./organizations#branding). main:docs/docs/guides/manage/console/default-settings.mdx
