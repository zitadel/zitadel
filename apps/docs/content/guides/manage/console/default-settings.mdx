...
<img
  src="../../../../public/img/guides/console/instancebutton.png"
  alt="Instance Button"
  width="450px"
/>
...
- [**Login Behavior and Access**](#login-behavior-and-access): Multifactor Authentication Options and Enforcement, Define whether passkeys are allowed or not, Set Login Lifetimes and advanced behavior for the login interface.
...
<img
  src="../../../../public/img/console_feature_settings.png"
  alt="Feature page"
  width="700px"
/>
...
Branding settings applied on you instance act as a default for all your organizations. If you need custom branding on a organization take a look at our guide under [branding](/docs/guides/manage/customize/branding).
...
<img
  src="../../../../public/img/guides/console/notification.png"
  alt="Notification"
  width="400px"
/>
...
<img src="../../../../public/img/guides/console/smtp.png" alt="SMTP" width="800px" />

While you create/update a SMTP provider you have the chance to test your SMTP configuration

<img src="../../../../public/img/guides/console/smtp_test.png" alt="SMTP" width="800px" />
...
<img src="../../../../public/img/guides/console/smtp_table.png" alt="SMTP" width="800px" />
...
<img src="../../../../public/img/guides/console/twilio.png" alt="Twilio" />
...
| Domain discovery allowed         | If this setting is enabled, the user doesn't have to exist when entering the username. It is required to have verified domains on the organization. Example: ZITADEL is registered as organization with the domain zitadel.com and Entra ID as identity provider. A user enters john@zitadel.com in the login but the user doesn't exist. The domain can be mapped to the organization and therefore the user can be redirected to the Entra ID. |
...
<img
  src="../../../../public/img/guides/console/loginpolicy.png"
...
<img
  src="../../..//img/guides/solution-scenarios/console-default-redirect.png"
...
For a detailed guide about how to configure a new identity provider for identity brokering have a look at our [identity provider guides](/docs/guides/integrate/identity-providers/introduction).
...
<img
  src="../../../../public/img/guides/console/complexity.png"
...
<img
  src="../../../../public/img/guides/console/expiry.png"
...
<img src="../../../../public/img/guides/console/lockout.png" alt="Lockout" width="600px" />
...
More about how to verify a domain [here](/docs/guides/manage/console/organizations-overview#domain-verification-guide).
...
<img
  src="../../../../public/img/guides/console/external_links_1.png"
  alt="External Links"
  width="600px"
/>
...
<img
  src="../../../../public/img/guides/console/external_links_2.png"
  alt="Custom button"
  width="600px"
/>
...
<img
  src="../../../../public/img/guides/console/messagetexts.png"
  alt="Message texts"
  width="600px"
/>
...
<img
  src="../../../../public/img/guides/console/logintexts.png"
  alt="Login texts"
  width="600px"
/>
...
<img src="../../../../public/img/console_languages.png" alt="Languages" width="800px" />
...
<img
  src="../../../../public/img/guides/console/oidcsettings.png"
...
<img
  src="../../../../public/img/guides/console/secretappearance.png"
