...
This could for example be an **External Authentication** Flow, with a **Post Authentication** trigger.

<img src="/docs/img/guides/console/flow.png" alt="Flow" width="400px" />

Now whenever a user gets authenticated externally with an IDP, an action is triggered after the authentication itself.
