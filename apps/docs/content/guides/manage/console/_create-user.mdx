...
::: main:docs/docs/guides/manage/console/_create-user.mdx
...
<Tabs>
    <Tab value="human" label="Human User" default>
        ...
        - **Send an invitation E-Mail for authentication setup and E-Mail verification**: The user will receive an email and be able to setup an authentication method (e.g Password, Passkey, External SSO).
            ...
            - When using the [Zitadel Login V2](/guides/integrate/login/hosted-login#hosted-login-version-2) the user has the option to choose the authentication method (password, passkey, identity provider), based on the configuration of the organization main:docs/docs/guides/manage/console/_create-user.mdx
...
When logged in, a user can then manage the profile in the management console, adding a profile picture, external IDPs and Passkeys. main:docs/docs/guides/manage/console/_create-user.mdx
