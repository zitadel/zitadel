...
<Tabs groupId="create-user-types" defaultIndex={0} items={['Human User', 'Human User [deprecated]', 'Service Account']}>
    <Tab value="Human User">
    ...
    <Tab value="Human User [deprecated]">
...
You can prompt the user to add a second factor method too by checking the **Force MFA** toggle in [Login behaviour settings](/guides/manage/console/default-settings#login-behavior-and-security).
