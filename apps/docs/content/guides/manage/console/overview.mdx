...
The management console is used to configure global default settings and can be used by multiple Administrators.
Read more about [Console Administrators](./administrators) here.
...
If you're new to management console, you'll probably want to set some settings initially. Continue reading Default settings on the next page.
