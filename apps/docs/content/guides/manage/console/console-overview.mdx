...
sidebar_label: Management Console main:docs/docs/guides/manage/console/console-overview.mdx
---

## Overview

The ZITADEL Management Console is the web-based Dashboard UI designed to facilitate the management and administration of ZITADEL resources and configurations. It serves as a central hub where [Managers](/concepts/structure/managers) can perform tasks related to identity and access management, configure authentication methods, and manage the organization's infrastructure.
...
The management console is available by navigating to the [Custom Domain](/concepts/features/custom-domain) of your instance and appending the path `/ui/console`. main:docs/docs/guides/manage/console/console-overview.mdx
...
### Context Switcher
ZITADEL is a multi-tenant system. The Management Console features a **Context Switcher** in the **top-left** corner. This allows you to switch between the different **Organizations** you manage. main:docs/docs/guides/manage/console/console-overview.mdx
...
The Management Console enables administrators to perform the following critical tasks: main:docs/docs/guides/manage/console/console-overview.mdx
...
* [Administrator Roles Concept](/concepts/structure/managers) main:docs/docs/guides/manage/console/console-overview.mdx
