...
You would have to create roles for administration and your applications in this very project, and then create authorizations based on them.

![](../../../../public/img/guides/console/posproject.png)
...
| Setting                  | Description                                                                                                                                                                                                                |
|--------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Unspecified              | If nothing is specified the default will trigger. (System default settings)                                                                                                                                                |
