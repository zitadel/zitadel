...
Do not use it for production yet. To test it out, you need to enable the `UserSchema` [feature flag](/reference/api/feature).
</Callout>
...
We can do so by calling the [create user schema endpoint](/reference/api/user_schema/zitadel.resources.userschema.v3alpha.ZITADELUserSchemas.CreateUserSchema)
...
Finally, we call the [update user schema endpoint](/reference/api/user_schema/zitadel.resources.userschema.v3alpha.ZITADELUserSchemas.PatchUserSchema)
...
To check the state of existing schemas, you can simply [list them](/reference/api/user_schema/zitadel.resources.userschema.v3alpha.ZITADELUserSchemas.SearchUserSchemas).
...
The API also allows retrieving a single [schema by ID](/reference/api/user_schema/zitadel.resources.userschema.v3alpha.ZITADELUserSchemas.GetUserSchema).
