...
Users with the role IAM_OWNER can change the restrictions of their instance using the [Feature Restrictions Admin API](/reference/api/admin/zitadel.admin.v1.AdminService.GetRestrictions).
