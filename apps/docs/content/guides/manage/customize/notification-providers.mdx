...
<Tabs>
  ...
  First [add a new SMS Provider of type HTTP](/reference/api-v1/admin/zitadel.admin.v1.AdminService.AddSMSProviderHTTP) to create a new HTTP provider that can be used to send SMS messages:
  ...
  To use the HTTP provider you need to [activate the SMS provider](/reference/api-v1/admin/zitadel.admin.v1.AdminService.ActivateSMSProvider): 
  ...
  See full API reference for [SMS Providers](/reference/api-v1/admin/zitadel.admin.v1.AdminService.ListSMSProviders) for more details.

  </Tab>
  <Tab value="email" label="Email">

    First [add a new Email Provider of type HTTP](/reference/api-v1/admin/zitadel.admin.v1.AdminService.AddEmailProviderHTTP) to create a new HTTP provider that can be used to send Email messages:
  ...
  To use the HTTP provider you need to [activate the Email provider](/reference/api-v1/admin/zitadel.admin.v1.AdminService.ActivateEmailProvider):
  ...
  See full API reference for [Email Providers](/reference/api-v1/admin/zitadel.admin.v1.AdminService.ListEmailProviders) for more details.
