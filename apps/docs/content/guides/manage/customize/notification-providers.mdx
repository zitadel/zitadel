...
<Tabs>
  ...
  See full API reference for [SMS Providers](/category/apis/resources/admin/sms-provider) for more details. main:docs/docs/guides/manage/customize/notification-providers.mdx
