...
- [A service user](/guides/integrate/service-accounts/authenticate-service-accounts) with [enough authorization](/guides/manage/console/managers) to manage the desired resources
...
4. Add any resources to the organization in the `main.tf` file, [as an example a user (Human)](https://registry.terraform.io/providers/zitadel/zitadel/latest/docs/resources/human_user).
