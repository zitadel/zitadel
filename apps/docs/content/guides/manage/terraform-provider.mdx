...
4. Add any resources to the organization in the `main.tf` file, [as example a User (Human)](https://registry.terraform.io/providers/zitadel/zitadel/latest/docs/resources/human_user).
