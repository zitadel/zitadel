...
If you are federating an [external Identity Provider (IdP)](/guides/integrate/identity-providers/introduction) that sits behind a firewall:
...
For custom [Notification Providers](/guides/manage/customize/notification-providers):
