...
description: "Allowlist static egress IP addresses for ZITADEL Cloud regions to enable secure connections with internal infrastructure and external providers"
---
