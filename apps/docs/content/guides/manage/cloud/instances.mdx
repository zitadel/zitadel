...
::: main:docs/docs/guides/manage/cloud/instances.md
...
![Add Custom Domain](../../../../public/img/manuals/portal/customer_portal_add_domain.png) main:docs/docs/guides/manage/cloud/instances.md
