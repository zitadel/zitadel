...
<FrameworkSelector>
    ...
    <Tab value="Vue.js">
        <AppConfig
            redirectUrl="http://localhost:5173/auth/signin/zitadel"
...
<FrameworkSelector>
    ...
    <Tab value="Vue.js">
        <AppValues valueCount="three" clientSecret={false} projectID={true}></AppValues>
    </Tab>
</FrameworkSelector>
...
<FrameworkSelector>
    <Tab value="Angular">
        ```bash
        git clone [https://github.com/zitadel/example-auth-angular.git](https://github.com/zitadel/example-auth-angular.git)
        cd example-auth-angular
        ```
    </Tab>
    <Tab value="Flutter">
        ```bash
        git clone [https://github.com/zitadel/zitadel_flutter.git](https://github.com/zitadel/zitadel_flutter.git)
        cd zitadel_flutter
        ```
    </Tab>
    <Tab value="Go">
        ```bash
        git clone [https://github.com/zitadel/zitadel-go.git](https://github.com/zitadel/zitadel-go.git)
        cd zitadel_go
        ```
    </Tab>
    <Tab value="Next.js">
    ...
    <Tab value="React">
        ```bash
        git clone [https://github.com/zitadel/zitadel-react.git](https://github.com/zitadel/zitadel-react.git)
        cd zitadel-react
        ```
    </Tab>
    <Tab value="Symfony">
        ```bash
        git clone [https://github.com/zitadel/example-auth-symfony.git](https://github.com/zitadel/example-auth-symfony.git)
        cd example-auth-symfony
        ```
    </Tab>
    <Tab value="Vue.js">
        ```bash
        git clone [https://github.com/zitadel/zitadel-vue.git](https://github.com/zitadel/zitadel-vue.git)
        cd zitadel-vue
        ```
    </Tab>
</FrameworkSelector>
...
<FrameworkSelector>
    ...
    <Tab value="React">
        ...
        authority: "[https://your-instance.zitadel.cloud](https://your-instance.zitadel.cloud)", // Your Issuer URL
    ...
    <Tab value="Symfony">
        ...
        1. Copy+past the .env.example to .env
        2. Update the ZITADEL_CLIENT_ID and ZITADEL_DOMAIN with the client id and issuer you collected in Step 5.
    ...
    <Tab value="Vue.js">
        ...
        VITE_ZITADEL_ISSUER=[https://your-instance.zitadel.cloud/](https://your-instance.zitadel.cloud/)
        ```
    </Tab>
</FrameworkSelector>
...
<FrameworkSelector>
    ...
    <Tab value="Symfony">
        ...
        ![Angular Example App](../../../public/img/guides/quickstart/symfony_example_app.png)
    </Tab>
    <Tab value="Vue.js">
        ```bash
        yarn install
