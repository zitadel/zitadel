...
//import { FrameworkSelector } from '@/component/framework-selector';
...
<Tabs items={['Angular', 'React', 'Vue']} groupId="framework-select">
    <Tab value="Angular">
        <AppConfig
            redirectUrl="http://localhost:3000/auth/callback"
            postLogoutRegirectUrl="http://localhost:3000/signedout">
        </AppConfig>
    </Tab>
    <Tab value="React">
        <AppConfig
            redirectUrl="http://localhost:3000/callback"
            postLogoutRegirectUrl="http://localhost:3000/">
        </AppConfig>
    </Tab>
    <Tab value="Vue">
        <AppConfig
            redirectUrl="http://localhost:5173/auth/signinwin/zitadel"
            postLogoutRegirectUrl="http://localhost:5173/">
        </AppConfig>
    </Tab>
</Tabs>
...
<Tabs items={['Angular', 'React', 'Vue']} groupId="framework-select">
    ...
    <Tab value="React">
        <AppValues valueCount="two" projectID={true}></AppValues>
    </Tab>
    <Tab value="Vue">
        <AppValues valueCount="two" projectID={false}></AppValues>
    </Tab>
...
<Tabs items={['Angular', 'React', 'Vue']} groupId="framework-select">
    <Tab value="Angular">
        ...
        ![React Example App](../../../public/img/guides/quickstart/angular_example_app.png)
    ...
    <Tab value="Vue">
        ...
        ![React Example App](../../../public/img/guides/quickstart/vue_example_app.png)
