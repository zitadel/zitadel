...
![Home Page](../../../public/img/guides/quickstart/v3_1.png)
...
![Registration Page](../../../public/img/guides/quickstart/v3_2.png)

3. Next, complete your details and click "Continue".

![Congratulations Page](../../../public/img/guides/quickstart/v3_3.png)
...
![Login](../../../public/img/guides/quickstart/v3_8.png)
...
![Create Instance](../../../public/img/guides/quickstart/create_instance.png)

2. Provide a name for your instance and click on the “Continue” button at the bottom of this screen.

![Create Instance Name](../../../public/img/guides/quickstart/create_instance_name.png)

3. Next, you should see the following screen. Add a username and password for the instance administrator and click "Create".

![Create Instance Admin](../../../public/img/guides/quickstart/create_instance_admin.png)
...
![Sign In Instance](../../../public/img/guides/quickstart/sign_in_instance.png)
...
![Instance Details](../../../public/img/guides/quickstart/instance_dashboard.png)
...
- We recommend using the [Authentication Code Flow](/apis/openidoauth/grant-types#authorization-code) with [Proof Key for Code Exchange (PKCE)](/apis/openidoauth/grant-types#authorization-code) for secure OIDC configuration. This setup includes specific App, Grant, and Response Types, as well as an Authentication Method. More about the different app types can be found [here](/guides/integrate/login/oidc/oauth-recommended-flows#different-client-profiles).
...
![Project Name and Framework/Language](../../../public/img/guides/quickstart/app_detail_overview_react.png)

### 5. Add users (optional)

[Skip optional steps](#8-obtain-client-id-and-oidc-endpoints-for-your-application) and jump directly to the obtain ClientId and OIDC endpoints.
...
![Add User](../../../public/img/guides/quickstart/26.png)
...
![Add User](../../../public/img/guides/quickstart/27.png)

3. The newly created user details will be displayed as shown below.

![User Info](../../../public/img/guides/quickstart/28.png)
...
![User Info](../../../public/img/guides/quickstart/29.png)
...
![Add Authorization](../../../public/img/guides/quickstart/31.png)

3. Next, select a project. Since we created only “Project1” so far, you will see just that. Go ahead and select it.

![Add Authorization](../../../public/img/guides/quickstart/32.png)

4. Let’s select the role “sales”. Click on “Save”.

![Add Authorization](../../../public/img/guides/quickstart/33.png)

5. Now you will see the users with their designated roles.

![Add Authorization](../../../public/img/guides/quickstart/34.png)
...
![Add Authorization](../../../public/img/guides/quickstart/35.png)
...
![Add Authorization](../../../public/img/guides/quickstart/37.png)
...
![Get URLs](../../../public/img/guides/quickstart/51.png)
...
![Get URLs](../../../public/img/guides/quickstart/52.png)
...
- project_resource_id (To add a ZITADEL project scope. `urn:zitadel:iam:org:project:id:[projectId]:aud` and `urn:zitadel:iam:org:projects:roles` [scopes](/apis/openidoauth/scopes#reserved-scopes).)
...
![Login](../../../public/img/guides/quickstart/login1.png)

4. You will be redirected to the ZITADEL login page. Add your username/email and click on “next”.

![Redirect](../../../public/img/guides/quickstart/login2.png)

5. Enter your password and click on “next”.

![Redirect](../../../public/img/guides/quickstart/login3.png)
