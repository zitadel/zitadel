...
description: Learn how to integrate OIDC PKCE authentication using ZITADEL in under 5 minutes.
...
<Tabs items={['Angular', 'Flutter', 'Go', 'Next.js', 'React', 'Vue.js']} groupId="framework-select">
    <Tab value="Angular">
        <AppConfig
...
<Tabs items={['Angular', 'Flutter', 'Go', 'Next.js', 'React', 'Vue']} groupId="framework-select">
    <Tab value="Angular">
        ```bash
        ng serve
        ```
