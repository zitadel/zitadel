...
![Get Client ID](../../../public/img/guides/quickstart/project_client_id.png)
...
1. **Login**: App redirects the User (Human) to ZITADEL with a PKCE challenge.
2. **Auth**: User (Human) authenticates on the ZITADEL hosted login page.
