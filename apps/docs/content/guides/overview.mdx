...
Follow our [quick start guide](/docs/guides/start/quickstart).
...
If you're unsure, consider the generous free tier of [ZITADEL Cloud](./manage/cloud/start).

Choose [ZITADEL Cloud](./manage/cloud/start) if you want:
...
Choose [ZITADEL self-hosted](/docs/self-hosting/deploy/overview) if you want:
...
Cloud and enterprise customers can additionally reach us privately via our [support communication channels](/docs/legal/service-description/support-services).
