...
:::info main:docs/docs/guides/integrate/token-exchange.mdx
...
```bash
curl -L -X PUT 'https://${CUSTOM_DOMAIN}/v2/features/instance' \
...
::: main:docs/docs/guides/integrate/token-exchange.mdx
