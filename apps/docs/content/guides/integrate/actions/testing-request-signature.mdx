...
import JWT from "./go/jwt.go"
import JWE from "./go/jwe.go"
import JSON from "./go/json.go"
import CodeBlock from '@/components/docusaurus/code-block';
import Tabs from "@theme/Tabs";
import TabItem from "@theme/TabItem";
import CodeBlock from '@theme/CodeBlock';
import JSON from "!!raw-loader!./go/json"
import JWT from "!!raw-loader!./go/jwt"
import JWE from "!!raw-loader!./go/jwe" main:docs/docs/guides/integrate/actions/testing-request-signature.mdx
...
::: main:docs/docs/guides/integrate/actions/testing-request-signature.mdx
...
See [Create a target](/apis/resources/action_service_v2/action-service-create-target) for more detailed information. main:docs/docs/guides/integrate/actions/testing-request-signature.mdx
...
```shell
curl -L -X POST 'https://${CUSTOM_DOMAIN}/v2/actions/targets' \ main:docs/docs/guides/integrate/actions/testing-request-signature.mdx
...
```shell
curl -L -X POST 'https://${CUSTOM_DOMAIN}/v2/actions/targets/<TargetID>/publickeys' \ main:docs/docs/guides/integrate/actions/testing-request-signature.mdx
-H 'Content-Type: application/json' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <TOKEN>' \
--data-raw '{
...
```shell
curl -L -X PUT 'https://${CUSTOM_DOMAIN}/v2/actions/targets/<TargetID>/publickeys/<KeyID>/activate' \ main:docs/docs/guides/integrate/actions/testing-request-signature.mdx
-H 'Content-Type: application/json' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <TOKEN>'
```
...
```shell
curl -L -X PUT 'https://${CUSTOM_DOMAIN}/v2/actions/executions' \ main:docs/docs/guides/integrate/actions/testing-request-signature.mdx
-H 'Content-Type: application/json' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <TOKEN>' \
--data-raw '{
...
<Tabs>
    <TabItem value="JSON">
        <CodeBlock language="go">{JSON}</CodeBlock>
    </TabItem>
    <TabItem value="JWT">
        <CodeBlock language="go">{JWT}</CodeBlock>
    </TabItem>
    <TabItem value="JWE">
        <CodeBlock language="go">{JWE}</CodeBlock>
    </TabItem>
</Tabs>
...
```shell
curl -L -X POST 'https://${CUSTOM_DOMAIN}/v2/users/new' \ main:docs/docs/guides/integrate/actions/testing-request-signature.mdx
-H 'Content-Type: application/json' \
-H 'Accept: application/json' \
-H 'Authorization: Bearer <TOKEN>' \
--data-raw '{
