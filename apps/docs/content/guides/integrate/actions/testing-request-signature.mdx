...
import JSONCode from "./go/json.go";
import JWTCode from "./go/jwt.go";
import JWECode from "./go/jwe.go";
...
<Tabs>
    <Tab value="JSON">
        <CodeBlock language="go">{JSONCode}</CodeBlock>
    </Tab>
    <Tab value="JWT">
        <CodeBlock language="go">{JWTCode}</CodeBlock>
    </Tab>
    <Tab value="JWE">
        <CodeBlock language="go">{JWECode}</CodeBlock>
    </Tab>
</Tabs>
...
by calling the ZITADEL API to create a User (Human).
