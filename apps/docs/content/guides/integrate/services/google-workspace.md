...
- Make sure that you [verify the same domain also in your ZITADEL organization and set it as primary domain](/guides/manage/console/organizations-overview#primary-domain) main:docs/docs/guides/integrate/services/google-workspace.md
