...
1. Press the "+" button right to "OpenID Connect"  
  ![Create new connection](../../../../public/img/oidc/auth0/auth0-create-app.png)
...
![initial connection configuration](../../../../public/img/oidc/auth0/auth0-init-app.png)
...
8. After you logged in you should see the following:
   ![full configuration](../../../../public/img/oidc/auth0/auth0-works.png)
