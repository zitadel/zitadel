...
1. As described you have to create a new provider, with a unique identifier:
   ![Create IDP Profile](../../../../public/img/saml/pingidentity/create_idp_profile.png)

We recommend activating signing the auth request whenever possible:
![Configure PingOne Connection](../../../../public/img/saml/pingidentity/conf_connection.png)
...
- Import certificate, provided from the certificate endpoint
  ![Configure IDP Connection](../../../../public/img/saml/pingidentity/conf_idp_connection.png)
...
![Identity Providers P1 Connection](../../../../public/img/saml/pingidentity/idp_p1_connection.png)
![Identity Providers IDP Configuration](../../../../public/img/saml/pingidentity/idp_idp_configuration.png)
