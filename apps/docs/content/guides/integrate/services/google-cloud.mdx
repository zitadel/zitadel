...
![Create application screen](../../../../public/img/guides/integrate/services/google-cloud-create-app.png)

## **ZITADEL**: Redirect url

![Redirect URL](../../../../public/img/guides/integrate/services/google-cloud-redirect-url.png)
...
![Token settings](../../../../public/img/guides/integrate/services/google-cloud-token-settings.png)
...
Claims can be transformed in ZITADEL with [Actions](/docs/guides/manage/console/actions-overview).
...
![Action Code](../../../../public/img/guides/integrate/services/google-cloud-action-code.png)
...
![Action Flow](../../../../public/img/guides/integrate/services/google-cloud-action-flow.png)
