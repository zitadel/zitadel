...
To register your login domain on your instance, [add](/apis/resources/admin/admin-service-add-instance-trusted-domain) your domain on your instances Trusted Domains. main:docs/docs/guides/integrate/login-ui/login-app.mdx
...
Also ensure your login domain is registered on your instance by adding it as a [Trusted Domain](/apis/resources/admin/admin-service-add-instance-trusted-domain). main:docs/docs/guides/integrate/login-ui/login-app.mdx
