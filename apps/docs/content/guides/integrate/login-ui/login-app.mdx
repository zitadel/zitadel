...
To register your login domain on your instance, [add](/reference/api-v1/admin/zitadel.admin.v1.AdminService.AddInstanceTrustedDomain) your domain on your instances trusted domains.
...
Also ensure your login domain is registered on your instance by adding it as a [trusted domain](/reference/api-v1/admin/zitadel.admin.v1.AdminService.AddInstanceTrustedDomain).
