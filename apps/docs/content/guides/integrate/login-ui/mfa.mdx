...
If the User (Human) already has a verified phone number you can skip this step.
...
When creating the session you can already start the sms challenge, this will only be executed if the User (Human) check was successful.
