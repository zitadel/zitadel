...
![Register and Login Flow](../../../../public/img/guides/login-ui/username-password-flow.png)
...
[Create User Documentation](/docs/reference/api/user/zitadel.user.v2.UserService.AddHumanUser)
...
- [Get Login Settings](/docs/reference/api/settings/zitadel.settings.v2.SettingsService.GetLoginSettings) To find out which authentication possibilities are enabled (password, identity provider, etc.)
- [Get Password Complexity Settings](/docs/reference/api/settings/zitadel.settings.v2.SettingsService.GetPasswordComplexitySettings) to find out how the password should look like (length, characters, etc.)
...
- [Create new session Documentation](/docs/reference/api/session/zitadel.session.v2.SessionService.CreateSession)
- [Update an existing session Documentation](/docs/reference/api/session/zitadel.session.v2.SessionService.SetSession)
- [Get Session Documentation](/docs/reference/api/session/zitadel.session.v2.SessionService.GetSession)
