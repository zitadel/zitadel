...
![OIDC Flow](../../../../public/img/guides/login-ui/oidc-flow.png)
...
Read more about the [Authorize Endpoint Documentation](/docs/apis/openidoauth/endpoints#authorization-endpoint)
