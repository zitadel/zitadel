...
![Passkey Registration](../../../../public/img/guides/login-ui/passkey-registration-flow.png)
...
More detailed information about the API: [Send Registration Link Documentation](/docs/reference/api/user/zitadel.user.v2.UserService.CreatePasskeyRegistrationLink)
...
More detailed information about the API: [Start Passkey Registration Documentation](/docs/reference/api/user/zitadel.user.v2.UserService.RegisterPasskey)
...
More detailed information about the API: [Verify Passkey Registration Documentation](/docs/reference/api/user/zitadel.user.v2.UserService.VerifyPasskeyRegistration)
...
![Passkey Login](../../../../public/img/guides/login-ui/passkey-login-flow.png)
...
More detailed information about the API: [Create Session Documentation](/docs/reference/api/session/zitadel.session.v2.SessionService.CreateSession)
