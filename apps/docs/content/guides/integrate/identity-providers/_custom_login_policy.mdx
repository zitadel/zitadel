...
- [Update Default Login Settings](/reference/api-v1/admin/zitadel.admin.v1.AdminService.UpdateLoginPolicy)
- [Update Organization Login Settings](/reference/api-v1/management/zitadel.management.v1.ManagementService.UpdateCustomLoginPolicy)
