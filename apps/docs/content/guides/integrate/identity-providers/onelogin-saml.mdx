...
![Activate OneLogin SAML provider in ZITADEL](../../../../public/img/guides/zitadel_activate_onelogin_saml.png)
...
![Image: OneLogin button on ZITADEL login](../../../../public/img/guides/zitadel_login_onelogin_button.png)
