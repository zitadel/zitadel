...
<Intro provider="OneLogin"/> main:docs/docs/guides/integrate/identity-providers/onelogin-saml.mdx
...
![Image: OneLogin Add Apps screen showing SAML connector selection](../../../../public/img/guides/onelogin-add-apps.png) main:docs/docs/guides/integrate/identity-providers/onelogin-saml.mdx
...
<IDPsOverview templates="SAML"/> main:docs/docs/guides/integrate/identity-providers/onelogin-saml.mdx
...
<GeneralConfigDescription provider_account="OneLogin" />

![SAML Provider](../../../../public/img/guides/zitadel_saml_create_provider.png) main:docs/docs/guides/integrate/identity-providers/onelogin-saml.mdx
...
![Image: OneLogin SAML configuration with ZITADEL URLs](../../../../public/img/guides/onelogin-configuration.png) main:docs/docs/guides/integrate/identity-providers/onelogin-saml.mdx
...
<CustomLoginPolicy/> main:docs/docs/guides/integrate/identity-providers/onelogin-saml.mdx
...
See the [Actions V2 Response Manipulation](/guides/integrate/actions/testing-response-manipulation.md) main:docs/docs/guides/integrate/identity-providers/onelogin-saml.mdx
...
<TestSetup loginscreen="your OneLogin login"/>

![Image: OneLogin button on ZITADEL login](../../../../public/img/guides/zitadel-login-onelogin-button.png) main:docs/docs/guides/integrate/identity-providers/onelogin-saml.mdx
