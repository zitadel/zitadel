...
- [Activate Default Identity Provider](/reference/api-v1/admin/zitadel.admin.v1.AdminService.AddIDPToLoginPolicy)
- [Activate Organization Identity Provider](/reference/api-v1/management/zitadel.management.v1.ManagementService.AddIDPToLoginPolicy)
