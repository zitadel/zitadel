...
<Intro provider="PingFederate"/> main:docs/docs/guides/integrate/identity-providers/pingfederate-saml.mdx
...
<IDPsOverview templates="SAML"/> main:docs/docs/guides/integrate/identity-providers/pingfederate-saml.mdx
...
![SAML Provider](../../../../public/img/guides/zitadel_saml_create_provider.png) main:docs/docs/guides/integrate/identity-providers/pingfederate-saml.mdx
...
<CustomLoginPolicy/> main:docs/docs/guides/integrate/identity-providers/pingfederate-saml.mdx
...
See the [Actions V2 Response Manipulation](/guides/integrate/actions/testing-response-manipulation.md) main:docs/docs/guides/integrate/identity-providers/pingfederate-saml.mdx
...
![Image: PingFederate button on ZITADEL login](../../../../public/img/guides/zitadel-login-pingfederate-button.png) main:docs/docs/guides/integrate/identity-providers/pingfederate-saml.mdx
