...
![Add new OIDC Client in Keycloak](../../../../public/img/guides/keycloak_add_client.png)
![Get Client Secret](../../../../public/img/guides/keycloak_client_secret.png)
...
![Keycloak Provider](../../../../public/img/guides/zitadel_keycloak_create_provider.png)

### Activate IdP

<Activate components={props.components} />

![Activate the Keycloak Provider](../../../../public/img/guides/zitadel_activate_keycloak.png)
...
![Keycloak Button](../../../../public/img/guides/zitadel_login_keycloak.png)

![Keycloak Login](../../../../public/img/guides/keycloak_login.png)
