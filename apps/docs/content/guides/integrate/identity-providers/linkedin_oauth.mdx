...
![Add new Application in LinkedIn](../../../../public/img/guides/linkedin_add_app.png)
...
![LinkedIn Provider](../../../../public/img/guides/zitadel_linkedin_create_provider.png)

### Activate IdP

<Activate components={props.components} />

![Activate the LinkedIn Provider](../../../../public/img/guides/zitadel_activate_linkedin.png)

## Test the setup

<TestSetup components={props.components}  loginscreen="your LinkedIn login"/>

![LinkedIn Button](../../../../public/img/guides/zitadel_login_linkedin.png)

![LinkedIn Login](../../../../public/img/guides/linkedin_login.png)
