...
<Intro provider="your OIDC Provider"/>

## Open the Generic OIDC Provider Template

<IDPsOverview templates="Generic OIDC"/> main:docs/docs/guides/integrate/identity-providers/generic-oidc.mdx
...
![Generic OIDC Provider](../../../../public/img/guides/zitadel_generic_oidc_create_provider.png) main:docs/docs/guides/integrate/identity-providers/generic-oidc.mdx
...
3. Create a new application or client and select "OIDC" or "OpenID Connect" as the type.
...
<GeneralConfigDescription provider_account="OIDC provider account" />
...
<TestSetup loginscreen="your OIDC provider login"/> main:docs/docs/guides/integrate/identity-providers/generic-oidc.mdx
