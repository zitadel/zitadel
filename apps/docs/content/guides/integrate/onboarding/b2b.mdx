...
Make sure that your admins have a [Administrator role](/guides/manage/console/managers) with permissions on an instance level such as "INSTANCE_OWNER" main:docs/docs/guides/integrate/onboarding/b2b.mdx
...
If you do want to know more about the roles check out the [ZITADEL Managers Guide with the Role List](/guides/manage/console/managers) main:docs/docs/guides/integrate/onboarding/b2b.mdx
