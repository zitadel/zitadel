...
<img
  src="../../../../public/img/guides/solution-scenarios/register-options.png"
...
<img
  src="../../../../public/img/guides/solution-scenarios/register-end-user.png"
...
<img
  src="../../../../public/img/guides/solution-scenarios/default-organization.png"
...
<img
  src="../../../../public/img/guides/solution-scenarios/register-local-user.png"
...
The [create user request](/docs/reference/api/user/zitadel.user.v2.UserService.AddHumanUser) also allows you to add [metadata](/docs/guides/manage/customize/user-metadata) (key, value) to the user.
