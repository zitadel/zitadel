...
Per default a User (Human) will be registered to the default organization.
By sending the scope below in your authorization request you can choose the organization to which the User (Human) will be added.
...
If an organization allows local user registration as well as registration with a social or enterprise login, the User (Human) can choose an option to register.

As soon as Users (Human) click the "register" button, they will be presented with a screen showing the different registration options.
...
After that, the User (Human) can select either local user registration or an external provider.
By pressing the button of an external provider, the User (Human) will directly be redirected to the provider for consent.
...
If nothing else is specified, a User (Human) will be registered to the default organization.
...
If the User (Human) chooses to register a local account, the register form will be shown.
