...
The System API can't be accessed by service users and requires special settings and authentication that can be found in our [guide to access ZITADEL's System API](./access-zitadel-system-api).
...
Follow the steps in this guide to [generate a key file](../service-accounts/private-key-jwt#2-register-a-private-key-for-your-service-user) and [create a JWT and sign with private key](../service-accounts/private-key-jwt#3-create-a-jwt-and-sign-it-with-your-private-key).
