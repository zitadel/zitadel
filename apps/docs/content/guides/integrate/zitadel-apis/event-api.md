...
You need to assign a user the [administrator role](/guides/manage/console/managers) IAM_OWNER_VIEWER or IAM_OWNER to access the Event API. main:docs/docs/guides/integrate/zitadel-apis/event-api.md
