---
title: Configure client credential authentication for service accounts
description: "Authenticate a service account with client credentials by requesting an access token for secure communication within ZITADEL"
