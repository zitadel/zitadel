---
title: Configure personal access token authentication for service accounts
description: "Obtain a Personal access token for service accounts in ZITADEL to authenticate API calls without interactive login flows securely"
