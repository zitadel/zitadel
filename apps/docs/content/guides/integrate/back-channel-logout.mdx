...
:::info main:docs/docs/guides/integrate/back-channel-logout.mdx
...
configuration, e.g. [creating an OIDC application](https://zitadel.com/docs/category/apis/resources/mgmt/management-service-add-oidc-app). main:docs/docs/guides/integrate/back-channel-logout.mdx
