...
![Authentication and Back-Channel Logout Flow](../../../public/img/guides/back-channel-logout/back-channel-logout-flow.png)
...
configuration, e.g. [creating an OIDC application](/docs/reference/api-v1/management/zitadel.management.v1.ManagementService.AddOIDCApp).
