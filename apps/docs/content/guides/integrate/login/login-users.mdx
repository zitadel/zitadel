...
![Screenshot of ZITADEL login screen](../../../../public/img/guides/integrate/login/login-start.png)
...
ZITADEL's [Session API](/docs/reference/api/session) provides developers with a straightforward method to manage user sessions within their applications.
...
- Learn how to [configure ZITADEL](/docs/guides/manage/console/console-overview) through the Console
