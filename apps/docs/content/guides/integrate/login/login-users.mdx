...
description: "Authenticate users with OpenID Connect 1.0 or SAML to securely integrate various applications and services using ZITADEL's identity platform"
