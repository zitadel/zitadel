...
The checkbox only has an effect when the instance-level Login V2 feature flag is **disabled**. In this scenario:

- **Checkbox checked**: This specific application will use Login V2 (`/ui/v2/login`)
- **Checkbox unchecked**: This specific application will use Login V1

If the instance-level Login V2 feature flag is **enabled**, all applications use Login V2 by default, and