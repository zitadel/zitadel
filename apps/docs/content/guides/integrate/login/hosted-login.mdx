...
description: "Authenticate users into your application with ZITADEL's hosted single-sign-on page supporting multiple authentication methods and enterprise SSO"
