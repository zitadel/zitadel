...
![](../../../../public/img/guides/integrate/login/login-external-idp-templates.png)
...
<Tabs queryString="deployment">
    ...
    <Tab value="vercel_custom" label="Vercel Custom Login Deployment">
        ...
        5. Add the domain where your login UI is hosted to the [trusted domains](/reference/api/admin/zitadel.admin.v1.AdminService.AddInstanceTrustedDomain) in Zitadel. (Example: my-new-zitadel-login.vercel.app)
