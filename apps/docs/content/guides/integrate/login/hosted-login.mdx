...
By default, all of these login methods are allowed and can be adjusted by [Managers](/concepts/structure/managers) to meet their requirements.
...
<Tabs queryString="deployment">
    ...
    <Tab value="vercel_custom" label="Vercel Custom Login Deployment">
        ...
        5. Add the domain where your login UI is hosted to the [trusted domains](/reference/api-v1/admin/zitadel.admin.v1.AdminService.AddInstanceTrustedDomain) in Zitadel. (Example: my-new-zitadel-login.vercel.app)
