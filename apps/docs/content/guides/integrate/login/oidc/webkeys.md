...
The web key [create](/apis/resources/webkey_service_v2/zitadel-webkey-v-2-web-key-service-create-web-key) endpoint generates a new web key pair, main:docs/docs/guides/integrate/login/oidc/webkeys.md
...
```bash
curl -L 'https://${CUSTOM_DOMAIN}/v2/web_keys' \ main:docs/docs/guides/integrate/login/oidc/webkeys.md
...
When a generated web key is [activated](/apis/resources/webkey_service_v2/zitadel-webkey-v-2-web-key-service-activate-web-key), main:docs/docs/guides/integrate/login/oidc/webkeys.md
...
Non-active keys may be [deleted](/apis/resources/webkey_service_v2/zitadel-webkey-v-2-web-key-service-delete-web-key). main:docs/docs/guides/integrate/login/oidc/webkeys.md
...
```bash
curl -L -X DELETE 'https://${CUSTOM_DOMAIN}/v2/web_keys/1' \ main:docs/docs/guides/integrate/login/oidc/webkeys.md
-H 'Accept: application/json' \
-H 'Authorization: Bearer <TOKEN>'
```
