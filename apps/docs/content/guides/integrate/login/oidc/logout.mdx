...
ZITADEL supports OpenID Connect Back-Channel Logout. See [OIDC Back-Channel Logout](/guides/integrate/back-channel-logout) for how it works and how to configure your application.
