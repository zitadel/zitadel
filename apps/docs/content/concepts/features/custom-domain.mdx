...
Learn how to [configure a Custom Domain in ZITADEL Cloud](https://help.zitadel.com/customer-portal-instances#add-custom-domain) or how to configure [Custom Domain when self-hosting](/self-hosting/manage/custom-domain).
