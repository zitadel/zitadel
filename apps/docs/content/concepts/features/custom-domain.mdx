---
title: Custom Domain
description: "Configure a custom domain for personalized authentication experience and maintain brand identity throughout the login process always securely"
