...
Administrators can see all events across an instance and filter them directly in [Console](/guides/manage/console/overview).
...
Access to the API is possible with a [Service Account](/guides/integrate/service-accounts/authenticate-service-accounts) account, allowing you to integrate the events with your own business logic.
