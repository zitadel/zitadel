...
- A business needs to automate tasks. Roles should be assigned to Users (Human) based on their ADFS 2016+ groups.
- A business needs to store metadata on a User (Human) that is used for integrating applications.
- A business needs to restrict the Users (Human) who are allowed to register to a certain organization by their email domains.
