...
The console is available by navigating to the [custom domain](/concepts/features/custom-domain) of your instance and appending the path `/ui/console`.
Administrators can [restrict end-users from accessing the console](/guides/solution-scenarios/restrict-console).
...
5. **Audit Logging:** The console offers access to [audit logs](/concepts/features/audit-trail) that track user activity and changes made to resources and system settings. Administrators can review these logs to monitor security-related events, track changes, and maintain compliance with regulatory requirements.
...
- Detailed guide on [using the console](/guides/manage/console/console-overview)
- [Restrict access](/guides/solution-scenarios/restrict-console) to the console
