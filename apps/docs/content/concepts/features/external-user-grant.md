...
* [API reference for user grants](/reference/api-v1/management)
* [How to manage user grants through ZITADEL's console](/guides/manage/console/roles#authorizations)
