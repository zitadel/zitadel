...
description: "Manage user accounts and access rights independently with ZITADEL's self-service capabilities for registration, login, and profile management"
