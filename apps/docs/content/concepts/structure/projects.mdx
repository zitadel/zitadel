...
To learn how to set up a project read this management console guide [here](../../guides/manage/console/projects-overview).
...
If you are unsure on how to structure your organizations and projects, we recommend reading the guide on [solution architecture](/concepts/architecture/solution).
