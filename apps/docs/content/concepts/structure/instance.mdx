...
This is useful if you have business customers, which in turn have their business customers with self service and Custom Domain demands. main:docs/docs/concepts/structure/instance.mdx
