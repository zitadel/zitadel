...
To learn how to set up a project read this management console guide [here](../../guides/manage/console/projects-overview.mdx). main:docs/docs/concepts/structure/projects.md
...
![](../../../public/img/guides/solution-scenarios/console-default-project.png)
