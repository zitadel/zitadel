...
const FRAMEWORKS = ['angular', 'django', 'flutter', 'go', 'nextjs', 'react', 'spring', 'symfony', 'vue'];
const DISPLAY_NAMES = ['Angular', 'Django', 'Flutter', 'Go', 'Next.js', 'React', 'Spring', 'Symfony', 'Vue.js'];
