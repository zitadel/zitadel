...
const FRAMEWORKS = ['angular', 'django', 'flask', 'flutter', 'go', 'laravel', 'nextjs', 'react', 'spring', 'symfony', 'vue'];
const DISPLAY_NAMES = ['Angular', 'Django', 'Flask', 'Flutter', 'Go', 'Laravel', 'Next.js', 'React', 'Spring', 'Symfony', 'Vue.js'];
