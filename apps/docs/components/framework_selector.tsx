...
const FRAMEWORKS = ['angular', 'django', 'fastapi', 'flask', 'flutter', 'go', 'laravel', 'nextjs', 'react', 'spring', 'symfony', 'vue'];
const DISPLAY_NAMES = ['Angular', 'Django', 'FastAPI', 'Flask', 'Flutter', 'Go', 'Laravel', 'Next.js', 'React', 'Spring', 'Symfony', 'Vue.js'];
