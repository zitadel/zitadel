...
const FRAMEWORKS = ['angular', 'django', 'flutter', 'go', 'laravel', 'nextjs', 'react', 'spring', 'symfony', 'vue'];
const DISPLAY_NAMES = ['Angular', 'Django', 'Flutter', 'Go', 'Laravel', 'Next.js', 'React', 'Spring', 'Symfony', 'Vue.js'];
