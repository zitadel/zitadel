...
function CheckIcon({ title }: { title: string }) {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="las la-check me-2 h-6 w-6 flex-none text-lg text-green-500 dark:text-green-500"
      role="img"
    >
      <title>{title}</title>
...
function CrossIcon({ title }: { title: string }) {
  return (
    <svg
      className="las la-times text-warn-light-500 dark:text-warn-dark-500 me-2 h-6 w-6 flex-none text-lg"
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
      strokeWidth={1.5}
