...
describe("base64 utilities", () => {
  describe("coerceToBase64Url", () => {
    ...
    it("should throw error for non-coercible types", () => {
      expect(() => coerceToBase64Url(123, "number")).toThrow(
        "could not coerce 'number' to string"
      );
      
      expect(() => coerceToBase64Url(null, "null")).toThrow(
        "could not coerce 'null' to string"
      );
      
      expect(() => coerceToBase64Url(undefined, "undefined")).toThrow(
        "could not coerce 'undefined' to string"
      );
      
      expect(() => coerceToBase64Url({}, "object")).toThrow(
        "could not coerce 'object' to string"
      );
    });
  ...
  describe("coerceToArrayBuffer", () => {
    ...
    it("should throw TypeError for non-coercible types", () => {
      ...
      expect(() => coerceToArrayBuffer(123, "number")).toThrow(
        "could not coerce 'number' to ArrayBuffer"
      );
  ...
  describe("edge cases", () => {
    ...
    it("should provide meaningful error messages with parameter names", () => {
      expect(() => coerceToBase64Url(123, "myParameter")).toThrow(
        "could not coerce 'myParameter' to string"
      );
      
      expect(() => coerceToArrayBuffer(123, "anotherParam")).toThrow(
        "could not coerce 'anotherParam' to ArrayBuffer"
      );
    });
  });
});
