...
func SetMappingsUI(
	...
	version := "v2"
	kind := "Mapping"
	k8sClient.EXPECT().CheckCRD("mappings.getambassador.io").MinTimes(1).MaxTimes(1).Return(&apixv1beta1.CustomResourceDefinition{}, false, nil)
...
func SetHosts(
	...
	version := "v2"
	kind := "Host"
	k8sClient.EXPECT().CheckCRD("hosts.getambassador.io").MinTimes(1).MaxTimes(1).Return(&apixv1beta1.CustomResourceDefinition{}, false, nil)
