...
require (
	...
	github.com/caos/orbos v1.5.14-0.20210114174609-0c13338e7be2
	...
	github.com/mattn/go-colorable v0.1.8 // indirect github.com/mitchellh/copystructure v1.0.0 // indirect
