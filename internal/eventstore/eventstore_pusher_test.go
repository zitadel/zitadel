...
func TestEventstore_Push_UniqueConstraintOwners(t *testing.T) {
	for pusherName, pusher := range pushers {
		t.Run(pusherName, func(t *testing.T) {
			...
			t.Run("add stores owners", func(t *testing.T) {
			...
			t.Run("omit owners stores empty", func(t *testing.T) {
				t.Cleanup(cleanupEventstore(client))
			...
			t.Run("add duplicate already exists", func(t *testing.T) {
				t.Cleanup(cleanupEventstore(client))
			...
			t.Run("remove by field case insensitive", func(t *testing.T) {
				t.Cleanup(cleanupEventstore(client))
			...
			t.Run("remove by owner org", func(t *testing.T) {
				t.Cleanup(cleanupEventstore(client))
			...
			t.Run("remove by owner user", func(t *testing.T) {
				t.Cleanup(cleanupEventstore(client))
			...
			t.Run("remove by owner idp", func(t *testing.T) {
				t.Cleanup(cleanupEventstore(client))
			...
			t.Run("two org tags either org deletes grant", func(t *testing.T) {
				t.Cleanup(cleanupEventstore(client))
			...
			t.Run("instance remove deletes tagged rows", func(t *testing.T) {
				t.Cleanup(cleanupEventstore(client))
			...
			t.Run("global and empty owners not deleted by owner", func(t *testing.T) {
				t.Cleanup(cleanupEventstore(client))
			...
			t.Run("mixed batch deletes then inserts", func(t *testing.T) {
				t.Cleanup(cleanupEventstore(client))
