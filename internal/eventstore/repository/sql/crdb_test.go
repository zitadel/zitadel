	...
	}{
		{
			...
			res: res{
				...
				eventsRes: eventsRes{
					...
					aggType:           database.Array[string]{t.Name()},
				},
			},
		},
		{
...
func TestCRDB_Push_Parallel(t *testing.T) {
	...
	type eventsRes struct {
		pushedEventsCount int
		aggTypes          database.Array[string]
		aggIDs            database.Array[string]
	}
	type res struct {
		errCount  int
		eventsRes eventsRes
	...
	}{
		{
			...
			res: res{
				...
				eventsRes: eventsRes{
					...
					pushedEventsCount: 9,
					aggTypes:          database.Array[string]{t.Name()},
				},
			},
		},
		{
...
func TestCRDB_Push_ResourceOwner(t *testing.T) {
	...
	type res struct {
		resourceOwners database.Array[string]
	}
	type fields struct {
		aggregateIDs  database.Array[string]
