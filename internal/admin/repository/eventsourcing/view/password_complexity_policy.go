...
func (v *View) PasswordComplexityPolicyByAggregateID(aggregateID string) (*model.PasswordComplexityView, error) {
	return view.GetPasswordComplexityPolicyByAggregateID(v.Db, passwordComplexityPolicyTable, aggregateID)
}

func (v *View) PutPasswordComplexityPolicy(policy *model.PasswordComplexityView, sequence uint64) error {
