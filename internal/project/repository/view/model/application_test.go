...
func TestApplicationAppendEvent(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				event: &es_models.Event{AggregateID: "AggregateID", Seq: 1, Typ: es_models.EventType(project.ApplicationAddedType), Data: mockAppData(&es_model.Application{Name: "AppName"})},
				app:   &ApplicationView{},
			},
		...
		},
		{
			...
			args: args{
				event: &es_models.Event{AggregateID: "AggregateID", Seq: 1, Typ: es_models.EventType(project.ApplicationChangedType), Data: mockAppData(&es_model.Application{Name: "AppNameChanged"})},
		...
		},
		{
			...
			args: args{
				event: &es_models.Event{AggregateID: "AggregateID", Seq: 1, Typ: es_models.EventType(project.ApplicationDeactivatedType)},
				app:   &ApplicationView{ProjectID: "AggregateID", Name: "AppName", State: int32(model.AppStateActive)},
			},
		...
		},
		{
			...
			args: args{
				event: &es_models.Event{AggregateID: "AggregateID", Seq: 1, Typ: es_models.EventType(project.ApplicationReactivatedType)},
		...
		},
		{
			...
			args: args{
				event: &es_models.Event{AggregateID: "AggregateID", Seq: 1, Typ: es_models.EventType(project.OIDCConfigAddedType), Data: mockOIDCConfigData(&es_model.OIDCConfig{ClientID: "clientID"})},
				app:   &ApplicationView{ProjectID: "AggregateID", Name: "AppName", State: int32(model.AppStateActive)},
			},
		...
		},
		{
			...
			args: args{
				event: &es_models.Event{AggregateID: "AggregateID", Seq: 1, Typ: es_models.EventType(project.OIDCConfigAddedType), Data: mockOIDCConfigData(&es_model.OIDCConfig{ClientID: "clientIDChanged"})},
