...
func TestProjectAppendEvent(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				event:   &es_models.Event{AggregateID: "AggregateID", Seq: 1, Typ: es_models.EventType(project.ProjectAddedType), ResourceOwner: "GrantedOrgID", Data: mockProjectData(&es_model.Project{Name: "ProjectName"})},
				project: &ProjectView{},
			},
		...
		},
		{
			...
			args: args{
				event:   &es_models.Event{AggregateID: "AggregateID", Seq: 1, Typ: es_models.EventType(project.ProjectChangedType), ResourceOwner: "GrantedOrgID", Data: mockProjectData(&es_model.Project{Name: "ProjectNameChanged"})},
		...
		},
		{
			...
			args: args{
				event:   &es_models.Event{AggregateID: "AggregateID", Seq: 1, Typ: es_models.EventType(project.ProjectDeactivatedType), ResourceOwner: "GrantedOrgID"},
				project: &ProjectView{ProjectID: "AggregateID", ResourceOwner: "GrantedOrgID", Name: "ProjectName", State: int32(model.ProjectStateActive)},
			},
		...
		},
		{
			...
			args: args{
				event:   &es_models.Event{AggregateID: "AggregateID", Seq: 1, Typ: es_models.EventType(project.ProjectReactivatedType), ResourceOwner: "GrantedOrgID"},
