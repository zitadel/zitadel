					...
					[][]driver.Value{
						{
							...
							"oidc-client-id",
							database.Array[string]{"https://redirect.to/me"},
							...
							database.Array[string]{"post.logout.ch"},
							true,
							...
							true,
							1 * time.Second,
							database.Array[string]{"additional.origin"},
							false,
							// saml config
							nil,
							nil,
				...
				Apps: []*App{
					{
						...
						OIDCConfig: &OIDCApp{
							...
							RedirectURIs:             database.Array[string]{"https://redirect.to/me"},
							...
							PostLogoutRedirectURIs:   database.Array[string]{"post.logout.ch"},
							IsDevMode:                true,
							...
							AdditionalOrigins:        database.Array[string]{"additional.origin"},
							ComplianceProblems:       nil,
							AllowedOrigins:           database.Array[string]{"https://redirect.to", "additional.origin"},
	...
	tests := []struct {
		...
		},
		{
			...
			want: want{
				sqlExpectations: mockQueries(
					expectedAppIDsQuery,
					database.Array[string]{"client_id", "client_id"},
					[][]driver.Value{
						{
							"app-id",
							nil,
	...
	tests := []struct {
		...
		},
		{
			...
			want: want{
				sqlExpectations: mockQuery(
					expectedProjectIDByAppQuery,
					database.Array[string]{"project_id"},
