...
func newIDPTemplateProjection(ctx context.Context, config crdb.StatementHandlerConfig) *idpTemplateProjection {
	...
	config.InitCheck = crdb.NewMultiTableCheck(
		crdb.NewTable([]*crdb.Column{
			...
			crdb.NewColumn(IDPTemplateTypeCol, crdb.ColumnTypeEnum, crdb.Nullable()),
			crdb.NewColumn(IDPTemplateOwnerRemovedCol, crdb.ColumnTypeBool, crdb.Default(false)),
			crdb.NewColumn(IDPTemplateIsCreationAllowedCol, crdb.ColumnTypeBool),
			crdb.NewColumn(IDPTemplateIsLinkingAllowedCol, crdb.ColumnTypeBool),
			crdb.NewColumn(IDPTemplateIsAutoCreationCol, crdb.ColumnTypeBool),
			crdb.NewColumn(IDPTemplateIsAutoUpdateCol, crdb.ColumnTypeBool),
		},
			crdb.NewPrimaryKey(IDPInstanceIDCol, IDPTemplateIDCol),
