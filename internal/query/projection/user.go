	...
	return crdb.NewMultiStatement(
		...
		crdb.AddCreateStatement(
			[]handler.Column{
				...
				handler.NewCol(HumanPhoneCol, &sql.NullString{String: string(e.PhoneNumber), Valid: e.PhoneNumber != "" /* TODO: Really validate */}),
			},
		...
		crdb.AddCreateStatement(
			[]handler.Column{
				...
				handler.NewCol(NotifyLastPhoneCol, &sql.NullString{String: string(e.PhoneNumber), Valid: e.PhoneNumber != "" /* TODO: Really validate */}),
