					...
					executions: []execution{
						{
							...
							expectedArgs: []interface{}{
								...
								"client-id",
								anyArg{},
								database.Array[string]{"redirect.one.ch", "redirect.two.ch"},
								...
								database.Array[string]{"logout.one.ch", "logout.two.ch"},
								true,
								...
								true,
								1 * time.Microsecond,
								database.Array[string]{"origin.one.ch", "origin.two.ch"},
								true,
							},
						},
						{
