			...
			want: wantReduce{
				...
				executer: &testExecuter{
					executions: []execution{
						{
							expectedStmt: "INSERT INTO projections.user_metadata2 (user_id, resource_owner, instance_id, creation_date, change_date, sequence, key, value) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) ON CONFLICT (instance_id, user_id) DO UPDATE SET (user_id, resource_owner, instance_id, creation_date, change_date, sequence, key, value) = ($1, $2, $3, $4, $5, $6, $7, $8)",
