...
func prepareQuotaNotificationsQuery() (sq.SelectBuilder, func(database.Rows) (*QuotaNotifications, error)) {
	return sq.Select(
			...
			PlaceholderFormat(sq.Dollar), func(rows database.Rows) (*QuotaNotifications, error) {
