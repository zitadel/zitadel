...
var (
	userGrantStmt = regexp.QuoteMeta(
		"SELECT projections.user_grants4.id" +
			...
			" LEFT JOIN projections.users11 ON projections.user_grants4.user_id = projections.users11.id AND projections.user_grants4.instance_id = projections.users11.instance_id" +
			" LEFT JOIN projections.users11_humans ON projections.user_grants4.user_id = projections.users11_humans.user_id AND projections.user_grants4.instance_id = projections.users11_humans.instance_id" +
