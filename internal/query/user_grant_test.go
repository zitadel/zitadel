...
var (
	userGrantStmt = regexp.QuoteMeta(
		"SELECT projections.user_grants4.id" +
			...
			" LEFT JOIN projections.users9 ON projections.user_grants4.user_id = projections.users9.id AND projections.user_grants4.instance_id = projections.users9.instance_id" +
			" LEFT JOIN projections.users9_humans ON projections.user_grants4.user_id = projections.users9_humans.user_id AND projections.user_grants4.instance_id = projections.users9_humans.instance_id" +
