...
const (
	MetadataSetType        = groupEventTypePrefix + metadata.SetEventType
	MetadataRemovedType    = groupEventTypePrefix + metadata.RemovedEventType
	MetadataRemovedAllType = groupEventTypePrefix + metadata.RemovedAllEventType
)
