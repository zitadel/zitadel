...
func RegisterEventMappers(es *eventstore.Eventstore) {
	es.RegisterFilterEventMapper(SetupStartedEventType, SetupStepMapper).
		...
		RegisterFilterEventMapper(DebugNotificationProviderFileEnabledEventType, DebugNotificationProviderFileEnabledEventMapper).
		RegisterFilterEventMapper(DebugNotificationProviderFileDisabledEventType, DebugNotificationProviderFileDisabledEventMapper).
		...
		RegisterFilterEventMapper(DebugNotificationProviderLogEnabledEventType, DebugNotificationProviderLogEnabledEventMapper).
		RegisterFilterEventMapper(DebugNotificationProviderLogDisabledEventType, DebugNotificationProviderLogDisabledEventMapper).
		RegisterFilterEventMapper(DebugNotificationProviderLogRemovedEventType, DebugNotificationProviderLogRemovedEventMapper).
