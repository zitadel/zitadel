...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, SystemImprovedOrgByIDEventType, eventstore.GenericEventMapper[SetEvent[bool]])
	...
	eventstore.RegisterFilterEventMapper(AggregateType, InstanceImprovedOrgByIDEventType, eventstore.GenericEventMapper[SetEvent[bool]])
}
