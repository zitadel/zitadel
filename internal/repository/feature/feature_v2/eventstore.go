...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, SystemExecutionEventType, eventstore.GenericEventMapper[SetEvent[bool]])
	...
	eventstore.RegisterFilterEventMapper(AggregateType, InstanceExecutionEventType, eventstore.GenericEventMapper[SetEvent[bool]])
}
