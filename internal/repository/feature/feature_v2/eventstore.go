...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, SystemRequireLoginV2, eventstore.GenericEventMapper[SetEvent[bool]])
	...
	eventstore.RegisterFilterEventMapper(AggregateType, InstanceRequireLoginV2, eventstore.GenericEventMapper[SetEvent[bool]])
}
