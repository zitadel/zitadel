...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, HumanEmailChangeSentType, HumanEmailChangeSentEventMapper)
	...
	eventstore.RegisterFilterEventMapper(AggregateType, HumanPhoneChangeSentType, HumanPhoneChangeSentEventMapper)
