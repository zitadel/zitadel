...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, UserV1PhoneCodeSendFailedType, eventstore.GenericEventMapper[HumanPhoneCodeSendFailedEvent])
	...
	eventstore.RegisterFilterEventMapper(AggregateType, HumanPhoneCodeSendFailedType, eventstore.GenericEventMapper[HumanPhoneCodeSendFailedEvent])
