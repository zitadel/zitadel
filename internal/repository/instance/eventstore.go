...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, DetectionSettingsSetEventType, eventstore.GenericEventMapper[DetectionSettingsSetEvent])
	eventstore.RegisterFilterEventMapper(AggregateType, DetectionRuleAddedEventType, eventstore.GenericEventMapper[DetectionRuleAddedEvent])
	eventstore.RegisterFilterEventMapper(AggregateType, DetectionRuleChangedEventType, eventstore.GenericEventMapper[DetectionRuleChangedEvent])
	eventstore.RegisterFilterEventMapper(AggregateType, DetectionRuleRemovedEventType, eventstore.GenericEventMapper[DetectionRuleRemovedEvent])
