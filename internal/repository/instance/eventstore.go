...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, SMSConfigHTTPAddedEventType, SMSConfigHTTPAddedEventMapper)
	eventstore.RegisterFilterEventMapper(AggregateType, SMSConfigHTTPChangedEventType, SMSConfigHTTPChangedEventMapper)
	eventstore.RegisterFilterEventMapper(AggregateType, SMSConfigTwilioActivatedEventType, SMSConfigTwilioActivatedEventMapper)
	eventstore.RegisterFilterEventMapper(AggregateType, SMSConfigTwilioDeactivatedEventType, SMSConfigTwilioDeactivatedEventMapper)
	eventstore.RegisterFilterEventMapper(AggregateType, SMSConfigTwilioRemovedEventType, SMSConfigTwilioRemovedEventMapper)
