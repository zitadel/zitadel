...
func init() {
	...
	eventstore.RegisterFilterEventMapper(AggregateType, OrgSMTPConfigAddedEventType, eventstore.GenericEventMapper[OrgSMTPConfigAddedEvent])
	eventstore.RegisterFilterEventMapper(AggregateType, OrgSMTPConfigChangedEventType, eventstore.GenericEventMapper[OrgSMTPConfigChangedEvent])
	eventstore.RegisterFilterEventMapper(AggregateType, OrgSMTPConfigPasswordChangedEventType, eventstore.GenericEventMapper[OrgSMTPConfigPasswordChangedEvent])
	eventstore.RegisterFilterEventMapper(AggregateType, OrgSMTPConfigHTTPAddedEventType, eventstore.GenericEventMapper[OrgSMTPConfigHTTPAddedEvent])
	eventstore.RegisterFilterEventMapper(AggregateType, OrgSMTPConfigHTTPChangedEventType, eventstore.GenericEventMapper[OrgSMTPConfigHTTPChangedEvent])
	eventstore.RegisterFilterEventMapper(AggregateType, OrgSMTPConfigActivatedEventType, eventstore.GenericEventMapper[OrgSMTPConfigActivatedEvent])
	eventstore.RegisterFilterEventMapper(AggregateType, OrgSMTPConfigDeactivatedEventType, eventstore.GenericEventMapper[OrgSMTPConfigDeactivatedEvent])
	eventstore.RegisterFilterEventMapper(AggregateType, OrgSMTPConfigRemovedEventType, eventstore.GenericEventMapper[OrgSMTPConfigRemovedEvent])
}
