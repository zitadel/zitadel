...
func DomainAddedEventMapper(event eventstore.Event) (eventstore.Event, error) {
	...
	if err != nil {
		return nil, zerrors.ThrowInternal(err, "ORG-GBr52", "unable to unmarshal organization domain added")
	}
...
func DomainVerificationAddedEventMapper(event eventstore.Event) (eventstore.Event, error) {
	...
	if err != nil {
		return nil, zerrors.ThrowInternal(err, "ORG-NRN32", "unable to unmarshal organization domain verification added")
	}
...
func DomainVerificationFailedEventMapper(event eventstore.Event) (eventstore.Event, error) {
	...
	if err != nil {
		return nil, zerrors.ThrowInternal(err, "ORG-Bhm37", "unable to unmarshal organization domain verification failed")
	}
...
func DomainVerifiedEventMapper(event eventstore.Event) (eventstore.Event, error) {
	...
	if err != nil {
		return nil, zerrors.ThrowInternal(err, "ORG-BFSwt", "unable to unmarshal organization domain verified")
	}
...
func DomainPrimarySetEventMapper(event eventstore.Event) (eventstore.Event, error) {
	...
	if err != nil {
		return nil, zerrors.ThrowInternal(err, "ORG-N5787", "unable to unmarshal organization domain primary set")
	}
...
func DomainRemovedEventMapper(event eventstore.Event) (eventstore.Event, error) {
	...
	if err != nil {
		return nil, zerrors.ThrowInternal(err, "ORG-BngB2", "unable to unmarshal organization domain removed")
	}
