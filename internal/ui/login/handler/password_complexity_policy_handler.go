...
func (l *Login) generatePolicyDescription(r *http.Request, policy *iam_model.PasswordComplexityPolicyView) (string, error) {
	...
	if policy.HasUppercase {
		...
		description += "<li id=\"uppercase\" class=\"invalid\"><i class=\"las la-times lgn-warn\"></i><span>" + uppercase + "</span></li>"
	}
	if policy.HasLowercase {
		lowercase := l.renderer.LocalizeFromRequest(r, "Password.HasLowercase", nil)
		description += "<li id=\"lowercase\" class=\"invalid\"><i class=\"las la-times lgn-warn\"></i><span>" + lowercase + "</span></li>"
	}
	if policy.HasNumber {
		hasnumber := l.renderer.LocalizeFromRequest(r, "Password.HasNumber", nil)
		description += "<li id=\"number\" class=\"invalid\"><i class=\"las la-times lgn-warn\"></i><span>" + hasnumber + "</span></li>"
	}
	if policy.HasSymbol {
		hassymbol := l.renderer.LocalizeFromRequest(r, "Password.HasSymbol", nil)
		description += "<li id=\"symbol\" class=\"invalid\"><i class=\"las la-times lgn-warn\"></i><span>" + hassymbol + "</span></li>"
	}
