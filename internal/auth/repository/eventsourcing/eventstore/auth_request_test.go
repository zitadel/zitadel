...
func TestAuthRequestRepo_nextSteps(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"user not found, ignore unknown usernames, password check step",
			fields{
				userViewProvider:        &mockViewNoUser{},
				userEventProvider:       &mockEventUser{},
				userSessionViewProvider: &mockViewNoUserSession{},
			},
			args{&domain.AuthRequest{UserID: "UserID", LoginPolicy: &domain.LoginPolicy{IgnoreUnknownUsernames: true}}, false},
		...
		},
		{
			...
			args{&domain.AuthRequest{UserID: "UserID", LoginPolicy: &domain.LoginPolicy{}, SelectedIDPConfigID: "IDPConfigID"}, false},
