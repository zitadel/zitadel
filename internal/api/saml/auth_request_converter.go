...
func CreateAuthRequestToBusiness(ctx context.Context, authReq *samlp.AuthnRequestType, acsUrl, protocolBinding, issuerID, relayState, userAgentID string) *domain.AuthRequest {
