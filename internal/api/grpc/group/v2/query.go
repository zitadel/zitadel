...
func listGroupsRequestToModel(req *group.ListGroupsRequest, systemDefaults systemdefaults.SystemDefaults) (*query.GroupSearchQuery, error) {
...
func groupSearchFiltersToQuery(filters []*group.GroupsSearchFilter) (_ []query.SearchQuery, err error) {
...
func groupFilterToQuery(f *group.GroupsSearchFilter) (query.SearchQuery, error) {
...
func groupFieldNameToSortingColumn(field *group.FieldName) query.Column {
	if field == nil {
		return query.GroupColumnCreationDate
	}
	switch *field {
	case group.FieldName_FIELD_NAME_CREATION_DATE, group.FieldName_FIELD_NAME_UNSPECIFIED:
		return query.GroupColumnCreationDate
	case group.FieldName_FIELD_NAME_ID:
		return query.GroupColumnID
	case group.FieldName_FIELD_NAME_NAME:
		return query.GroupColumnName
	case group.FieldName_FIELD_NAME_CHANGE_DATE:
