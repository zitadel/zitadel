...
func TestServer_ListIAMMemberRoles(t *testing.T) {
	got, err := Tester.Client.Admin.ListIAMMemberRoles(AdminCTX, &admin_pb.ListIAMMemberRolesRequest{})
...
func TestServer_ListIAMMembers(t *testing.T) {
	...
	_, err := Tester.Client.Admin.AddIAMMember(AdminCTX, &admin_pb.AddIAMMemberRequest{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := Tester.Client.Admin.ListIAMMembers(tt.args.ctx, tt.args.req)
			if tt.wantErr {
				assert.Error(t, err)
				return
			}
			...
			for i, want := range wantResult {
				...
				assert.Equal(t, want.GetRoles(), gotResult[i].GetRoles())
			}
		})
	}
}
...
func TestServer_UpdateIAMMember(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := Tester.Client.Admin.UpdateIAMMember(tt.args.ctx, tt.args.req)
			if tt.wantErr {
				assert.Error(t, err)
				return
			}
...
func TestServer_RemoveIAMMember(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := Tester.Client.Admin.RemoveIAMMember(tt.args.ctx, tt.args.req)
			if tt.wantErr {
				assert.Error(t, err)
				return
			}
