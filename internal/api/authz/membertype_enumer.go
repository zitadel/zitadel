// Code generated by "enumer -type MemberType -trimprefix MemberType -json -yaml -sql"; DO NOT EDIT.
...
// MarshalYAML implements a YAML Marshaler for MemberType
func (i MemberType) MarshalYAML() (interface{}, error) {
	return i.String(), nil
}

// UnmarshalYAML implements a YAML Unmarshaler for MemberType
func (i *MemberType) UnmarshalYAML(unmarshal func(interface{}) error) error {
	var s string
