...
func newDefaultLoginPolicyChangedEvent(ctx context.Context, allowRegister, allowUsernamePassword, allowExternalIDP, forceMFA, forceMFALocalOnly,
	...
	redirectURI string,
	passwordLifetime, externalLoginLifetime, mfaInitSkipLifetime, secondFactorLifetime, multiFactorLifetime time.Duration, useDefaultRedirectUriForNotificationLinks bool) *instance.LoginPolicyChangedEvent {
	event, _ := instance.NewLoginPolicyChangedEvent(ctx,
		...
		[]policy.LoginPolicyChanges{
			...
			policy.ChangeUseDefaultRedirectUriForNotificationLinks(useDefaultRedirectUriForNotificationLinks),
		},
	)
	return event
}
