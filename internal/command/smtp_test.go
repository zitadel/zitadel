...
func newSMTPConfigChangedEvent(ctx context.Context, tls bool, fromAddress, fromName, replyTo, host, user string, isActive bool, providerType string) *instance.SMTPConfigChangedEvent {
