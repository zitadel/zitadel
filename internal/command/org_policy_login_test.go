...
func newLoginPolicyChangedEvent(ctx context.Context, orgID string,
	...
	redirectURI string,
	passwordLifetime, externalLoginLifetime, mfaInitSkipLifetime, secondFactorLifetime, multiFactorLifetime *time.Duration, useDefaultRedirectUriForNotificationLinks bool) *org.LoginPolicyChangedEvent {
