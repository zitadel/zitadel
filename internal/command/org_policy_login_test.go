...
func newLoginPolicyChangedEvent(ctx context.Context, orgID string,
	...
	redirectURI string,
	passwordLifetime, externalLoginLifetime, mfaInitSkipLifetime, secondFactorLifetime, multiFactorLifetime *time.Duration, useDefaultUriForNotificationLinks bool) *org.LoginPolicyChangedEvent {
