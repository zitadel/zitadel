...
func reduceInstanceFeature(features *InstanceFeatures, key feature.Key, value any) {
	...
	case feature.KeyTerminateSingleV1Session:
		v := value.(bool)
		features.TerminateSingleV1Session = &v
	}
}
...
func (wm *InstanceFeaturesWriteModel) setCommands(ctx context.Context, f *InstanceFeatures) []eventstore.Command {
	...
	cmds = appendFeatureUpdate(ctx, cmds, aggregate, wm.TerminateSingleV1Session, f.TerminateSingleV1Session, feature_v2.InstanceTerminateSingleV1SessionEventType)
	return cmds
}
