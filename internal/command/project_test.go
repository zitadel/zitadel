		...
		},
		{
					...
					expectPushFailed(caos_errs.ThrowAlreadyExists(nil, "ERROR", "internl"),
						[]*repository.Event{
							eventFromEventPusher(project.NewProjectAddedEvent(
								...
								domain.PrivateLabelingSettingLoginUserResourceOwnerPolicy,
							),
							),
			...
			args: args{
				...
				project: &domain.Project{
					...
					PrivateLabelingSetting: domain.PrivateLabelingSettingLoginUserResourceOwnerPolicy,
				},
				resourceOwner: "org1",
				ownerID:       "user1",
			},
		...
		},
		{
						...
						[]*repository.Event{
							eventFromEventPusher(
								newProjectChangedEvent(context.Background(),
									...
									false,
									false,
									domain.PrivateLabelingSettingProjectResourceOwnerPolicy),
							),
						},
			...
			args: args{
				...
				project: &domain.Project{
					...
					PrivateLabelingSetting: domain.PrivateLabelingSettingProjectResourceOwnerPolicy,
				},
				resourceOwner: "org1",
			},
			res: res{
