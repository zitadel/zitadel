			...
			fields: fields{
				eventstore: eventstoreExpect(
					...
					expectPush(
						...
						instance.NewCustomTextSetEvent(context.Background(),
							&instance.NewAggregate("INSTANCE").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundNoOptionAvailable, "NoOptionAvailable", language.English,
						),
						instance.NewCustomTextSetEvent(context.Background(),
			...
			fields: fields{
				eventstore: eventstoreExpect(
					...
					expectPush(
						...
						instance.NewCustomTextRemovedEvent(context.Background(),
							&instance.NewAggregate("INSTANCE").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundNoOptionAvailable, language.English,
						),
						instance.NewCustomTextRemovedEvent(context.Background(),
