				...
				eventstore: eventstoreExpect(
					...
					expectPush(
						[]*repository.Event{
							...
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptTitle, "Title", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptDescription, "Description", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptDescriptionInit, "DescriptionInit", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptPasswordlessButtonText, "PasswordlessButtonText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptNextButtonText, "NextButtonText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptSkipButtonText, "SkipButtonText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationTitle, "Title", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationDescription, "Description", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationRegisterTokenButtonText, "RegisterTokenButtonText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationTokenNameLabel, "TokenNameLabel", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationNotSupported, "NotSupported", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationErrorRetry, "ErrorRetry", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationDoneTitle, "Title", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
							...
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationDoneCancelButtonText, "CancelButtonText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
							...
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewTitle, "Title", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewDescription, "Description", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewEmailLabel, "EmailLabel", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewUsernameLabel, "UsernameLabel", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewFirstnameLabel, "FirstnameLabel", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewLastnameLabel, "LastnameLabel", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewNicknameLabel, "NicknameLabel", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewLanguageLabel, "LanguageLabel", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewPhoneLabel, "PhoneLabel", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewTOSAndPrivacyLabel, "TOSAndPrivacyLabel", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewTOSConfirm, "TOSConfirm", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewTOSLinkText, "TOSLinkText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewTOSConfirmAnd, "TOSConfirmAnd", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewPrivacyLinkText, "PrivacyLinkText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewBackButtonText, "BackButtonText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewNextButtonText, "NextButtonText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
							...
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundTOSAndPrivacyLabel, "TOSAndPrivacyLabel", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundTOSConfirm, "TOSConfirm", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundTOSLinkText, "TOSLinkText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundTOSConfirmAnd, "TOSConfirmAnd", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundPrivacyLinkText, "PrivacyLinkText", language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextSetEvent(context.Background(),
				...
				eventstore: eventstoreExpect(
					...
					expectPush(
						[]*repository.Event{
							...
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptTitle, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptDescription, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptDescriptionInit, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptPasswordlessButtonText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptNextButtonText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessPromptSkipButtonText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationTitle, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationDescription, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationRegisterTokenButtonText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationTokenNameLabel, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationNotSupported, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationErrorRetry, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationDoneTitle, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
							...
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyPasswordlessRegistrationDoneCancelButtonText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
							...
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewTitle, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewDescription, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewEmailLabel, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewUsernameLabel, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewFirstnameLabel, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewLastnameLabel, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewNicknameLabel, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewLanguageLabel, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewPhoneLabel, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewTOSAndPrivacyLabel, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewTOSConfirm, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewTOSLinkText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewTOSConfirmAnd, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewPrivacyLinkText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewBackButtonText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalRegistrationUserOverviewNextButtonText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
							...
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundTOSAndPrivacyLabel, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundTOSConfirm, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundTOSLinkText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundTOSConfirmAnd, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
									&org.NewAggregate("org1", "org1").Aggregate, domain.LoginCustomText, domain.LoginKeyExternalNotFoundPrivacyLinkText, language.English,
								),
							),
							eventFromEventPusher(
								org.NewCustomTextRemovedEvent(context.Background(),
