...
//go:generate go tool github.com/dmarkham/enumer -type WebKeyConfigType -trimprefix WebKeyConfigType -text -json -linecomment
...
//go:generate go tool github.com/dmarkham/enumer -type RSABits -trimprefix RSABits -text -json -linecomment
type RSABits int
...
//go:generate go tool github.com/dmarkham/enumer -type RSAHasher -trimprefix RSAHasher -text -json -linecomment
const (
...
//go:generate go tool github.com/dmarkham/enumer -type EllipticCurve -trimprefix EllipticCurve -text -json -linecomment
const (
