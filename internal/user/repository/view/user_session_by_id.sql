...
FROM auth.user_sessions s
         LEFT JOIN projections.users9 u ON s.user_id = u.id AND s.instance_id = u.instance_id
         LEFT JOIN projections.users9_humans h ON s.user_id = h.user_id AND s.instance_id = h.instance_id
