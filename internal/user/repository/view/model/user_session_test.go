...
func TestAppendEvent(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.UserV1PasswordCheckSucceededType)},
				userView: &UserSessionView{},
			},
		...
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.HumanPasswordCheckSucceededType)},
				userView: &UserSessionView{},
			},
			result: &UserSessionView{ChangeDate: now(), PasswordVerification: now()},
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.UserV1PasswordCheckFailedType)},
		...
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.HumanPasswordCheckFailedType)},
				userView: &UserSessionView{PasswordVerification: now()},
			},
			result: &UserSessionView{ChangeDate: now(), PasswordVerification: time.Time{}},
		},
		{
			...
			args: args{
				event: &es_models.Event{
					CreatedAt: now(),
					Typ:       es_models.EventType(user.UserV1PasswordChangedType),
					Data: func() []byte {
		...
		},
		{
			...
			args: args{
				event: &es_models.Event{
					CreatedAt: now(),
					Typ:       es_models.EventType(user.HumanPasswordChangedType),
					Data: func() []byte {
		...
		},
		{
			...
			args: args{
				event: &es_models.Event{
					CreatedAt: now(),
					Typ:       es_models.EventType(user.HumanMFAOTPVerifiedType),
					Data:      nil,
				},
		...
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.UserV1MFAOTPCheckSucceededType)},
				userView: &UserSessionView{},
			},
		...
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.HumanMFAOTPCheckSucceededType)},
				userView: &UserSessionView{},
			},
			result: &UserSessionView{ChangeDate: now(), SecondFactorVerification: now()},
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.UserV1MFAOTPCheckFailedType)},
		...
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.HumanMFAOTPCheckFailedType)},
				userView: &UserSessionView{SecondFactorVerification: now()},
			},
			result: &UserSessionView{ChangeDate: now(), SecondFactorVerification: time.Time{}},
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.UserV1MFAOTPRemovedType)},
				userView: &UserSessionView{SecondFactorVerification: now()},
			},
			result: &UserSessionView{ChangeDate: now(), SecondFactorVerification: time.Time{}},
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.HumanMFAOTPRemovedType)},
				userView: &UserSessionView{SecondFactorVerification: now()},
			},
			result: &UserSessionView{ChangeDate: now(), SecondFactorVerification: time.Time{}},
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.UserV1SignedOutType)},
		...
		},
		{
			...
			args: args{
				event:    &es_models.Event{CreatedAt: now(), Typ: es_models.EventType(user.HumanSignedOutType)},
				userView: &UserSessionView{PasswordVerification: now(), SecondFactorVerification: now()},
			},
			result: &UserSessionView{ChangeDate: now(), PasswordVerification: time.Time{}, SecondFactorVerification: time.Time{}, State: 1},
		},
