...
type RefreshTokenView struct {
	...
	Audience              database.Array[string] `json:"audience" gorm:"column:audience"`
	Scopes                database.Array[string] `json:"scopes" gorm:"column:scopes"`
	AuthMethodsReferences database.Array[string] `json:"authMethodsReference" gorm:"column:amr"`
