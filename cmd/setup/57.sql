...
(
    instance_id TEXT,
    table_name TEXT,
    parent_type projections.object_level DEFAULT 'instance',
    parent_id TEXT,
...
BEGIN
	...
	ELSEIF (TG_OP = 'DELETE') THEN
		...
		WHERE (instance_id, table_name, parent_type, parent_id) = 
...
BEGIN
	DELETE FROM projections.resource_counts
	WHERE (instance_id, parent_type, parent_id) = (
		SELECT instance_id, parent_type, parent_id
