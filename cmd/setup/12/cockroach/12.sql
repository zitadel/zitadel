...
CREATE INDEX IF NOT EXISTS es_inst_agg_type_agg_id_cd ON eventstore3.eventstore.events (instance_id, aggregate_type, aggregate_id, created_at) INCLUDE (event_type, aggregate_version, previous_aggregate_sequence, previous_aggregate_type_sequence, event_data, editor_user, editor_service, resource_owner);
COMMIT;
