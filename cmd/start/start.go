...
import (
	...
	"github.com/zitadel/zitadel/v2/cmd/encryption"
	"github.com/zitadel/zitadel/v2/cmd/key"
	cmd_tls "github.com/zitadel/zitadel/v2/cmd/tls"
	"github.com/zitadel/zitadel/v2/internal/actions"
	admin_es "github.com/zitadel/zitadel/v2/internal/admin/repository/eventsourcing"
	"github.com/zitadel/zitadel/v2/internal/api"
	"github.com/zitadel/zitadel/v2/internal/api/assets"
	internal_authz "github.com/zitadel/zitadel/v2/internal/api/authz"
	"github.com/zitadel/zitadel/v2/internal/api/grpc/admin"
	"github.com/zitadel/zitadel/v2/internal/api/grpc/auth"
	feature_v2 "github.com/zitadel/zitadel/v2/internal/api/grpc/feature/v2"
	feature_v2beta "github.com/zitadel/zitadel/v2/internal/api/grpc/feature/v2beta"
	idp_v2 "github.com/zitadel/zitadel/v2/internal/api/grpc/idp/v2"
	"github.com/zitadel/zitadel/v2/internal/api/grpc/management"
	oidc_v2 "github.com/zitadel/zitadel/v2/internal/api/grpc/oidc/v2"
	oidc_v2beta "github.com/zitadel/zitadel/v2/internal/api/grpc/oidc/v2beta"
	org_v2 "github.com/zitadel/zitadel/v2/internal/api/grpc/org/v2"
	org_v2beta "github.com/zitadel/zitadel/v2/internal/api/grpc/org/v2beta"
	action_v3_alpha "github.com/zitadel/zitadel/v2/internal/api/grpc/resources/action/v3alpha"
	"github.com/zitadel/zitadel/v2/internal/api/grpc/resources/debug_events/debug_events"
	user_v3_alpha "github.com/zitadel/zitadel/v2/internal/api/grpc/resources/user/v3alpha"
	userschema_v3_alpha "github.com/zitadel/zitadel/v2/internal/api/grpc/resources/userschema/v3alpha"
	"github.com/zitadel/zitadel/v2/internal/api/grpc/resources/webkey/v3"
	session_v2 "github.com/zitadel/zitadel/v2/internal/api/grpc/session/v2"
	session_v2beta "github.com/zitadel/zitadel/v2/internal/api/grpc/session/v2beta"
	settings_v2 "github.com/zitadel/zitadel/v2/internal/api/grpc/settings/v2"
	settings_v2beta "github.com/zitadel/zitadel/v2/internal/api/grpc/settings/v2beta"
	"github.com/zitadel/zitadel/v2/internal/api/grpc/system"
	user_v2 "github.com/zitadel/zitadel/v2/internal/api/grpc/user/v2"
	user_v2beta "github.com/zitadel/zitadel/v2/internal/api/grpc/user/v2beta"
	http_util "github.com/zitadel/zitadel/v2/internal/api/http"
	"github.com/zitadel/zitadel/v2/internal/api/http/middleware"
	"github.com/zitadel/zitadel/v2/internal/api/idp"
	"github.com/zitadel/zitadel/v2/internal/api/oidc"
	"github.com/zitadel/zitadel/v2/internal/api/robots_txt"
	"github.com/zitadel/zitadel/v2/internal/api/saml"
	"github.com/zitadel/zitadel/v2/internal/api/ui/console"
	"github.com/zitadel/zitadel/v2/internal/api/ui/console/path"
	"github.com/zitadel/zitadel/v2/internal/api/ui/login"
	auth_es "github.com/zitadel/zitadel/v2/internal/auth/repository/eventsourcing"
	"github.com/zitadel/zitadel/v2/internal/authz"
	authz_repo "github.com/zitadel/zitadel/v2/internal/authz/repository"
	...
	cryptoDB "github.com/zitadel/zitadel/v2/internal/crypto/database"
	...
	"github.com/zitadel/zitadel/v2/internal/logstore/emitters/access"
	"github.com/zitadel/zitadel/v2/internal/logstore/emitters/execution"
	"github.com/zitadel/zitadel/v2/internal/logstore/emitters/stdout"
	"github.com/zitadel/zitadel/v2/internal/logstore/record"
	"github.com/zitadel/zitadel/v2/internal/net"
	"github.com/zitadel/zitadel/v2/internal/notification"
	"github.com/zitadel/zitadel/v2/internal/query"
	"github.com/zitadel/zitadel/v2/internal/static"
	es_v4 "github.com/zitadel/zitadel/v2/internal/v2/eventstore"
	es_v4_pg "github.com/zitadel/zitadel/v2/internal/v2/eventstore/postgres"
	"github.com/zitadel/zitadel/v2/internal/webauthn"
	"github.com/zitadel/zitadel/v2/openapi"
)
