...
import (
	...
	"github.com/zitadel/zitadel/internal/api/grpc/group/v2"
...
func startAPIs(
	...
	if err := apis.RegisterService(ctx, group.CreateServer(config.SystemDefaults, commands, queries, permissionCheck)); err != nil {
		return nil, err
	}
