CREATE TABLE IF NOT EXISTS eventstore.events2 (
    ...
    , written_by_relational BOOLEAN NOT NULL DEFAULT false
...
CREATE OR REPLACE FUNCTION eventstore.commands_to_events(commands eventstore.command2[]) RETURNS SETOF eventstore.events2 VOLATILE AS $$
SELECT
    c.instance_id
    , c.aggregate_type
    , c.aggregate_id
