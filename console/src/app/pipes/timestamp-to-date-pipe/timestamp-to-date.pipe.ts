...
import { Timestamp as BufTimestamp, TimestampSchema } from '@bufbuild/protobuf/wkt';
...
export class TimestampToDatePipe implements PipeTransform {
  ...
  transform(date: MessageInitShape<typeof TimestampSchema> | undefined): Date | undefined;
  transform(date: BufTimestamp | Timestamp.AsObject | undefined): Date | undefined;
  transform(
    date: MessageInitShape<typeof TimestampSchema> | BufTimestamp | Timestamp.AsObject | undefined,
  ): Date | undefined {
