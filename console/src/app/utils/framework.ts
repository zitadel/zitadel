...
/**
 * Each entry builds a *new* request. The configurations used to be shared
 * AddOIDCAppRequest instances, so the integrate page configured one object in
 * place and leaked its project, name and redirect URIs into the next app
 * created with the same framework.
 */
