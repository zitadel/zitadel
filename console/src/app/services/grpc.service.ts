...
const createApplicationServiceClient = createClientFor(ApplicationService);
const createGroupServiceClient = createClientFor(GroupService);
...
export class GrpcService {
  ...
  public group!: ReturnType<typeof createGroupServiceClient>;
  ...
  public loadAppEnvironment(): Promise<any> {
    ...
    const init = this.translate.use(language).pipe(
      ...
      tap((env) => {
        ...
        this.group = createGroupServiceClient(transport);
