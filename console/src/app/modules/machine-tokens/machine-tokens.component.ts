...
@Component({
  selector: 'cnsl-machine-tokens',
  templateUrl: './machine-tokens.component.html',
  styleUrls: ['./machine-tokens.component.scss'],
})
export class MachineTokensComponent implements OnInit {
  @Input() userId!: string;
