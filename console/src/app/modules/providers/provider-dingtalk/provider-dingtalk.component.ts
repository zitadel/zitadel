...
import {
  AddDingTalkProviderRequest as AdminAddDingTalkProviderRequest,
  GetProviderByIDRequest as AdminGetProviderByIDRequest,
  UpdateDingTalkProviderRequest as AdminUpdateDingTalkProviderRequest,
} from 'src/app/proto/generated/zitadel/admin_pb';
import { AutoLinkingOption, Options, Provider } from 'src/app/proto/generated/zitadel/idp_pb';
import {
  AddDingTalkProviderRequest as MgmtAddDingTalkProviderRequest,
  GetProviderByIDRequest as MgmtGetProviderByIDRequest,
  UpdateDingTalkProviderRequest as MgmtUpdateDingTalkProviderRequest,
...
@Component({
  selector: 'cnsl-provider-dingtalk',
  templateUrl: './provider-dingtalk.component.html',
})
export class ProviderDingTalkComponent {
  ...
  private getData(id: string): void {
    ...
    this.service
      ...
      .then((resp) => {
        ...
        this.loading = false;
        if (this.provider?.config?.dingtalk) {
          this.form.patchValue(this.provider.config.dingtalk);
  ...
  public submitForm(): void {
    this.provider || this.justCreated$.value ? this.updateDingTalkProvider() : this.addDingTalkProvider();
  }

  public addDingTalkProvider(): void {
    const req =
      this.serviceType === PolicyComponentServiceType.MGMT
        ? new MgmtAddDingTalkProviderRequest()
        : new AdminAddDingTalkProviderRequest();
  ...
  public updateDingTalkProvider(): void {
    if (this.provider || this.justCreated$.value) {
      const req =
        this.serviceType === PolicyComponentServiceType.MGMT
          ? new MgmtUpdateDingTalkProviderRequest()
          : new AdminUpdateDingTalkProviderRequest();
