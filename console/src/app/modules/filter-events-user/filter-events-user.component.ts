...
@Component({
  selector: 'cnsl-filter-events-user',
  templateUrl: './filter-events-user.component.html',
  styleUrls: ['./filter-events-user.component.scss'],
})
export class FilterEventsUserComponent implements OnInit, AfterContentChecked {
