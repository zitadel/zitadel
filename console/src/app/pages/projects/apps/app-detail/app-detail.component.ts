...
VITE_ZITADEL_CALLBACK_URL="${this.redirectUrisList[0] ?? 'http://localhost:3000/auth/callback'}"
...
VITE_ZITADEL_POST_LOGOUT_URL="${this.postLogoutRedirectUrisList[0] ?? 'http://localhost:3000/'}"
