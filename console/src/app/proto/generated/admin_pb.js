...
/** @param {string} value */
proto.caos.zitadel.admin.api.v1.CreateUserRequest.prototype.setDisplayName = function(value) {
  jspb.Message.setProto3StringField(this, 5, value);
};
...
proto.caos.zitadel.admin.api.v1.CreateUserRequest.prototype.getGender = function() {
  return /** @type {!proto.caos.zitadel.admin.api.v1.Gender} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};
