...
- **Generate**: `pnpm nx run @zitadel/console:generate` (regenerate gRPC clients after proto changes)
- **Test**: No unit test target. Use `pnpm nx run @zitadel/functional-ui:test` for E2E tests.
