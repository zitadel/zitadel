...
GEN_PATH=${GOPATH}/src/github.com/caos/citadel/console/src/app/proto/generated
...
protoc \
  -I=/usr/local/include \
  -I=${GOPATH}/src/github.com/caos/citadel/management/api/proto \
  -I=${GOPATH}/src/github.com/caos/citadel/auth/api/proto \
  -I=${GOPATH}/src/github.com/caos/citadel/admin/api/proto \
  -I=${GOPATH}/src/github.com/caos/citadel/utils/protoc/protoc-gen-authoption \
  -I=${GOPATH}/src/github.com/caos/citadel/console/node_modules/google-proto-files \
  ...
  ${GOPATH}/src/github.com/caos/citadel/management/api/proto/*.proto \
  ${GOPATH}/src/github.com/caos/citadel/admin/api/proto/*.proto \
  ${GOPATH}/src/github.com/caos/citadel/auth/api/proto/*.proto
